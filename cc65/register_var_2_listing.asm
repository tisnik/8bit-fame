...
Main file   : register_var_2.asm
Current file: register_var_2.asm
...
000000r 1               
000000r 1               ;
000000r 1               ; register unsigned char x = 42;
000000r 1               ;
000000r 1  A5 rr                lda     regbank+5
000002r 1  20 rr rr             jsr     pusha
000005r 1  A9 2A                lda     #$2A
000007r 1  85 rr                sta     regbank+5
000009r 1               ;
000009r 1               ; }
000009r 1               ;
000009r 1  A0 00                ldy     #$00
00000Br 1  B1 rr                lda     (sp),y
00000Dr 1  85 rr                sta     regbank+5
00000Fr 1  4C rr rr             jmp     incsp1
000012r 1               
000012r 1               .endproc
000012r 1               
000012r 1               
