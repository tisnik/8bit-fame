...
Main file   : local_add_7.asm
Current file: local_add_7.asm
...
000022r 1  85 rr                sta     regbank+3
000024r 1  C8                   iny
000025r 1  B1 rr                lda     (sp),y
000027r 1  85 rr                sta     regbank+4
000029r 1  C8                   iny
00002Ar 1  B1 rr                lda     (sp),y
00002Cr 1  85 rr                sta     regbank+5
00002Er 1  4C rr rr             jmp     incsp3
000031r 1               
000031r 1               .endproc
000031r 1               
000031r 1               
