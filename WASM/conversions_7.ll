; ModuleID = 'conversions_7.c'
source_filename = "conversions_7.c"
target datalayout = "e-m:e-p:32:32-p10:8:8-p20:8:8-i64:64-n32:64-S128-ni:1:10:20"
target triple = "wasm32"

; Function Attrs: mustprogress nofree norecurse nosync nounwind optsize willreturn memory(none)
define hidden i32 @unsigned_int_from_float(float noundef %0) local_unnamed_addr #0 {
  %2 = fptoui float %0 to i32
  ret i32 %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind optsize willreturn memory(none)
define hidden i64 @unsigned_long_from_float(float noundef %0) local_unnamed_addr #0 {
  %2 = fptoui float %0 to i64
  ret i64 %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind optsize willreturn memory(none)
define hidden i32 @unsigned_int_from_double(double noundef %0) local_unnamed_addr #0 {
  %2 = fptoui double %0 to i32
  ret i32 %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind optsize willreturn memory(none)
define hidden i64 @unsigned_long_from_double(double noundef %0) local_unnamed_addr #0 {
