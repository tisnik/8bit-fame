...
block:
        ...
        ld a, [hl]                          ; načíst třetí bajt spritu na řádku
        rra                                 ; posun doprava s nasunutím původního příznaku Carry, vysunutí nulového bitu do příznaku Carry
        ld [de], a
        inc hl                              ; posun na další bajt ve zdrojovém i cílovém spritu
        inc de

        ld a, [hl]                          ; načíst poslední bajt spritu na řádku
        rra                                 ; posun doprava s nasunutím původního příznaku Carry, vysunutí nulového bitu do příznaku Carry
        ld [de], a
        inc hl                              ; posun na další bajt ve zdrojovém i cílovém spritu
        inc de
...
SPRITE_ADR
        ...
        db %00000000, %00000000, %00000000, %11111111
        db %00000001, %11110000, %00010000, %11111111
        db %00000011, %00111000, %00010000, %11111111
        db %00000101, %11010111, %00010000, %11111111
        db %00000101, %11001100, %00010000, %11111111
        db %00000101, %00110000, %00010000, %11111111
        db %00000100, %11001000, %00010000, %11111111
        db %00000111, %00110110, %00010000, %11111111
        db %00001100, %11111110, %00111000, %11111111
        db %00011111, %11111000, %00000000, %11111111
        db %00000000, %00000000, %00110000, %11111111
        db %00000011, %11111111, %10110000, %11111111
        db %00000101, %11111110, %11100000, %11111111
        db %00001110, %11111101, %11000000, %11111111
        db %00011000, %11111100, %00000000, %11111111
        db %00011000, %00000000, %00000000, %11111111
        db %00000001, %11111000, %00000000, %11111111
        db %00000011, %11111100, %00000000, %11111111
        db %00000001, %10110000, %00000000, %11111111
        db %00000010, %00001100, %00000000, %11111111
        db %00000111, %00001110, %00000000, %11111111
        db %00011110, %00000111, %10000000, %11111111
        db %00000000, %00000000, %00000000, %11111111
SPRITE_SHIFT_0:
