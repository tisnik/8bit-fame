...
Main file   : pmg_10.asm
Current file: pmg_10.asm
...
00004Ar 1  9D 1E 9A             sta addr+PLAYER_0_OFFSET+30, x  ; uložit byte - první hráč
00004Dr 1  9D B2 9A             sta addr+PLAYER_1_OFFSET+50, x  ; uložit byte - druhý hráč
000050r 1  9D 46 9B             sta addr+PLAYER_2_OFFSET+70, x  ; uložit byte - třetí hráč
000053r 1  9D DA 9B             sta addr+PLAYER_3_OFFSET+90, x  ; uložit byte - čtvrtý hráč
...
00005Er 1               
00005Er 1  4C rr rr     loop:   jmp loop
000061r 1               .endproc
000061r 1               
000061r 1               ; data
000061r 1  18 3C 7E DB  sprite:   .byte 24, 60, 126, 219, 255, 36, 90, 165
000065r 1  FF 24 5A A5  
000069r 1               
000069r 1               end:
000069r 1               
000069r 1               
