...
000000r 1               .CODE
000000r 1               
000000r 1               .macro  fill_random_pixels address, size
000000r 1                       .local fills
000000r 1                       ldy #0                  ; počitadlo zápisů
000000r 1               fills:
000000r 1                       lda RANDOM
000000r 1                       sta address, y          ; tisk znaku osmice pixelu na zvolené místo na obrazovce
000000r 1                       iny                     ; zvětšit hodnotu počitadla a offsetu
000000r 1                       cpy size                ; test na koncovou hodnotu počitadla
000000r 1                       bne fills               ; skok, pokud Y>size
000000r 1                       ldy #0                  ; počitadlo zápisů
000000r 1               .endmacro
000000r 1               
000000r 1               
...
000017r 1               
000017r 1               loop:
000017r 1  A0 00 AD 0A          fill_random_pixels screen, 40*6
00001Br 1  D2 99 rr rr  
00001Fr 1  C8 C4 F0 D0  
000023r 1  F5 A0 00     
000026r 1  A0 00 AD 0A          fill_random_pixels screen+40*6, 40*6
00002Ar 1  D2 99 rr rr  
00002Er 1  C8 C4 F0 D0  
000032r 1  F5 A0 00     
000035r 1               
000035r 1  20 rr rr             jsr get_key
000038r 1  4C rr rr             jmp loop
00003Br 1               .endproc
00003Br 1               
00003Br 1               
00003Br 1               ; ---------------------------------------------------------------------
00003Br 1               ; čekání na stisk klávesy
00003Br 1               ; ---------------------------------------------------------------------
00003Br 1               .proc get_key
00003Br 1                       KBHANDLER = $e424       ; rutina pro cteni klavesy
00003Br 1  AD 25 E4             lda KBHANDLER+1         ; cteni horni casti adresy ulozene v ROM
00003Er 1  48                   pha                     ; ulozeni na zasobnik
00003Fr 1  AD 24 E4             lda KBHANDLER           ; cteni dolni casti adresy ulozene v ROM
000042r 1  48                   pha                     ; ulozeni na zasobnik
000043r 1  60                   rts                     ; vyber adresy ze zasobniku + skok
000044r 1                                               ; zde neni nutne mit RTS
000044r 1               .endproc
000044r 1               
000044r 1               dlist:
000044r 1  70 70 70     .byte DL_BLK8, DL_BLK8, DL_BLK8 ; 3x8=24 prázdných obrazových řádků
000047r 1  49           .byte DL_LMS+DL_MAP80x4x2       ; určení počáteční adresy obrazové paměti + jeden řádek režimu 9 (GR.4)
000048r 1  rr rr        .byte <screen, >screen          ; počáteční adresa obrazové paměti
00004Ar 1  09 09 09 09  .res 47, DL_MAP80x4x2           ; opakovat řádky grafického režimu 9 (GR.4)
...
000072r 1  09 09 09 09  
000076r 1  09 09 09     
000079r 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
00007Cr 1               
00007Cr 1               screen:                         ; video paměť
00007Cr 1               .include "image_80x48.asm"
00007Cr 2  FF FF FB BB  .byte $ff, $ff, $fb, $bb, $ff, $ff, $ff, $ff, $ff, $ff, $ff, $ff, $ff, $7f, $ff, $ff
000080r 2  FF FF FF FF  
000084r 2  FF FF FF FF  
000088r 2  FF 7F FF FF  
00008Cr 2  FF FF FF FF  .byte $ff, $ff, $ff, $ff, $ff, $ff, $ff, $7f, $ff, $ff, $ff, $ff, $ff, $ff, $ff, $ff
000090r 2  FF FF FF 7F  
000094r 2  FF FF FF FF  
000098r 2  FF FF FF FF  
00009Cr 2  FE 7F FF FF  .byte $fe, $7f, $ff, $ff, $ff, $ff, $ff, $ff, $ff, $ff, $fd, $7f, $ff, $ff, $ff, $ff
0000A0r 2  FF FF FF FF  
0000A4r 2  FF FF FD 7F  
0000A8r 2  FF FF FF FF  
0000ACr 2  FF FF FF F0  .byte $ff, $ff, $ff, $f0, $0d, $b0, $00, $00, $00, $00, $00, $00, $ff, $e0, $1b, $d8
0000B0r 2  0D B0 00 00  
0000B4r 2  00 00 00 00  
0000B8r 2  FF E0 1B D8  
0000BCr 2  00 00 00 00  .byte $00, $00, $00, $00, $00, $00, $ff, $e0, $0f, $f0, $00, $00, $00, $00, $00, $00
0000C0r 2  00 00 FF E0  
0000C4r 2  0F F0 00 00  
0000C8r 2  00 00 00 00  
0000CCr 2  FF C7 FF 3F  .byte $ff, $c7, $ff, $3f, $ff, $ff, $ff, $ff, $ff, $ff, $ff, $c7, $ff, $3f, $ff, $ff
0000D0r 2  FF FF FF FF  
0000D4r 2  FF FF FF C7  
0000D8r 2  FF 3F FF FF  
0000DCr 2  FF FF FF FF  .byte $ff, $ff, $ff, $ff, $ff, $8f, $fe, $7f, $ff, $ff, $ff, $ff, $ff, $ff, $ff, $8f
0000E0r 2  FF 8F FE 7F  
0000E4r 2  FF FF FF FF  
0000E8r 2  FF FF FF 8F  
0000ECr 2  FE 0F F0 00  .byte $fe, $0f, $f0, $00, $00, $00, $00, $00, $ff, $1f, $fc, $1f, $e0, $00, $00, $00
0000F0r 2  00 00 00 00  
0000F4r 2  FF 1F FC 1F  
0000F8r 2  E0 00 00 00  
0000FCr 2  00 00 FF 1F  .byte $00, $00, $ff, $1f, $fc, $1f, $e7, $fe, $7f, $ff, $9f, $fc, $fe, $3f, $f8, $3f
000100r 2  FC 1F E7 FE  
000104r 2  7F FF 9F FC  
000108r 2  FE 3F F8 3F  
00010Cr 2  CF FE 7F FF  .byte $cf, $fe, $7f, $ff, $9f, $fc, $fe, $3f, $f8, $3f, $cf, $fe, $7f, $ff, $3f, $fc
000110r 2  9F FC FE 3F  
000114r 2  F8 3F CF FE  
000118r 2  7F FF 3F FC  
00011Cr 2  FC 7F F0 7F  .byte $fc, $7f, $f0, $7f, $9f, $fe, $7f, $ff, $3f, $fc, $fc, $7f, $f8, $7f, $9f, $fe
000120r 2  9F FE 7F FF  
000124r 2  3F FC FC 7F  
000128r 2  F8 7F 9F FE  
00012Cr 2  7F FE 7F FC  .byte $7f, $fe, $7f, $fc, $f8, $ff, $f8, $ff, $3f, $fe, $7f, $fe, $7f, $fc, $f8, $ff
000130r 2  F8 FF F8 FF  
000134r 2  3F FE 7F FE  
000138r 2  7F FC F8 FF  
00013Cr 2  FC FF 3F FE  .byte $fc, $ff, $3f, $fe, $7f, $fc, $fe, $fc, $f1, $ff, $fc, $fe, $7e, $7e, $7e, $fc
000140r 2  7F FC FE FC  
000144r 2  F1 FF FC FE  
000148r 2  7E 7E 7E FC  
00014Cr 2  FC FC F1 FF  .byte $fc, $fc, $f1, $ff, $fe, $7e, $7e, $7e, $7c, $f9, $fc, $fc, $e0, $07, $fe, $7c
000150r 2  FE 7E 7E 7E  
000154r 2  7C F9 FC FC  
000158r 2  E0 07 FE 7C  
00015Cr 2  FC 7E 7C F9  .byte $fc, $7e, $7c, $f9, $f8, $fc, $e0, $03, $ff, $3c, $fe, $7e, $7f, $f3, $f8, $fc
000160r 2  F8 FC E0 03  
000164r 2  FF 3C FE 7E  
000168r 2  7F F3 F8 FC  
00016Cr 2  C7 FF FF 39  .byte $c7, $ff, $ff, $39, $fe, $7e, $7f, $f3, $fc, $fc, $c7, $ff, $ff, $99, $fe, $7e
000170r 2  FE 7E 7F F3  
000174r 2  FC FC C7 FF  
000178r 2  FF 99 FE 7E  
00017Cr 2  7F F9 FE FC  .byte $7f, $f9, $fe, $fc, $8f, $ff, $ff, $93, $fe, $7e, $7f, $fc, $ff, $fc, $8f, $ff
000180r 2  8F FF FF 93  
000184r 2  FE 7E 7F FC  
000188r 2  FF FC 8F FF  
00018Cr 2  FF C3 E0 7E  .byte $ff, $c3, $e0, $7e, $7c, $fe, $7f, $fc, $1f, $ff, $ff, $c7, $e0, $7e, $7c, $ff
000190r 2  7C FE 7F FC  
000194r 2  1F FF FF C7  
000198r 2  E0 7E 7C FF  
00019Cr 2  3F FC 1F FF  .byte $3f, $fc, $1f, $ff, $ff, $e7, $c0, $7e, $7c, $ff, $9f, $fc, $8f, $ff, $ff, $e7
0001A0r 2  FF E7 C0 7E  
0001A4r 2  7C FF 9F FC  
0001A8r 2  8F FF FF E7  
0001ACr 2  C0 7E 7C FF  .byte $c0, $7e, $7c, $ff, $cf, $fc, $8f, $ff, $ff, $f3, $80, $7e, $7c, $ff, $e7, $fc
0001B0r 2  CF FC 8F FF  
0001B4r 2  FF F3 80 7E  
0001B8r 2  7C FF E7 FC  
0001BCr 2  C0 0D F0 00  .byte $c0, $0d, $f0, $00, $00, $7e, $00, $00, $03, $fc, $c0, $15, $f8, $00, $00, $7e
0001C0r 2  00 7E 00 00  
0001C4r 2  03 FC C0 15  
0001C8r 2  F8 00 00 7E  
0001CCr 2  00 00 01 FC  .byte $00, $00, $01, $fc, $e3, $f9, $ef, $ff, $ff, $ff, $ff, $ff, $f8, $fc, $e3, $fd
0001D0r 2  E3 F9 EF FF  
0001D4r 2  FF FF FF FF  
0001D8r 2  F8 FC E3 FD  
0001DCr 2  CF FF FF FF  .byte $cf, $ff, $ff, $ff, $ff, $ff, $f8, $fd, $f1, $fd, $df, $ff, $ff, $ff, $ff, $ff
0001E0r 2  FF FF F8 FD  
0001E4r 2  F1 FD DF FF  
0001E8r 2  FF FF FF FF  
0001ECr 2  F8 FF F0 0D  .byte $f8, $ff, $f0, $0d, $d8, $00, $00, $00, $00, $00, $00, $ff, $f8, $10, $98, $00
0001F0r 2  D8 00 00 00  
0001F4r 2  00 00 00 FF  
0001F8r 2  F8 10 98 00  
0001FCr 2  00 00 00 00  .byte $00, $00, $00, $00, $00, $ff, $f8, $0e, $30, $08, $00, $04, $10, $00, $00, $fc
000200r 2  00 FF F8 0E  
000204r 2  30 08 00 04  
000208r 2  10 00 00 FC  
00020Cr 2  FF FE 3F F7  .byte $ff, $fe, $3f, $f7, $ff, $fb, $ef, $ff, $f8, $fb, $ff, $ff, $3f, $f1, $ff, $e7
000210r 2  FF FB EF FF  
000214r 2  F8 FB FF FF  
000218r 2  3F F1 FF E7  
00021Cr 2  9F FF F8 C9  .byte $9f, $ff, $f8, $c9, $ff, $ff, $9f, $f7, $ff, $cc, $3f, $ff, $f8, $0d, $ff, $ff
000220r 2  FF FF 9F F7  
000224r 2  FF CC 3F FF  
000228r 2  F8 0D FF FF  
00022Cr 2  9F E7 FF 81  .byte $9f, $e7, $ff, $81, $ff, $ff, $f8, $0c, $ff, $ff, $3e, $00, $3e, $3f, $ff, $ff
000230r 2  FF FF F8 0C  
000234r 2  FF FF 3E 00  
000238r 2  3E 3F FF FF  
00023Cr 2  FC 3E FF FF  .byte $fc, $3e, $ff, $ff, $20, $7f, $00, $7f, $ff, $ff, $fe, $fe, $ff, $fe, $43, $ff
000240r 2  20 7F 00 7F  
000244r 2  FF FF FE FE  
000248r 2  FF FE 43 FF  
00024Cr 2  FF FF FF 7F  .byte $ff, $ff, $ff, $7f, $ff, $ff, $ff, $fe, $0f, $ff, $ff, $ff, $ff, $ff, $ff, $ff
000250r 2  FF FF FF FE  
000254r 2  0F FF FF FF  
000258r 2  FF FF FF FF  
00025Cr 2               
00025Cr 1               
00025Cr 1               end:
00025Cr 1               
00025Cr 1               .segment "EXEHDR"
