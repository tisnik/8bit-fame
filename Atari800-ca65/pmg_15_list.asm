...
000028r 1               
000028r 1  A9 03                lda #3                  ; bitové pole: povolení hráčů i střel
00002Ar 1  8D 1D D0             sta GRACTL              ; uložit do řídicího registru GRACTL na čipu GTIA
00002Dr 1               
00002Dr 1  A9 00                lda #0                  ; priorita hráčů a pozadí
00002Fr 1  8D 6F 02             sta GPRIOR              ; uložit do řídicího registru GPRIOR na čipu GTIA
000032r 1               
000032r 1  A9 98                lda #152                ; paměťová stránka číslo 152
000034r 1  8D 07 D4             sta PMBASE
000037r 1               
000037r 1                       addr = 152*256
000037r 1  A2 0A                ldx #10                 ; začneme na hodnotě o 1 vyšší
000039r 1               next_line:
000039r 1  BD rr rr             lda sprite-1, x         ; načíst
00003Cr 1  9D B2 9A             sta addr+PLAYER_1_OFFSET+50, x  ; uložit byte - druhý hráč
00003Fr 1  9D 32 9B             sta addr+PLAYER_2_OFFSET+50, x  ; uložit byte - třetí hráč
000042r 1  9D B2 9B             sta addr+PLAYER_3_OFFSET+50, x  ; uložit byte - čtvrtý hráč
000045r 1  CA                   dex                     ; snížit offset + nastavit příznaky
000046r 1  D0 F1                bne next_line           ; další byte spritu
000048r 1               
000048r 1  A9 2E                lda #46                 ; povolení PMG DMA
00004Ar 1  8D 2F 02             sta SDMCTL
00004Dr 1               
00004Dr 1  A0 7F                ldy #127                ; počáteční vertikální pozice spritu
00004Fr 1               
00004Fr 1               loop:
00004Fr 1  20 rr rr             jsr _wait_vsync         ; čekat na překreslení snímku
000052r 1  20 rr rr             jsr _wait_vsync         ; dtto
000055r 1  20 rr rr             jsr _wait_vsync         ; dtto
000058r 1               
000058r 1  20 rr rr             jsr draw_at_y
00005Br 1  88                   dey                     ; vertikální posun
...
000061r 1               
000061r 1  A2 0A                ldx #10                 ; začneme na hodnotě o 1 vyšší
000063r 1               next_line:
...
000070r 1               
000070r 1               
000070r 1               .proc   _wait_vsync
000070r 1  A6 14                ldx     RTCLOK+2        ; čekání na konec snímku
000072r 1  E4 14        @wt:    cpx     RTCLOK+2
000074r 1  F0 FC                beq     @wt
000076r 1  60                   rts                     ; návrat z podprogramu
000077r 1               .endproc
000077r 1               
000077r 1               
000077r 1               ; data
000077r 1  00 18 3C 7E  sprite:   .byte 0, 24, 60, 126, 219, 255, 36, 90, 165, 0
00007Br 1  DB FF 24 5A  
00007Fr 1  A5 00        
000081r 1               
000081r 1               end:
000081r 1               
