...
Main file   : gtia_mode_5.asm
Current file: gtia_mode_5.asm
...
000000r 1               ; Postupná změna intenzity všech barev.
000000r 1               ; ---------------------------------------------------------------------
000000r 1               
...
00002Er 1               
00002Er 1  AD 6F 02             lda GPRIOR              ; modifikace stínového registru GPRIOR
000031r 1  09 C0                ora  #$c0               ; výběr GTIA režimu GR.11
000033r 1  8D 6F 02             sta GPRIOR
000036r 1               
000036r 1               
000036r 1                       ; postupná změna globálního odstínu (intenzity)
000036r 1  A9 00                lda #0                  ; barvový registr použití v režimu GR.9
000038r 1               next_color:
000038r 1  8D C8 02             sta COLOR4              ; ulozit nový kód barvy do registru COLOR2
00003Br 1  18           	clc
00003Cr 1  69 01        	adc #1                  ; a zvýšit kód barvy pro další iteraci
00003Er 1  48           	pha
00003Fr 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
000042r 1  68           	pla
000043r 1  4C rr rr     	jmp next_color          ; změna barvy + další čekání na klávesu
000046r 1               
000046r 1               
000046r 1  4C rr rr     loop:   jmp loop
000049r 1               .endproc
000049r 1               
000049r 1               
000049r 1               ; ---------------------------------------------------------------------
000049r 1               ; čekání na stisk klávesy
000049r 1               ; ---------------------------------------------------------------------
000049r 1               .proc get_key
000049r 1                       KBHANDLER = $e424       ; rutina pro cteni klavesy
000049r 1  AD 25 E4             lda KBHANDLER+1         ; cteni horni casti adresy ulozene v ROM
00004Cr 1  48                   pha                     ; ulozeni na zasobnik
00004Dr 1  AD 24 E4             lda KBHANDLER           ; cteni dolni casti adresy ulozene v ROM
000050r 1  48                   pha                     ; ulozeni na zasobnik
000051r 1  60                   rts                     ; vyber adresy ze zasobniku + skok
000052r 1                                               ; zde neni nutne mit RTS
000052r 1               .endproc
000052r 1               
000052r 1               
000052r 1               dlist:
000052r 1  70 70 70     .byte DL_BLK8, DL_BLK8, DL_BLK8 ; 3x8=24 prázdných obrazových řádků
000055r 1  4F           .byte DL_LMS+DL_MAP320x1x1      ; určení počáteční adresy obrazové paměti + jeden řádek režimu F (GR.8)
000056r 1  00 70        .byte <screen1, >screen1        ; počáteční adresa obrazové paměti (první blok)
000058r 1  0F 0F 0F 0F  .res 95, DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
00005Cr 1  0F 0F 0F 0F  
000060r 1  0F 0F 0F 0F  
000064r 1  0F 0F 0F 0F  
000068r 1  0F 0F 0F 0F  
00006Cr 1  0F 0F 0F 0F  
000070r 1  0F 0F 0F 0F  
000074r 1  0F 0F 0F 0F  
000078r 1  0F 0F 0F 0F  
00007Cr 1  0F 0F 0F 0F  
000080r 1  0F 0F 0F 0F  
000084r 1  0F 0F 0F 0F  
000088r 1  0F 0F 0F 0F  
00008Cr 1  0F 0F 0F 0F  
000090r 1  0F 0F 0F 0F  
000094r 1  0F 0F 0F 0F  
000098r 1  0F 0F 0F 0F  
00009Cr 1  0F 0F 0F 0F  
0000A0r 1  0F 0F 0F 0F  
0000A4r 1  0F 0F 0F 0F  
0000A8r 1  0F 0F 0F 0F  
0000ACr 1  0F 0F 0F 0F  
0000B0r 1  0F 0F 0F 0F  
0000B4r 1  0F 0F 0F     
0000B7r 1  4F           .byte DL_LMS+DL_MAP320x1x1      ; určení počáteční adresy obrazové paměti + jeden řádek režimu F (GR.8)
0000B8r 1  00 80        .byte <screen2, >screen2        ; počáteční adresa obrazové paměti (druhý blok)
0000BAr 1  0F 0F 0F 0F  .res 95, DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000BEr 1  0F 0F 0F 0F  
0000C2r 1  0F 0F 0F 0F  
0000C6r 1  0F 0F 0F 0F  
0000CAr 1  0F 0F 0F 0F  
0000CEr 1  0F 0F 0F 0F  
0000D2r 1  0F 0F 0F 0F  
0000D6r 1  0F 0F 0F 0F  
0000DAr 1  0F 0F 0F 0F  
...
000116r 1  0F 0F 0F     
000119r 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
00011Cr 1               
00011Cr 1               
00011Cr 1               end:
00011Cr 1               
00011Cr 1               .segment "EXEHDR"
