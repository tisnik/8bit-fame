...
Main file   : rainbow_5.asm
Current file: rainbow_5.asm
...
000021r 1               next_line:
000021r 1  8C 18 D0             sty COLPF2              ; změna barvy
000024r 1  C8                   iny                     ; další barva v paletě
000025r 1  EA EA EA EA          .repeat 10
000029r 1  EA EA EA EA  
00002Dr 1  EA EA        
00002Fr 1                       nop
00002Fr 1                       .endrepeat
00002Fr 1  A9 00                lda #0
000031r 1  8D 18 D0             sta COLPF2              ; změna barvy
000034r 1  8D 0A D4             sta WSYNC               ; čekání na další řádek
000037r 1               
000037r 1  CA                   dex
000038r 1  D0 E7                bne next_line           ; opakovat 192x
00003Ar 1  EE rr rr             inc color               ; počáteční barva pro další snímek
00003Dr 1  40                   rti                     ; návrat z DLI
00003Er 1               
00003Er 1               
00003Er 1               ; ---------------------------------------------------------------------
00003Er 1               ; display list
00003Er 1               ; ---------------------------------------------------------------------
00003Er 1               dlist:
00003Er 1  70 70 F0     .byte DL_BLK8, DL_BLK8, DL_DLI+DL_BLK8 ; 3x8=24 prázdných obrazových řádků
000041r 1  42           .byte DL_LMS+DL_CHR40x8x1       ; určení počáteční adresy obrazové paměti + jeden řádek režimu 2 (GR.0)
000042r 1  rr rr        .byte <screen, >screen          ; počáteční adresa obrazové paměti
000044r 1  02 02 02 02  .res 23, DL_CHR40x8x1           ; opakovat řádky textového režimu 2 (GR.0)
000048r 1  02 02 02 02  
00004Cr 1  02 02 02 02  
000050r 1  02 02 02 02  
000054r 1  02 02 02 02  
000058r 1  02 02 02     
00005Br 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
00005Er 1               
00005Er 1               end:
00005Er 1               
00005Er 1  00           color: .byte 0
00005Fr 1               
00005Fr 1               .BSS
