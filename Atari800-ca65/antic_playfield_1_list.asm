...
Main file   : antic_playfield_1.asm
Current file: antic_playfield_1.asm
...
000000r 1               
000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; nastavení spodních dvou bitů stínového registru SDMCTL
000000r 1               ; ---------------------------------------------------------------------
000000r 1               .macro  set_playfield_width bitfield
000000r 1                       lda SDMCTL              ; načíst stínový registr
000000r 1                       and #%11111100          ; vynulovat spodní dva bity
000000r 1                       ora  bitfield           ; nastavit spodní dva bity na zvolenou masku
000000r 1                       sta SDMCTL              ; a uložit zpět
000000r 1               .endmacro
000000r 1               
000000r 1               
000000r 1               ; ---------------------------------------------------------------------
...
00001Ar 1  F1           
00001Br 1               
00001Br 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
00001Er 1               
00001Er 1  AD 2F 02 29          set_playfield_width #%00
000022r 1  FC 09 00 8D  
000026r 1  2F 02        
000028r 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
00002Br 1               
00002Br 1  AD 2F 02 29          set_playfield_width #%01
00002Fr 1  FC 09 01 8D  
000033r 1  2F 02        
000035r 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
000038r 1               
000038r 1  AD 2F 02 29          set_playfield_width #%10
00003Cr 1  FC 09 02 8D  
000040r 1  2F 02        
000042r 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
000045r 1               
000045r 1  AD 2F 02 29          set_playfield_width #%11
000049r 1  FC 09 03 8D  
00004Dr 1  2F 02        
00004Fr 1               
00004Fr 1  4C rr rr             game_loop               ; hlavní herní smyčka
000052r 1               .endproc
000052r 1               
000052r 1               
000052r 1               ; ---------------------------------------------------------------------
000052r 1               ; čekání na stisk klávesy
000052r 1               ; ---------------------------------------------------------------------
000052r 1               .proc get_key
000052r 1                       KBHANDLER = $e424       ; rutina pro cteni klavesy
000052r 1  AD 25 E4             lda KBHANDLER+1         ; cteni horni casti adresy ulozene v ROM
000055r 1  48                   pha                     ; ulozeni na zasobnik
000056r 1  AD 24 E4             lda KBHANDLER           ; cteni dolni casti adresy ulozene v ROM
000059r 1  48                   pha                     ; ulozeni na zasobnik
00005Ar 1  60                   rts                     ; vyber adresy ze zasobniku + skok
00005Br 1                                               ; zde neni nutne mit RTS
00005Br 1               .endproc
00005Br 1               
00005Br 1               
00005Br 1               
00005Br 1               ; ---------------------------------------------------------------------
00005Br 1               ; display list
00005Br 1               ; ---------------------------------------------------------------------
00005Br 1               dlist:
00005Br 1  70 70 70     .byte DL_BLK8, DL_BLK8, DL_BLK8 ; 3x8=24 prázdných obrazových řádků
00005Er 1  42           .byte DL_LMS+DL_CHR40x8x1       ; určení počáteční adresy obrazové paměti + jeden řádek režimu 2 (GR.0)
00005Fr 1  rr rr        .byte <screen, >screen          ; počáteční adresa obrazové paměti
000061r 1  02 02 02 02  .res 23, DL_CHR40x8x1           ; opakovat řádky textového režimu 2 (GR.0)
000065r 1  02 02 02 02  
000069r 1  02 02 02 02  
00006Dr 1  02 02 02 02  
000071r 1  02 02 02 02  
000075r 1  02 02 02     
000078r 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
00007Br 1               
00007Br 1               
00007Br 1               end:
00007Br 1               
