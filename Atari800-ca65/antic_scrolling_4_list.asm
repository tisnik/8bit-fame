...
Main file   : antic_scrolling_4.asm
Current file: antic_scrolling_4.asm
...
000046r 1               not_down:
000046r 1  AD rr rr             lda x_scroll            ; změna horizontálního posunu
000049r 1  4A                   lsr A                   ; 4x "zpomalení"
00004Ar 1  4A                   lsr A
00004Br 1  8D 04 D4             sta HSCROL              ; zápis do řídicího registru ANTICu
00004Er 1               
00004Er 1  AD rr rr             lda y_scroll            ; změna vertikálního posunu
000051r 1  4A                   lsr A                   ; 4x "zpomalení"
000052r 1  4A                   lsr A
000053r 1  8D 05 D4             sta VSCROL              ; zápis do řídicího registru ANTICu
000056r 1               
000056r 1  AD rr rr 4A          print_hex x_scroll, screen, 40*23
00005Ar 1  4A 29 0F C9  
00005Er 1  0A 90 02 69  
000062r 1  06 69 10 8D  
000066r 1  rr rr        
000068r 1  AD rr rr 4A          print_hex y_scroll, screen, 40*23+2
00006Cr 1  4A 29 0F C9  
000070r 1  0A 90 02 69  
000074r 1  06 69 10 8D  
000078r 1  rr rr        
00007Ar 1  4C 62 E4             jmp XITVBV              ; zpracovat zbytek odloženého VBLANKu
00007Dr 1               .endproc
00007Dr 1               
00007Dr 1               
00007Dr 1               
00007Dr 1               ; ---------------------------------------------------------------------
00007Dr 1               ; display list
00007Dr 1               ; ---------------------------------------------------------------------
00007Dr 1               dlist:
00007Dr 1  70 70 70     .byte DL_BLK8, DL_BLK8, DL_BLK8 ; 3x8=24 prázdných obrazových řádků
000080r 1  42           .byte DL_LMS+DL_CHR40x8x1       ; určení počáteční adresy obrazové paměti + jeden řádek režimu 2 (GR.0)
000081r 1  rr rr        .byte <screen, >screen          ; počáteční adresa obrazové paměti
000083r 1  02 02 02 02  .res 11, DL_CHR40x8x1           ; opakovat řádky textového režimu 2 (GR.0)
000087r 1  02 02 02 02  
00008Br 1  02 02 02     
00008Er 1  32 32 32 32  .res 6,  DL_HSCROL+DL_VSCROL+DL_CHR40x8x1 ; zde bude povolen scrolling
000092r 1  32 32        
000094r 1  02 02 02 02  .res 6,  DL_CHR40x8x1           ; opakovat řádky textového režimu 2 (GR.0)
000098r 1  02 02        
