...
Main file   : antic_bitmap_1.asm
Current file: antic_bitmap_1.asm
...
000000r 1               ; make antic_bitmap_1.xex
000000r 1               ; ---------------------------------------------------------------------
000000r 1               
...
00001Ar 1  49           .byte DL_LMS+DL_MAP80x4x2       ; určení počáteční adresy obrazové paměti + jeden řádek režimu 9 (GR.4)
00001Br 1  rr rr        .byte <screen, >screen          ; počáteční adresa obrazové paměti
00001Dr 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
00001Er 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
00001Fr 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000020r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000021r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000022r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000023r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000024r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000025r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000026r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000027r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000028r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000029r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
00002Ar 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
00002Br 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
00002Cr 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
00002Dr 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
00002Er 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
00002Fr 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000030r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000031r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000032r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000033r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000034r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000035r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000036r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000037r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000038r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000039r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
00003Ar 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
00003Br 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
00003Cr 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
00003Dr 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
00003Er 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
00003Fr 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000040r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000041r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000042r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000043r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000044r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000045r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000046r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000047r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000048r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
000049r 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
00004Ar 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
00004Br 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
00004Cr 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
00004Fr 1               
00004Fr 1               screen:                         ; video paměť
00004Fr 1               .include "image_80x48.asm"
00004Fr 2  FF FF FB BB  .byte $ff, $ff, $fb, $bb, $ff, $ff, $ff, $ff, $ff, $ff, $ff, $ff, $ff, $7f, $ff, $ff
000053r 2  FF FF FF FF  
000057r 2  FF FF FF FF  
00005Br 2  FF 7F FF FF  
00005Fr 2  FF FF FF FF  .byte $ff, $ff, $ff, $ff, $ff, $ff, $ff, $7f, $ff, $ff, $ff, $ff, $ff, $ff, $ff, $ff
000063r 2  FF FF FF 7F  
000067r 2  FF FF FF FF  
00006Br 2  FF FF FF FF  
00006Fr 2  FE 7F FF FF  .byte $fe, $7f, $ff, $ff, $ff, $ff, $ff, $ff, $ff, $ff, $fd, $7f, $ff, $ff, $ff, $ff
000073r 2  FF FF FF FF  
000077r 2  FF FF FD 7F  
00007Br 2  FF FF FF FF  
00007Fr 2  FF FF FF F0  .byte $ff, $ff, $ff, $f0, $0d, $b0, $00, $00, $00, $00, $00, $00, $ff, $e0, $1b, $d8
000083r 2  0D B0 00 00  
000087r 2  00 00 00 00  
00008Br 2  FF E0 1B D8  
00008Fr 2  00 00 00 00  .byte $00, $00, $00, $00, $00, $00, $ff, $e0, $0f, $f0, $00, $00, $00, $00, $00, $00
000093r 2  00 00 FF E0  
000097r 2  0F F0 00 00  
00009Br 2  00 00 00 00  
00009Fr 2  FF C7 FF 3F  .byte $ff, $c7, $ff, $3f, $ff, $ff, $ff, $ff, $ff, $ff, $ff, $c7, $ff, $3f, $ff, $ff
0000A3r 2  FF FF FF FF  
0000A7r 2  FF FF FF C7  
0000ABr 2  FF 3F FF FF  
0000AFr 2  FF FF FF FF  .byte $ff, $ff, $ff, $ff, $ff, $8f, $fe, $7f, $ff, $ff, $ff, $ff, $ff, $ff, $ff, $8f
0000B3r 2  FF 8F FE 7F  
0000B7r 2  FF FF FF FF  
0000BBr 2  FF FF FF 8F  
0000BFr 2  FE 0F F0 00  .byte $fe, $0f, $f0, $00, $00, $00, $00, $00, $ff, $1f, $fc, $1f, $e0, $00, $00, $00
0000C3r 2  00 00 00 00  
0000C7r 2  FF 1F FC 1F  
0000CBr 2  E0 00 00 00  
0000CFr 2  00 00 FF 1F  .byte $00, $00, $ff, $1f, $fc, $1f, $e7, $fe, $7f, $ff, $9f, $fc, $fe, $3f, $f8, $3f
0000D3r 2  FC 1F E7 FE  
0000D7r 2  7F FF 9F FC  
0000DBr 2  FE 3F F8 3F  
0000DFr 2  CF FE 7F FF  .byte $cf, $fe, $7f, $ff, $9f, $fc, $fe, $3f, $f8, $3f, $cf, $fe, $7f, $ff, $3f, $fc
0000E3r 2  9F FC FE 3F  
0000E7r 2  F8 3F CF FE  
0000EBr 2  7F FF 3F FC  
0000EFr 2  FC 7F F0 7F  .byte $fc, $7f, $f0, $7f, $9f, $fe, $7f, $ff, $3f, $fc, $fc, $7f, $f8, $7f, $9f, $fe
0000F3r 2  9F FE 7F FF  
0000F7r 2  3F FC FC 7F  
0000FBr 2  F8 7F 9F FE  
0000FFr 2  7F FE 7F FC  .byte $7f, $fe, $7f, $fc, $f8, $ff, $f8, $ff, $3f, $fe, $7f, $fe, $7f, $fc, $f8, $ff
000103r 2  F8 FF F8 FF  
000107r 2  3F FE 7F FE  
00010Br 2  7F FC F8 FF  
00010Fr 2  FC FF 3F FE  .byte $fc, $ff, $3f, $fe, $7f, $fc, $fe, $fc, $f1, $ff, $fc, $fe, $7e, $7e, $7e, $fc
000113r 2  7F FC FE FC  
000117r 2  F1 FF FC FE  
00011Br 2  7E 7E 7E FC  
00011Fr 2  FC FC F1 FF  .byte $fc, $fc, $f1, $ff, $fe, $7e, $7e, $7e, $7c, $f9, $fc, $fc, $e0, $07, $fe, $7c
000123r 2  FE 7E 7E 7E  
000127r 2  7C F9 FC FC  
00012Br 2  E0 07 FE 7C  
00012Fr 2  FC 7E 7C F9  .byte $fc, $7e, $7c, $f9, $f8, $fc, $e0, $03, $ff, $3c, $fe, $7e, $7f, $f3, $f8, $fc
000133r 2  F8 FC E0 03  
000137r 2  FF 3C FE 7E  
00013Br 2  7F F3 F8 FC  
00013Fr 2  C7 FF FF 39  .byte $c7, $ff, $ff, $39, $fe, $7e, $7f, $f3, $fc, $fc, $c7, $ff, $ff, $99, $fe, $7e
000143r 2  FE 7E 7F F3  
000147r 2  FC FC C7 FF  
00014Br 2  FF 99 FE 7E  
00014Fr 2  7F F9 FE FC  .byte $7f, $f9, $fe, $fc, $8f, $ff, $ff, $93, $fe, $7e, $7f, $fc, $ff, $fc, $8f, $ff
000153r 2  8F FF FF 93  
000157r 2  FE 7E 7F FC  
00015Br 2  FF FC 8F FF  
00015Fr 2  FF C3 E0 7E  .byte $ff, $c3, $e0, $7e, $7c, $fe, $7f, $fc, $1f, $ff, $ff, $c7, $e0, $7e, $7c, $ff
000163r 2  7C FE 7F FC  
000167r 2  1F FF FF C7  
00016Br 2  E0 7E 7C FF  
00016Fr 2  3F FC 1F FF  .byte $3f, $fc, $1f, $ff, $ff, $e7, $c0, $7e, $7c, $ff, $9f, $fc, $8f, $ff, $ff, $e7
000173r 2  FF E7 C0 7E  
000177r 2  7C FF 9F FC  
00017Br 2  8F FF FF E7  
00017Fr 2  C0 7E 7C FF  .byte $c0, $7e, $7c, $ff, $cf, $fc, $8f, $ff, $ff, $f3, $80, $7e, $7c, $ff, $e7, $fc
000183r 2  CF FC 8F FF  
000187r 2  FF F3 80 7E  
00018Br 2  7C FF E7 FC  
00018Fr 2  C0 0D F0 00  .byte $c0, $0d, $f0, $00, $00, $7e, $00, $00, $03, $fc, $c0, $15, $f8, $00, $00, $7e
000193r 2  00 7E 00 00  
000197r 2  03 FC C0 15  
00019Br 2  F8 00 00 7E  
00019Fr 2  00 00 01 FC  .byte $00, $00, $01, $fc, $e3, $f9, $ef, $ff, $ff, $ff, $ff, $ff, $f8, $fc, $e3, $fd
0001A3r 2  E3 F9 EF FF  
0001A7r 2  FF FF FF FF  
0001ABr 2  F8 FC E3 FD  
0001AFr 2  CF FF FF FF  .byte $cf, $ff, $ff, $ff, $ff, $ff, $f8, $fd, $f1, $fd, $df, $ff, $ff, $ff, $ff, $ff
0001B3r 2  FF FF F8 FD  
0001B7r 2  F1 FD DF FF  
0001BBr 2  FF FF FF FF  
0001BFr 2  F8 FF F0 0D  .byte $f8, $ff, $f0, $0d, $d8, $00, $00, $00, $00, $00, $00, $ff, $f8, $10, $98, $00
0001C3r 2  D8 00 00 00  
0001C7r 2  00 00 00 FF  
0001CBr 2  F8 10 98 00  
0001CFr 2  00 00 00 00  .byte $00, $00, $00, $00, $00, $ff, $f8, $0e, $30, $08, $00, $04, $10, $00, $00, $fc
0001D3r 2  00 FF F8 0E  
0001D7r 2  30 08 00 04  
0001DBr 2  10 00 00 FC  
0001DFr 2  FF FE 3F F7  .byte $ff, $fe, $3f, $f7, $ff, $fb, $ef, $ff, $f8, $fb, $ff, $ff, $3f, $f1, $ff, $e7
0001E3r 2  FF FB EF FF  
0001E7r 2  F8 FB FF FF  
0001EBr 2  3F F1 FF E7  
0001EFr 2  9F FF F8 C9  .byte $9f, $ff, $f8, $c9, $ff, $ff, $9f, $f7, $ff, $cc, $3f, $ff, $f8, $0d, $ff, $ff
0001F3r 2  FF FF 9F F7  
0001F7r 2  FF CC 3F FF  
0001FBr 2  F8 0D FF FF  
0001FFr 2  9F E7 FF 81  .byte $9f, $e7, $ff, $81, $ff, $ff, $f8, $0c, $ff, $ff, $3e, $00, $3e, $3f, $ff, $ff
000203r 2  FF FF F8 0C  
000207r 2  FF FF 3E 00  
00020Br 2  3E 3F FF FF  
00020Fr 2  FC 3E FF FF  .byte $fc, $3e, $ff, $ff, $20, $7f, $00, $7f, $ff, $ff, $fe, $fe, $ff, $fe, $43, $ff
000213r 2  20 7F 00 7F  
000217r 2  FF FF FE FE  
00021Br 2  FF FE 43 FF  
00021Fr 2  FF FF FF 7F  .byte $ff, $ff, $ff, $7f, $ff, $ff, $ff, $fe, $0f, $ff, $ff, $ff, $ff, $ff, $ff, $ff
000223r 2  FF FF FF FE  
000227r 2  0F FF FF FF  
...
00022Fr 1               
00022Fr 1               ; ---------------------------------------------------------------------
00022Fr 1               ; definice segmentů vyžadovaných formátem XEX
00022Fr 1               ; ---------------------------------------------------------------------
00022Fr 1               .segment "EXEHDR"
