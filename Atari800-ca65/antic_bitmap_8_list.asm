...
Main file   : antic_bitmap_8.asm
Current file: antic_bitmap_8.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Grafický režim 160x96 se čtyřmi barvami.
000000r 1               ;
...
000000r 1               ; ---------------------------------------------------------------------
000000r 1               .proc main
000000r 1  A9 76                lda #$76                ; kod barvy
000002r 1  8D C4 02             sta COLOR0              ; ulozit do registru COLOR0
000005r 1               
000005r 1  A9 34                lda #$34                ; kod barvy
000007r 1  8D C5 02             sta COLOR1              ; ulozit do registru COLOR1
00000Ar 1               
00000Ar 1  A9 0C                lda #$0c                ; kod barvy
00000Cr 1  8D C6 02             sta COLOR2              ; ulozit do registru COLOR2
00000Fr 1               
00000Fr 1  A9 46                lda #$46                 ; kod barvy
000011r 1  8D C7 02             sta COLOR3              ; ulozit do registru COLOR3
000014r 1               
000014r 1  A9 rr                lda #<dlist             ; nižší byte adresy display listu
000016r 1  8D 30 02             sta SDLSTL
000019r 1  A9 rr                lda #>dlist             ; vyšší byte adresy display listu
00001Br 1  8D 31 02             sta SDLSTH
00001Er 1               
00001Er 1  4C rr rr     loop:   jmp loop
000021r 1               .endproc
000021r 1               
000021r 1               
000021r 1               
000021r 1               ; ---------------------------------------------------------------------
000021r 1               ; display list
000021r 1               ; ---------------------------------------------------------------------
000021r 1               dlist:
000021r 1  70 70 70     .byte DL_BLK8, DL_BLK8, DL_BLK8 ; 3x8=24 prázdných obrazových řádků
000024r 1  4D           .byte DL_LMS+DL_MAP160x2x4      ; určení počáteční adresy obrazové paměti + jeden řádek režimu B (GR.6)
000025r 1  rr rr        .byte <screen, >screen          ; počáteční adresa obrazové paměti
000027r 1  0D 0D 0D 0D  .res 95, DL_MAP160x2x4          ; opakovat řádky grafického režimu B (GR.6)
00002Br 1  0D 0D 0D 0D  
00002Fr 1  0D 0D 0D 0D  
000033r 1  0D 0D 0D 0D  
000037r 1  0D 0D 0D 0D  
00003Br 1  0D 0D 0D 0D  
00003Fr 1  0D 0D 0D 0D  
000043r 1  0D 0D 0D 0D  
000047r 1  0D 0D 0D 0D  
00004Br 1  0D 0D 0D 0D  
00004Fr 1  0D 0D 0D 0D  
000053r 1  0D 0D 0D 0D  
000057r 1  0D 0D 0D 0D  
00005Br 1  0D 0D 0D 0D  
00005Fr 1  0D 0D 0D 0D  
000063r 1  0D 0D 0D 0D  
000067r 1  0D 0D 0D 0D  
00006Br 1  0D 0D 0D 0D  
00006Fr 1  0D 0D 0D 0D  
000073r 1  0D 0D 0D 0D  
000077r 1  0D 0D 0D 0D  
00007Br 1  0D 0D 0D 0D  
00007Fr 1  0D 0D 0D 0D  
000083r 1  0D 0D 0D     
000086r 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
000089r 1               
000089r 1               screen:                         ; video paměť
000089r 1  FC 00 00 03  .incbin "image_160x96x2.bin"
00008Dr 1  00 00 00 30  
000091r 1  F3 C0 00 00  
000095r 1  02 A8 00 00  
000099r 1  00 00 00 00  
00009Dr 1  00 00 00 00  
0000A1r 1  2A AA AA AA  
0000A5r 1  AA AA AA AA  
0000A9r 1  AA AA AA AA  
0000ADr 1  AA AA AA 00  
0000B1r 1  C0 F0 F3 C3  
0000B5r 1  C3 3C 3C FC  
0000B9r 1  FF CC C3 CC  
0000BDr 1  F1 54 FF FC  
0000C1r 1  FF FC FF FC  
0000C5r 1  FF FC FF FC  
0000C9r 1  15 55 55 55  
0000CDr 1  55 55 55 55  
0000D1r 1  55 55 55 55  
0000D5r 1  55 55 56 80  
0000D9r 1  44 41 11 11  
0000DDr 1  11 10 10 10  
0000E1r 1  44 44 41 04  
0000E5r 1  43 FC 00 5C  
0000E9r 1  00 5C 00 5C  
000F89r 1               end:
000F89r 1               
000F89r 1               
000F89r 1               
000F89r 1               ; ---------------------------------------------------------------------
000F89r 1               ; definice segmentů vyžadovaných formátem XEX
000F89r 1               ; ---------------------------------------------------------------------
000F89r 1               .segment "EXEHDR"
