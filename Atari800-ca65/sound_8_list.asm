...
Main file   : sound_8.asm
Current file: sound_8.asm
...
000000r 1               
000000r 1               .proc main
000000r 1  A9 00                lda #00                 ; základní tón odvozený od 64kHz
000002r 1  8D 08 D2             sta AUDCTL              ; zápis do řídicího registru čipu POKEY
000005r 1               
000005r 1  A9 AA                lda #PURE_TONE_MASK+10  ; hlasitost (0-15)
000007r 1  8D 01 D2             sta AUDC1               ; zápis do registru řízení hlasitosti pro zvukový kanál číslo 1 čipu POKEY
00000Ar 1               
...
000017r 1  AE rr rr             ldx divider
00001Ar 1  AD 78 02             lda STICK0              ; čtení joysticku
00001Dr 1  C9 0B                cmp #11                 ; je nakloněn doleva?
00001Fr 1  D0 01                bne not_left
000021r 1  CA                   dex                     ; změna děliče
000022r 1               not_left:
000022r 1  C9 07                cmp #7                  ; je nakloněn doprava?
000024r 1  D0 01                bne not_right
000026r 1  E8                   inx                     ; změna děliče
000027r 1               not_right:
000027r 1  8E 00 D2             stx AUDF1               ; zápis do registru děliče frekvence pro zvukový kanál číslo 1 čipu POKEY
00002Ar 1  8E rr rr             stx divider
00002Dr 1  4C 62 E4             jmp XITVBV              ; zpracovat zbytek odloženého VBLANKu
000030r 1  60                   rts
000031r 1               .endproc
000031r 1               
000031r 1               ; dělič frekvence
000031r 1  47           divider: .byte 71
000032r 1               
000032r 1               
000032r 1               end:
000032r 1               
000032r 1               .segment "EXEHDR"
