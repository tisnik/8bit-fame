...
Main file   : antic_scrolling_2.asm
Current file: antic_scrolling_2.asm
...
000046r 1               not_down:
000046r 1  AD rr rr 4A          print_hex x_scroll, screen, 40*23
00004Ar 1  4A 29 0F C9  
00004Er 1  0A 90 02 69  
000052r 1  06 69 10 8D  
000056r 1  rr rr        
000058r 1  AD rr rr 4A          print_hex y_scroll, screen, 40*23+2
00005Cr 1  4A 29 0F C9  
000060r 1  0A 90 02 69  
000064r 1  06 69 10 8D  
000068r 1  rr rr        
00006Ar 1  4C 62 E4             jmp XITVBV              ; zpracovat zbytek odloženého VBLANKu
00006Dr 1               .endproc
00006Dr 1               
00006Dr 1               
00006Dr 1               
00006Dr 1               ; ---------------------------------------------------------------------
00006Dr 1               ; display list
00006Dr 1               ; ---------------------------------------------------------------------
00006Dr 1               dlist:
00006Dr 1  70 70 70     .byte DL_BLK8, DL_BLK8, DL_BLK8 ; 3x8=24 prázdných obrazových řádků
000070r 1  42           .byte DL_LMS+DL_CHR40x8x1       ; určení počáteční adresy obrazové paměti + jeden řádek režimu 2 (GR.0)
000071r 1  rr rr        .byte <screen, >screen          ; počáteční adresa obrazové paměti
000073r 1  02 02 02 02  .res 23, DL_CHR40x8x1           ; opakovat řádky textového režimu 2 (GR.0)
000077r 1  02 02 02 02  
00007Br 1  02 02 02 02  
00007Fr 1  02 02 02 02  
000083r 1  02 02 02 02  
000087r 1  02 02 02     
