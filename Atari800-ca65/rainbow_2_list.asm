...
Main file   : rainbow_2.asm
Current file: rainbow_2.asm
...
000024r 1  8D 0A D4             sta WSYNC               ; čekání na další řádek
000027r 1  C8                   iny                     ; další barva v paletě
000028r 1  CA                   dex
000029r 1  D0 F6                bne next_line           ; opakovat 192x
00002Br 1  EE rr rr             inc color               ; počáteční barva pro další snímek
00002Er 1  40                   rti                     ; návrat z DLI
00002Fr 1               
00002Fr 1               
00002Fr 1               ; ---------------------------------------------------------------------
00002Fr 1               ; display list
00002Fr 1               ; ---------------------------------------------------------------------
00002Fr 1               dlist:
00002Fr 1  70 70 F0     .byte DL_BLK8, DL_BLK8, DL_DLI+DL_BLK8 ; 3x8=24 prázdných obrazových řádků
000032r 1  42           .byte DL_LMS+DL_CHR40x8x1       ; určení počáteční adresy obrazové paměti + jeden řádek režimu 2 (GR.0)
000033r 1  rr rr        .byte <screen, >screen          ; počáteční adresa obrazové paměti
000035r 1  02 02 02 02  .res 23, DL_CHR40x8x1           ; opakovat řádky textového režimu 2 (GR.0)
000039r 1  02 02 02 02  
00003Dr 1  02 02 02 02  
000041r 1  02 02 02 02  
