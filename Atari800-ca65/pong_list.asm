...
000000r 1               
000000r 1               .proc main
000000r 1  A9 00                lda #0                  ; barva pozadí textu
000002r 1  8D C5 02             sta COLOR1              ; nastavit
000005r 1  8D C6 02             sta COLOR2              ; nastavit
000008r 1               
000008r 1  A9 46                lda #70                 ; horizontální pozice prvního hráče (číslice skóre)
00000Ar 1  8D 00 D0             sta HPOSP0              ; uložit do řídicího registru HPOSP0 na čipu GTIA
00000Dr 1               
00000Dr 1  A9 50                lda #80                 ; horizontální pozice druhého hráče (číslice skóre)
00000Fr 1  8D 01 D0             sta HPOSP1              ; uložit do řídicího registru HPOSP1 na čipu GTIA
000012r 1               
000012r 1  A9 A0                lda #160                ; horizontální pozice třetího hráče (číslice skóre)
000014r 1  8D 02 D0             sta HPOSP2              ; uložit do řídicího registru HPOSP2 na čipu GTIA
000017r 1               
000017r 1  A9 AA                lda #170                ; horizontální pozice čtvrtého hráče (číslice skóre)
000019r 1  8D 03 D0             sta HPOSP3              ; uložit do řídicího registru HPOSP3 na čipu GTIA
00001Cr 1               
00001Cr 1  A9 32                lda #50                 ; horizontální pozice první střely (pálka)
00001Er 1  8D 04 D0             sta HPOSM0              ; uložit do řídicího registru HPOSM0 na čipu GTIA
000021r 1               
000021r 1  A9 C8                lda #200                ; horizontální pozice druhé střely (pálka)
000023r 1  8D 05 D0             sta HPOSM1              ; uložit do řídicího registru HPOSM1 na čipu GTIA
000026r 1               
000026r 1  A9 A0                lda #160                ; horizontální pozice třetí střely (míček)
000028r 1  8D 06 D0             sta HPOSM2              ; uložit do řídicího registru HPOSM2 na čipu GTIA
00002Br 1               
00002Br 1  A9 80                lda #128                ; horizontální pozice čtvrté střely (síťka)
00002Dr 1  8D 07 D0             sta HPOSM3              ; uložit do řídicího registru HPOSM3 na čipu GTIA
000030r 1               
000030r 1  A9 CC                lda #HUE_GREEN<<4 + 12  ; barva prvního hráče (odstín+intenzita)
000032r 1  8D C0 02             sta PCOLR0              ; uložit do řídicího registru PCOLR0 na čipu GTIA
000035r 1               
000035r 1  A9 EC                lda #HUE_YELLOW<<4 + 12 ; barva druhého hráče (odstín+intenzita)
000037r 1  8D C1 02             sta PCOLR1              ; uložit do řídicího registru PCOLR1 na čipu GTIA
00003Ar 1               
00003Ar 1  A9 5C                lda #HUE_MAGENTA<<4 + 12 ; barva třetího hráče (odstín+intenzita)
00003Cr 1  8D C2 02             sta PCOLR2              ; uložit do řídicího registru PCOLR2 na čipu GTIA
00003Fr 1               
00003Fr 1  A9 9C                lda #HUE_CYAN<<4 + 12   ; barva čtvrtého hráče (odstín+intenzita)
000041r 1  8D C3 02             sta PCOLR3              ; uložit do řídicího registru PCOLR3 na čipu GTIA
000044r 1               
000044r 1  A9 03                lda #3                  ; bitové pole: povolení hráčů i střel
000046r 1  8D 1D D0             sta GRACTL              ; uložit do řídicího registru GRACTL na čipu GTIA
000049r 1               
000049r 1  A9 00                lda #0                  ; priorita hráčů a pozadí
00004Br 1  8D 6F 02             sta GPRIOR              ; uložit do řídicího registru GPRIOR na čipu GTIA
00004Er 1               
00004Er 1  A9 98                lda #152                ; paměťová stránka číslo 152
000050r 1  8D 07 D4             sta PMBASE
000053r 1               
000053r 1                       ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
000053r 1                       ;; Skóre
000053r 1                       ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
000053r 1                       addr = 152*256
000053r 1  A2 08                ldx #8                  ; začneme na hodnotě o 1 vyšší
000055r 1               next_line:
000055r 1  BD rr rr             lda number_0-1, x         ; načíst
000058r 1  9D 0A 9A             sta addr+PLAYER_0_OFFSET+SCORE_OFFSET, x  ; uložit byte - první hráč
00005Br 1  9D 8A 9A             sta addr+PLAYER_1_OFFSET+SCORE_OFFSET, x  ; uložit byte - druhý hráč
00005Er 1  9D 0A 9B             sta addr+PLAYER_2_OFFSET+SCORE_OFFSET, x  ; uložit byte - třetí hráč
000061r 1  9D 8A 9B             sta addr+PLAYER_3_OFFSET+SCORE_OFFSET, x  ; uložit byte - čtvrtý hráč
000064r 1  CA                   dex                     ; snížit offset + nastavit příznaky
000065r 1  D0 EE                bne next_line           ; další byte spritu
000067r 1               
000067r 1                       ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
000067r 1                       ;; Pálky
000067r 1                       ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
000067r 1  A2 14                ldx #20
000069r 1               missile_line:
000069r 1  A9 01                lda #%0000001           ; jen první střela (pálka)
00006Br 1  9D B2 99             sta addr+MISSILES_OFFSET+50, x
00006Er 1  A9 04                lda #%0000100           ; jen druhá střela (pálka)
000070r 1  9D C8 99             sta addr+MISSILES_OFFSET+72, x
000073r 1  CA                   dex
000074r 1  D0 F3                bne missile_line        ; další byte spritu
000076r 1               
000076r 1                       ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
000076r 1                       ;; Míček
000076r 1                       ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
000076r 1  A9 30                lda #%00110000          ; jen třetí střela (míček)
000078r 1  9D C6 99             sta addr+MISSILES_OFFSET+70, x
00007Br 1  9D C7 99             sta addr+MISSILES_OFFSET+71, x
00007Er 1               
00007Er 1                       ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
00007Er 1                       ;; Síťka
00007Er 1                       ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
00007Er 1  A2 7E                ldx #126
000080r 1               net:
000080r 1  BD 80 99             lda addr+MISSILES_OFFSET, x
000083r 1  09 40                ora #%1000000           ; jen čtvrtá střela (síťka)
000085r 1  9D 80 99             sta addr+MISSILES_OFFSET, x
000088r 1  CA                   dex
000089r 1  CA                   dex
00008Ar 1  D0 F4                bne net                 ; další byte spritu
00008Cr 1               
00008Cr 1  A9 2E                lda #46                 ; povolení PMG DMA
00008Er 1  8D 2F 02             sta SDMCTL
000091r 1               
000091r 1  4C rr rr     loop:   jmp loop
000094r 1               .endproc
000094r 1               
000094r 1               ; data
000094r 1  3C C3 C3 C3  number_0: .byte %00111100, %011000011, %011000011, %011000011, %011000011, %011000011, %00111100, 0
000098r 1  C3 C3 3C 00  
00009Cr 1               
00009Cr 1               end:
00009Cr 1               
00009Cr 1               
00009Cr 1               .segment "EXEHDR"
