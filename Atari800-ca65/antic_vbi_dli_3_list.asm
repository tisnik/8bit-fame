...
Main file   : antic_vbi_dli_3.asm
Current file: antic_vbi_dli_3.asm
...
000000r 1               ; ---------------------------------------------------------------------
000000r 1               .proc main
000000r 1  20 rr rr             jsr set_display_list    ; nastavení display listu
000003r 1  20 rr rr             jsr fill_screen         ; výpis znaků na obrazovku
000006r 1  20 rr rr             jsr setup_sprites
000009r 1  20 rr rr             jsr set_dli_handler     ; nastavení obsluhy DLI
00000Cr 1  20 rr rr             jsr set_vbi_handler     ; nastavení obsluhy VBI
00000Fr 1  20 rr rr             jsr enable_interrupts
000012r 1               
000012r 1               loop:
...
000015r 1               
000015r 1               ; ---------------------------------------------------------------------
000015r 1               ; subrutina pro vyplnění obrazovky znaky
000015r 1               ; ---------------------------------------------------------------------
000015r 1               .proc   fill_screen
000015r 1  A0 00                ldy #0                  ; počitadlo zápisů
000017r 1               clear:
000017r 1  98                   tya                     ; kód vypisovaného znaku
000018r 1  99 rr rr             sta screen, y           ; tisk znaku na zvolené místo na obrazovce
00001Br 1  99 rr rr             sta screen+40*8, y
00001Er 1  99 rr rr             sta screen+40*16, y
