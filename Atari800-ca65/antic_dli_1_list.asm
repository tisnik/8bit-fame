...
Main file   : antic_dli_1.asm
Current file: antic_dli_1.asm
...
000010r 1  99 rr rr             sta screen+40*12, y
000013r 1  C8                   iny                     ; zvětšit hodnotu počitadla a offsetu
000014r 1  D0 F6                bne clear               ; skok
000016r 1               
000016r 1  4C rr rr     loop:   jmp loop
000019r 1               .endproc
000019r 1               
000019r 1               
000019r 1               
000019r 1               ; ---------------------------------------------------------------------
000019r 1               ; display list
000019r 1               ; ---------------------------------------------------------------------
000019r 1               dlist:
000019r 1  70 70 70     .byte DL_BLK8, DL_BLK8, DL_BLK8 ; 3x8=24 prázdných obrazových řádků
00001Cr 1  42           .byte DL_LMS+DL_CHR40x8x1       ; určení počáteční adresy obrazové paměti + jeden řádek režimu 2 (GR.0)
00001Dr 1  rr rr        .byte <screen, >screen          ; počáteční adresa obrazové paměti
00001Fr 1  02 02 02 02  .res 23, DL_CHR40x8x1           ; opakovat řádky textového režimu 2 (GR.0)
000023r 1  02 02 02 02  
000027r 1  02 02 02 02  
00002Br 1  02 02 02 02  
00002Fr 1  02 02 02 02  
000033r 1  02 02 02     
000036r 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
000039r 1               
000039r 1               end:
000039r 1               
000039r 1               .BSS
