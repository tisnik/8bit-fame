...
Main file   : gtia_mode_6.asm
Current file: gtia_mode_6.asm
...
000000r 1               ; Přepnutí do GTIA režimu 10.
000000r 1               ; Specifikace barev pro PMG z výchozí černé barvy.
000000r 1               ; ---------------------------------------------------------------------
000000r 1               
...
000000r 1               
000000r 1               ; délka obrazového řádku v bajtech
000000r 1               scanline = 320/8
000000r 1               
000000r 1               
000000r 1               .proc main
...
00000Ar 1               
00000Ar 1  A9 00                lda #0                  ; zapisovaná hodnota + počitadlo smyčky
00000Cr 1  AA                   tax                     ; offset do obrazové paměti
00000Dr 1  18                   clc                     ; nechceme přičítat přenos
00000Er 1               draw:
00000Er 1  9D 00 70             sta screen1, x          ; zápis na první řádek
000011r 1  9D 28 70             sta screen1+scanline, x ; buranský zápis do sedmi obrazových řádků pod sebe
000014r 1  9D 50 70             sta screen1+scanline*2, x  ; pozn: jde použít opakování přes makro
000017r 1  9D 78 70             sta screen1+scanline*3, x
00001Ar 1  9D A0 70             sta screen1+scanline*4, x
00001Dr 1  9D C8 70             sta screen1+scanline*5, x
000020r 1  9D F0 70             sta screen1+scanline*6, x
000023r 1  9D 18 71             sta screen1+scanline*7, x
000026r 1  E8                   inx                     ; další zápis bude proveden o dva bajty dále
000027r 1  E8                   inx
000028r 1  69 01                adc #1                  ; zvýšení hodnoty v akumulátoru
00002Ar 1  C9 10                cmp #16                 ; konec smyčky?
00002Cr 1  D0 E0                bne draw                ; dokud není nula, pokračovat
00002Er 1               
00002Er 1  A9 CC                lda #HUE_GREEN<<4 + 12  ; barva prvního hráče (odstín+intenzita)
000030r 1  8D C0 02             sta PCOLR0              ; uložit do řídicího registru PCOLR0 na čipu GTIA
000033r 1               
000033r 1  A9 EC                lda #HUE_YELLOW<<4 + 12 ; barva druhého hráče (odstín+intenzita)
000035r 1  8D C1 02             sta PCOLR1              ; uložit do řídicího registru PCOLR1 na čipu GTIA
000038r 1               
000038r 1  A9 5C                lda #HUE_MAGENTA<<4 + 12 ; barva třetího hráče (odstín+intenzita)
00003Ar 1  8D C2 02             sta PCOLR2              ; uložit do řídicího registru PCOLR2 na čipu GTIA
00003Dr 1               
00003Dr 1  A9 9C                lda #HUE_CYAN<<4 + 12   ; barva čtvrtého hráče (odstín+intenzita)
00003Fr 1  8D C3 02             sta PCOLR3              ; uložit do řídicího registru PCOLR3 na čipu GTIA
000042r 1               
000042r 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
000045r 1               
000045r 1  AD 6F 02             lda GPRIOR              ; modifikace stínového registru GPRIOR
000048r 1  09 80                ora  #$80               ; výběr GTIA režimu GR.11
00004Ar 1  8D 6F 02             sta GPRIOR
00004Dr 1               
00004Dr 1  4C rr rr     loop:   jmp loop
000050r 1               .endproc
000050r 1               
000050r 1               
000050r 1               ; ---------------------------------------------------------------------
000050r 1               ; čekání na stisk klávesy
000050r 1               ; ---------------------------------------------------------------------
000050r 1               .proc get_key
000050r 1                       KBHANDLER = $e424       ; rutina pro cteni klavesy
000050r 1  AD 25 E4             lda KBHANDLER+1         ; cteni horni casti adresy ulozene v ROM
000053r 1  48                   pha                     ; ulozeni na zasobnik
000054r 1  AD 24 E4             lda KBHANDLER           ; cteni dolni casti adresy ulozene v ROM
000057r 1  48                   pha                     ; ulozeni na zasobnik
000058r 1  60                   rts                     ; vyber adresy ze zasobniku + skok
000059r 1                                               ; zde neni nutne mit RTS
000059r 1               .endproc
000059r 1               
000059r 1               
000059r 1               dlist:
000059r 1  70 70 70     .byte DL_BLK8, DL_BLK8, DL_BLK8 ; 3x8=24 prázdných obrazových řádků
00005Cr 1  4F           .byte DL_LMS+DL_MAP320x1x1      ; určení počáteční adresy obrazové paměti + jeden řádek režimu F (GR.8)
00005Dr 1  00 70        .byte <screen1, >screen1        ; počáteční adresa obrazové paměti (první blok)
00005Fr 1  0F 0F 0F 0F  .res 95, DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000063r 1  0F 0F 0F 0F  
000067r 1  0F 0F 0F 0F  
00006Br 1  0F 0F 0F 0F  
00006Fr 1  0F 0F 0F 0F  
000073r 1  0F 0F 0F 0F  
000077r 1  0F 0F 0F 0F  
00007Br 1  0F 0F 0F 0F  
00007Fr 1  0F 0F 0F 0F  
000083r 1  0F 0F 0F 0F  
000087r 1  0F 0F 0F 0F  
00008Br 1  0F 0F 0F 0F  
00008Fr 1  0F 0F 0F 0F  
000093r 1  0F 0F 0F 0F  
000097r 1  0F 0F 0F 0F  
00009Br 1  0F 0F 0F 0F  
00009Fr 1  0F 0F 0F 0F  
0000A3r 1  0F 0F 0F 0F  
0000A7r 1  0F 0F 0F 0F  
0000ABr 1  0F 0F 0F 0F  
0000AFr 1  0F 0F 0F 0F  
0000B3r 1  0F 0F 0F 0F  
0000B7r 1  0F 0F 0F 0F  
0000BBr 1  0F 0F 0F     
0000BEr 1  4F           .byte DL_LMS+DL_MAP320x1x1      ; určení počáteční adresy obrazové paměti + jeden řádek režimu F (GR.8)
0000BFr 1  00 80        .byte <screen2, >screen2        ; počáteční adresa obrazové paměti (druhý blok)
0000C1r 1  0F 0F 0F 0F  .res 95, DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000C5r 1  0F 0F 0F 0F  
0000C9r 1  0F 0F 0F 0F  
0000CDr 1  0F 0F 0F 0F  
0000D1r 1  0F 0F 0F 0F  
0000D5r 1  0F 0F 0F 0F  
0000D9r 1  0F 0F 0F 0F  
0000DDr 1  0F 0F 0F 0F  
0000E1r 1  0F 0F 0F 0F  
0000E5r 1  0F 0F 0F 0F  
0000E9r 1  0F 0F 0F 0F  
0000EDr 1  0F 0F 0F 0F  
0000F1r 1  0F 0F 0F 0F  
0000F5r 1  0F 0F 0F 0F  
0000F9r 1  0F 0F 0F 0F  
0000FDr 1  0F 0F 0F 0F  
000101r 1  0F 0F 0F 0F  
000105r 1  0F 0F 0F 0F  
000109r 1  0F 0F 0F 0F  
00010Dr 1  0F 0F 0F 0F  
000111r 1  0F 0F 0F 0F  
000115r 1  0F 0F 0F 0F  
000119r 1  0F 0F 0F 0F  
00011Dr 1  0F 0F 0F     
000120r 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
000123r 1               
000123r 1               
000123r 1               end:
000123r 1               
000123r 1               .segment "EXEHDR"
