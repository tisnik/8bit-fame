...
Main file   : hex_number_5.asm
Current file: hex_number_5.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Tisk jedné hexadecimální číslice, varianta postavená na makrech, lokální automaticky generovaná návěští
000000r 1               ;
...
000000r 1               ; ---------------------------------------------------------------------
000000r 1               
000000r 1               .macro hex_digit
000000r 1                       cmp #$0a                ; test na hodnotu 0-9 nebo 10-15
000000r 1                       bcc :+                  ; je to hodnota 0-9
...
000000r 1               
000000r 1               
000000r 1               .macro print_char
000000r 1                       ldy #0                  ; vynulovat registr Y
000000r 1                       sta (88), y             ; tisk znaku na první místo na obrazovce
000000r 1                                               ; (adresa Video RAM je na adresách 88 a 89)
000000r 1               .endmacro
000000r 1               
000000r 1               
000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Kodovy segment
000000r 1               ; ---------------------------------------------------------------------
000000r 1               
000000r 1               .CODE
000000r 1               
