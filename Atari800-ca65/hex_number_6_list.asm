...
000014r 1               
000014r 1               
000014r 1               .proc nibble_to_hex_char
000014r 1  C9 0A                cmp #$0a                ; test na hodnotu 0-9 nebo 10-15
000016r 1  90 02                bcc skip_add            ; je to hodnota 0-9
000018r 1  69 06                adc #6                  ; pricist sedmicku (6+carry)
00001Ar 1               skip_add:
00001Ar 1  69 10                adc #16                 ; prevod hodnoty na interni kod (ne ATASCII!)
00001Cr 1  60                   rts                     ; navrat z podprogramu
00001Dr 1               .endproc
00001Dr 1               
00001Dr 1               
00001Dr 1               .proc print_char
00001Dr 1  A0 00                ldy #0                  ; vynulovat registr Y
00001Fr 1  91 58                sta (88), y             ; tisk znaku na první místo na obrazovce
000021r 1                                               ; (adresa Video RAM je na adresách 88 a 89)
000021r 1  60                   rts
000022r 1               .endproc
000022r 1               
000022r 1               end:                            ; potrebujeme znat adresu konce kodoveho segmentu
000022r 1               
000022r 1               
