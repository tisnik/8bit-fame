...
Main file   : key_05.asm
Current file: key_05.asm
...
000000r 1               ; ---------------------------------------------------------------------
000000r 1               .proc main
000000r 1                       ; nastavit vektor pro BREAK
000000r 1  A9 rr                lda #>break_handler
000002r 1  8D 37 02             sta BRKKY+1
000005r 1  A9 rr                lda #<break_handler
000007r 1  8D 36 02             sta BRKKY
00000Ar 1               loop:
00000Ar 1  4C rr rr             jmp loop
00000Dr 1               .endproc
00000Dr 1               
00000Dr 1               
00000Dr 1               
00000Dr 1               ; ---------------------------------------------------------------------
00000Dr 1               ; Subrutina pro obsluhu stisku klavesy BREAK
00000Dr 1               ; ---------------------------------------------------------------------
00000Dr 1               .proc   break_handler
00000Dr 1  A9 22                lda #34                 ; kod znaku "B"
00000Fr 1  A0 01                ldy #1
000011r 1  91 58                sta (88), y             ; tisk znaku na první místo na obrazovce
000013r 1                                               ; (adresa Video RAM je na adresách 88 a 89)
000013r 1  40                   rti
000014r 1               .endproc
000014r 1               
000014r 1               end:                            ; potrebujeme znat adresu konce kodoveho segmentu
000014r 1               
000014r 1               
000014r 1               .segment "EXEHDR"
