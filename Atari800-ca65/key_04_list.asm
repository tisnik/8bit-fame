...
Main file   : key_04.asm
Current file: key_04.asm
...
000000r 1               .proc main
000000r 1               loop:
000000r 1  20 rr rr             jsr get_key             ; načíst kód stisknuté klávesy
000003r 1  20 rr rr             jsr print_2_hex_digits  ; tisk kódu stiknuté klávesy
000006r 1  4C rr rr             jmp loop
000009r 1               .endproc
000009r 1               
000009r 1               
000009r 1               
000009r 1               ; ---------------------------------------------------------------------
000009r 1               ; Tisk hodnoty 0..255 formou dvou hexadecimálních číslic
000009r 1               ; ---------------------------------------------------------------------
000009r 1               .proc print_2_hex_digits
000009r 1  48                   pha                     ; ulozit akumulator na zasobnik
00000Ar 1  4A 4A 4A 4A          lsr_ 4                  ; posun 4 nejvyssich bitu do bitu nejnizsich
00000Er 1  20 rr rr             jsr nibble_to_hex_char  ; prevod na interni kod cislice
000011r 1  A0 00                ldy #0                  ; pozice na obrazovce
000013r 1  20 rr rr             jsr print_char_at_y     ; tisk cislice/znaku
000016r 1               
000016r 1  68                   pla
000017r 1  29 0F                and #$0f                ; ziskat jen nizsi nibble
000019r 1  20 rr rr             jsr nibble_to_hex_char  ; prevod na interni kod cislice
00001Cr 1  A0 01                ldy #1                  ; pozice na obrazovce
00001Er 1  20 rr rr             jsr print_char_at_y     ; tisk cislice/znaku
000021r 1               .endproc
000021r 1               
000021r 1               
000021r 1               
000021r 1               ; ---------------------------------------------------------------------
000021r 1               ; Převod hodnoty 0..15 na jeden hexadecimální znak
000021r 1               ; ---------------------------------------------------------------------
000021r 1               .proc nibble_to_hex_char
000021r 1  C9 0A                cmp #$0a                ; test na hodnotu 0-9 nebo 10-15
000023r 1  90 02                bcc skip_add            ; je to hodnota 0-9
000025r 1  69 06                adc #6                  ; pricist sedmicku (6+carry)
000027r 1               skip_add:
000027r 1  69 10                adc #16                 ; prevod hodnoty na interni kod (ne ATASCII!)
000029r 1  60                   rts                     ; navrat z podprogramu
00002Ar 1               .endproc
00002Ar 1               
00002Ar 1               
00002Ar 1               
00002Ar 1               ; ---------------------------------------------------------------------
00002Ar 1               ; Tisk znaku (v akumulátoru) na offset definovaný v index registru Y
00002Ar 1               ; ---------------------------------------------------------------------
00002Ar 1               .proc print_char_at_y
00002Ar 1  91 58                sta (88), y             ; tisk znaku na první místo na obrazovce
00002Cr 1                                               ; (adresa Video RAM je na adresách 88 a 89)
00002Cr 1  60                   rts
00002Dr 1               .endproc
00002Dr 1               
00002Dr 1               
00002Dr 1               
00002Dr 1               ; ---------------------------------------------------------------------
00002Dr 1               ; Přečtení kódu naposledy stisknuté klávesy, kód se vrátí v registru A
00002Dr 1               ; ---------------------------------------------------------------------
00002Dr 1               .proc get_key
00002Dr 1  AD 25 E4             lda KBHANDLER+1         ; cteni horni casti adresy ulozene v ROM
000030r 1  48                   pha                     ; ulozeni na zasobnik
000031r 1  AD 24 E4             lda KBHANDLER           ; cteni dolni casti adresy ulozene v ROM
000034r 1  48                   pha                     ; ulozeni na zasobnik
000035r 1  60                   rts                     ; vyber adresy ze zasobniku + skok
000036r 1                                               ; zde neni nutne mit RTS
000036r 1               .endproc
000036r 1               
000036r 1               end:                            ; potrebujeme znat adresu konce kodoveho segmentu
000036r 1               
000036r 1               
000036r 1               .segment "EXEHDR"
