...
Main file   : cio_write_byte_3.asm
Current file: cio_write_byte_3.asm
...
000006r 1  20 rr rr             jsr WRITE_BYTE_CHANNEL_4
000009r 1  20 rr rr     	jsr CHECK_ERROR
00000Cr 1               loop:
00000Cr 1  4C rr rr             jmp loop                ; program vlastně nice nedělá - jen cyklí!
00000Fr 1               .endproc
00000Fr 1               
00000Fr 1               
00000Fr 1               
...
000058r 1               
000058r 1               ; ---------------------------------------------------------------------
000058r 1               ; kontrola chyby při zápisu
000058r 1               ; ---------------------------------------------------------------------
000058r 1               .proc CHECK_ERROR
000058r 1  A2 40                ldx #IOCB4              ; offset odvozený od čísla IOCB kanálu
00005Ar 1               
00005Ar 1  BD 43 03     	lda ICSTA, x            ; status poslední operace
00005Dr 1  10 06        	bpl ok                  ; test bitu 7
00005Fr 1               
00005Fr 1  A9 12                lda #18                 ; kod barvy
000061r 1  8D C6 02             sta COLOR2              ; ulozit do registru COLOR2
000064r 1  60                   rts                     ; návrat ze subrutiny
000065r 1               ok:
000065r 1  A9 C3                lda #$c3                ; kod barvy
000067r 1  8D C6 02             sta COLOR2              ; ulozit do registru COLOR2
00006Ar 1  60                   rts                     ; návrat ze subrutiny
00006Br 1               .endproc
00006Br 1               
00006Br 1               ; jméno zařízení (+ jméno souboru) ukončené nulou
00006Br 1  48 3A 54 45  device_name: .byte "H:TEST.TXT", 0
00006Fr 1  53 54 2E 54  
000073r 1  58 54 00     
000076r 1               
000076r 1               ; zapisovaný bajt
000076r 1  41           char_to_put: .byte $41
000077r 1               
000077r 1               end:
000077r 1               
000077r 1               
000077r 1               .segment "EXEHDR"
