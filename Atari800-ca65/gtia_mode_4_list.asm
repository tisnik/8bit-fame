...
Main file   : gtia_mode_4.asm
Current file: gtia_mode_4.asm
...
00002Er 1               
00002Er 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
000031r 1               
000031r 1  A9 0F                lda #15                 ; intenzita barev
000033r 1  8D C8 02             sta COLOR4              ; ulozit nový kód barvy do registru COLOR2
000036r 1               
000036r 1  AD 6F 02             lda GPRIOR              ; modifikace stínového registru GPRIOR
000039r 1  09 C0                ora  #$c0               ; výběr GTIA režimu GR.11
00003Br 1  8D 6F 02             sta GPRIOR
00003Er 1               
00003Er 1  4C rr rr     loop:   jmp loop
000041r 1               .endproc
000041r 1               
000041r 1               
000041r 1               ; ---------------------------------------------------------------------
000041r 1               ; čekání na stisk klávesy
000041r 1               ; ---------------------------------------------------------------------
000041r 1               .proc get_key
000041r 1                       KBHANDLER = $e424       ; rutina pro cteni klavesy
000041r 1  AD 25 E4             lda KBHANDLER+1         ; cteni horni casti adresy ulozene v ROM
000044r 1  48                   pha                     ; ulozeni na zasobnik
000045r 1  AD 24 E4             lda KBHANDLER           ; cteni dolni casti adresy ulozene v ROM
000048r 1  48                   pha                     ; ulozeni na zasobnik
000049r 1  60                   rts                     ; vyber adresy ze zasobniku + skok
00004Ar 1                                               ; zde neni nutne mit RTS
00004Ar 1               .endproc
00004Ar 1               
00004Ar 1               
00004Ar 1               dlist:
00004Ar 1  70 70 70     .byte DL_BLK8, DL_BLK8, DL_BLK8 ; 3x8=24 prázdných obrazových řádků
00004Dr 1  4F           .byte DL_LMS+DL_MAP320x1x1      ; určení počáteční adresy obrazové paměti + jeden řádek režimu F (GR.8)
00004Er 1  00 70        .byte <screen1, >screen1        ; počáteční adresa obrazové paměti (první blok)
000050r 1  0F 0F 0F 0F  .res 95, DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000054r 1  0F 0F 0F 0F  
000058r 1  0F 0F 0F 0F  
...
0000ACr 1  0F 0F 0F     
0000AFr 1  4F           .byte DL_LMS+DL_MAP320x1x1      ; určení počáteční adresy obrazové paměti + jeden řádek režimu F (GR.8)
0000B0r 1  00 80        .byte <screen2, >screen2        ; počáteční adresa obrazové paměti (druhý blok)
0000B2r 1  0F 0F 0F 0F  .res 95, DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000B6r 1  0F 0F 0F 0F  
0000BAr 1  0F 0F 0F 0F  
...
00010Er 1  0F 0F 0F     
000111r 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
000114r 1               
000114r 1               
000114r 1               end:
000114r 1               
000114r 1               .segment "EXEHDR"
