...
Main file   : antic_vbi_dli_1.asm
Current file: antic_vbi_dli_1.asm
...
0000AEr 1               
0000AEr 1               ; ---------------------------------------------------------------------
0000AEr 1               ; obsluha DLI
0000AEr 1               ; ---------------------------------------------------------------------
0000AEr 1               dli:
0000AEr 1  48                   pha                     ; uschovat akumulátor
0000AFr 1  AD rr rr             lda color               ; barva pozadí
0000B2r 1  8D 18 D0             sta COLPF2              ; přímo nastavit zápisem do HW registru
0000B5r 1  49 80                eor #%10000000          ; negovat nejvyšší bit
0000B7r 1  8D rr rr             sta color
0000BAr 1  68                   pla                     ; obnovit akumulátor
0000BBr 1  40                   rti                     ; návrat z DLI
0000BCr 1               
0000BCr 1               
0000BCr 1               dlist:
0000BCr 1  70 70 70     .byte DL_BLK8, DL_BLK8, DL_BLK8 ; 3x8=24 prázdných obrazových řádků
0000BFr 1  42           .byte DL_LMS+DL_CHR40x8x1       ; určení počáteční adresy obrazové paměti + jeden řádek režimu 2 (GR.0)
0000C0r 1  rr rr        .byte <screen, >screen          ; počáteční adresa obrazové paměti
0000C2r 1  02 02 02 02  .res 6, DL_CHR40x8x1            ; opakovat řádky textového režimu 2 (GR.0)
0000C6r 1  02 02        
0000C8r 1  82           .byte DL_DLI+DL_CHR40x8x1       ; GR.0 ovšem navíc s povolením DLI
0000C9r 1  02 02 02 02  .res 7, DL_CHR40x8x1            ; opakovat řádky textového režimu 2 (GR.0)
0000CDr 1  02 02 02     
0000D0r 1  82           .byte DL_DLI+DL_CHR40x8x1       ; GR.0 ovšem navíc s povolením DLI
0000D1r 1  02 02 02 02  .res 8, DL_CHR40x8x1            ; opakovat řádky textového režimu 2 (GR.0)
0000D5r 1  02 02 02 02  
0000D9r 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
0000DCr 1               
0000DCr 1               
0000DCr 1               color:
0000DCr 1  C4           .byte $c4                       ; původní barva
0000DDr 1               
0000DDr 1               
0000DDr 1               ; data
0000DDr 1  18 3C 7E DB  sprite:   .byte 24, 60, 126, 219, 255, 36, 90, 165
0000E1r 1  FF 24 5A A5  
0000E5r 1               
0000E5r 1               ; horizontální pozice hráče
0000E5r 1  50           x_pos:    .byte 80
0000E6r 1               
0000E6r 1               end:
0000E6r 1               
0000E6r 1               
