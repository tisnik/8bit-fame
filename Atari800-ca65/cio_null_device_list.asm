...
Main file   : cio_null_device.asm
Current file: cio_null_device.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Nulové zařízení N: vracející status "ok" pro všechny operace.
000000r 1               ;
...
000000r 1               ; make cio_null_device.xex
000000r 1               ; ---------------------------------------------------------------------
000000r 1               
...
000012r 1               
000012r 1               ; ---------------------------------------------------------------------
000012r 1               ; registrace nového zařízení
000012r 1               ; ---------------------------------------------------------------------
000012r 1               .proc REGISTER_NULL_DEVICE
000012r 1               
000012r 1               insert:
000012r 1  A2 00                ldx #0
000014r 1               next_place:
000014r 1  BD 1A 03             lda HATABS, x
000017r 1  F0 07                beq empty_place
000019r 1  E8                   inx
00001Ar 1  E8                   inx
00001Br 1  E8                   inx
00001Cr 1  D0 F6                bne next_place
00001Er 1  F0 F2                beq insert
000020r 1               empty_place:
000020r 1  A9 4E                lda #'N'
000022r 1  9D 1A 03             sta HATABS, x
000025r 1  A9 rr                lda #<null_table
000027r 1  9D 1B 03             sta HATABS+1, x
00002Ar 1  A9 rr                lda #>null_table
00002Cr 1  9D 1C 03             sta HATABS+2, x
00002Fr 1  60                   rts                     ; návrat ze subrutiny
000030r 1               .endproc
000030r 1               
000030r 1               
000030r 1               
...
00003Fr 1               ; ---------------------------------------------------------------------
00003Fr 1               .proc OPEN_CHANNEL_4_AS_N
...
000094r 1  rr rr                .word NULL_HANDLER-1    ; OPEN
000096r 1  rr rr                .word NULL_HANDLER-1    ; CLOSE
000098r 1  rr rr                .word NULL_HANDLER-1    ; GET
00009Ar 1  rr rr                .word NULL_HANDLER-1    ; PUT
00009Cr 1  rr rr                .word NULL_HANDLER-1    ; STATUS
00009Er 1  rr rr                .word NULL_HANDLER-1    ; SPECIAL
0000A0r 1  4C rr rr             jmp NULL_HANDLER        ; inicializace zařízení
0000A3r 1               end:
0000A3r 1               
0000A3r 1               
0000A3r 1               
0000A3r 1               .segment "EXEHDR"
