...
Main file   : sound_E.asm
Current file: sound_E.asm
...
000008r 1               
000008r 1  A2 00                ldx #0                  ; vynulovat počitadlo
00000Ar 1               loop:
00000Ar 1  BD rr rr             lda delays, x           ; načtení doby trvání
00000Dr 1  8D rr rr             sta msc
000010r 1               l0:
000010r 1  BD rr rr             lda volumes, x          ; načtení amplitudy
000013r 1  8D 01 D2             sta AUDC1               ; přímý zápis amplitudy (včetně bitu číslo 5)
000016r 1  AC rr rr             ldy tempo
000019r 1               l1:
000019r 1  88                   dey                     ; krátká zpožďovací smyčka
00001Ar 1  D0 FD                bne l1
00001Cr 1  CE rr rr             dec msc
00001Fr 1  D0 EF                bne l0                  ; vnější zpožďovací smyčka
000021r 1               
000021r 1  E8                   inx                     ; nový sampl
000022r 1  EC rr rr             cpx nc                  ; jsme na konci dat?
000025r 1  D0 E3                bne loop                ; zatím ne - pokračujeme v přehrávání
000027r 1               
000027r 1  A2 00                ldx #0                  ; začneme od začátku
000029r 1  F0 DF                beq loop                ; když už je příznak nastavený, proč ho nevyužít
00002Br 1               .endproc
00002Br 1               
00002Br 1               
00002Br 1               
00002Br 1               ; ---------------------------------------------------------------------
00002Br 1               ; čekání na stisk klávesy
00002Br 1               ; ---------------------------------------------------------------------
00002Br 1               .proc get_key
00002Br 1                       KBHANDLER = $e424       ; rutina pro cteni klavesy
00002Br 1  AD 25 E4             lda KBHANDLER+1         ; cteni horni casti adresy ulozene v ROM
00002Er 1  48                   pha                     ; ulozeni na zasobnik
00002Fr 1  AD 24 E4             lda KBHANDLER           ; cteni dolni casti adresy ulozene v ROM
000032r 1  48                   pha                     ; ulozeni na zasobnik
000033r 1  60                   rts                     ; vyber adresy ze zasobniku + skok
000034r 1                                               ; zde neni nutne mit RTS
000034r 1               .endproc
000034r 1               
000034r 1               
000034r 1               ; čítač samplů
000034r 1               nc:
000034r 1  1C           .byte 28
000035r 1               
000035r 1               ; tabulka amplitud
000035r 1               volumes:
000035r 1  18 19 1A 1B  .byte 24, 25, 26, 27, 28, 30, 31
000039r 1  1C 1E 1F     
00003Cr 1  1E 1D 1C 1B  .byte 30, 29, 28, 27, 26, 25, 24
000040r 1  1A 19 18     
000043r 1  17 16 15 14  .byte 23, 22, 21, 20, 19, 18, 17
000047r 1  13 12 11     
00004Ar 1  12 13 14 15  .byte 18, 19, 20, 21, 22, 23, 24
00004Er 1  16 17 18     
000051r 1               
000051r 1               ; tabulka doby trvání amplitud
000051r 1               delays:
000051r 1  01 01 01 02  .byte 1, 1, 1, 2, 2, 2, 3
000055r 1  02 02 03     
000058r 1  06 03 02 02  .byte 6, 3, 2, 2, 2, 1, 1
00005Cr 1  02 01 01     
00005Fr 1  01 01 01 02  .byte 1, 1, 1, 2, 2, 2, 3
000063r 1  02 02 03     
000066r 1  06 03 02 02  .byte 6, 3, 2, 2, 2, 1, 1
00006Ar 1  02 01 01     
00006Dr 1               
00006Dr 1               ; vyšší hodnota - nižší tón
00006Dr 1               tempo:
00006Dr 1  01           .byte 1
00006Er 1               
00006Er 1               ; čítač vnější zpožďovací smyčky
00006Er 1               msc:
00006Er 1  00           .byte 0
00006Fr 1               
00006Fr 1               end:
00006Fr 1               
00006Fr 1               .segment "EXEHDR"
