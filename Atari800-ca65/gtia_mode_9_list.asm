...
Main file   : gtia_mode_9.asm
Current file: gtia_mode_9.asm
...
000044r 1               
000044r 1  20 rr rr             jsr gtia_mode_9         ; nastavení GTIA režimu číslo 9
000047r 1               
...
000050r 1               
000050r 1               ; ---------------------------------------------------------------------
000050r 1               ; nastavení GTIA režimu číslo 9
000050r 1               ; ---------------------------------------------------------------------
000050r 1               .proc gtia_mode_9
000050r 1  AD 6F 02             lda GPRIOR              ; modifikace stínového registru GPRIOR
000053r 1  09 40                ora  #$40               ; výběr GTIA režimu GR.9
...
000066r 1  18                   clc
000067r 1  69 10                adc #16
000069r 1  8D 1A D0             sta COLBK               ; přímo nastavit zápisem do HW registru
00006Cr 1  8D rr rr             sta color
00006Fr 1  68                   pla                     ; obnovit akumulátor
000070r 1  40                   rti                     ; návrat z DLI
000071r 1               
000071r 1               
000071r 1               dlist:
000071r 1  70 70 70     .byte DL_BLK8, DL_BLK8, DL_BLK8 ; 3x8=24 prázdných obrazových řádků
000074r 1  4F           .byte DL_LMS+DL_MAP320x1x1      ; určení počáteční adresy obrazové paměti + jeden řádek režimu F (GR.8)
000075r 1  00 70        .byte <screen1, >screen1        ; počáteční adresa obrazové paměti (první blok)
000077r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
00007Br 1  0F           
00007Cr 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
00007Dr 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000081r 1  0F           
000082r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
000083r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000087r 1  0F           
000088r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
000089r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
00008Dr 1  0F           
00008Er 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
00008Fr 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000093r 1  0F           
000094r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
000095r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000099r 1  0F           
00009Ar 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
00009Br 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
00009Fr 1  0F           
0000A0r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
0000A1r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000A5r 1  0F           
0000A6r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
0000A7r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000ABr 1  0F           
0000ACr 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
0000ADr 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000B1r 1  0F           
0000B2r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
0000B3r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000B7r 1  0F           
0000B8r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
0000B9r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000BDr 1  0F           
0000BEr 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
0000BFr 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000C3r 1  0F           
0000C4r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
0000C5r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000C9r 1  0F           
0000CAr 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
0000CBr 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000CFr 1  0F           
0000D0r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
0000D1r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000D5r 1  0F           
0000D6r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
0000D7r 1  4F           .byte DL_LMS+DL_MAP320x1x1      ; určení počáteční adresy obrazové paměti + jeden řádek režimu F (GR.8)
0000D8r 1  00 80        .byte <screen2, >screen2        ; počáteční adresa obrazové paměti (druhý blok)
0000DAr 1  0F 0F 0F 0F  .res 95, DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000DEr 1  0F 0F 0F 0F  
0000E2r 1  0F 0F 0F 0F  
0000E6r 1  0F 0F 0F 0F  
0000EAr 1  0F 0F 0F 0F  
0000EEr 1  0F 0F 0F 0F  
0000F2r 1  0F 0F 0F 0F  
0000F6r 1  0F 0F 0F 0F  
0000FAr 1  0F 0F 0F 0F  
0000FEr 1  0F 0F 0F 0F  
000102r 1  0F 0F 0F 0F  
000106r 1  0F 0F 0F 0F  
00010Ar 1  0F 0F 0F 0F  
00010Er 1  0F 0F 0F 0F  
000112r 1  0F 0F 0F 0F  
000116r 1  0F 0F 0F 0F  
00011Ar 1  0F 0F 0F 0F  
00011Er 1  0F 0F 0F 0F  
000122r 1  0F 0F 0F 0F  
000126r 1  0F 0F 0F 0F  
00012Ar 1  0F 0F 0F 0F  
00012Er 1  0F 0F 0F 0F  
000132r 1  0F 0F 0F 0F  
000136r 1  0F 0F 0F     
000139r 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
00013Cr 1               
00013Cr 1               ; barva v GTIA režimu 9
00013Cr 1  01           color: .byte 1
00013Dr 1               
00013Dr 1               end:
00013Dr 1               
00013Dr 1               .segment "EXEHDR"
