...
Main file   : pmg_05.asm
Current file: pmg_05.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Initializace PMG, povolení PMG, nastavení pozice, tvaru a barvy prvního hráče.
000000r 1               ; Zákaz DMA. Postupná změna horizontální velikosti hráče.
000000r 1               ;
...
000000r 1               
000000r 1               .proc main
000000r 1  A9 80                lda #128                ; horizontální pozice hráče
000002r 1  8D 00 D0             sta HPOSP0              ; uložit do řídicího registru HPOSP0 na čipu GTIA
000005r 1               
000005r 1  A9 58                lda #HUE_MAGENTA<<4 + 8 ; barva hráče (odstín+intenzita)
000007r 1  8D C0 02             sta PCOLR0              ; uložit do řídicího registru PCOLR0 na čipu GTIA
00000Ar 1               
00000Ar 1  A9 AA                lda #128+32+8+2         ; bitová maska hráče
00000Cr 1  8D 0D D0             sta GRAFP0              ; uložit do řídicího registru GRAFP0 na čipu GTIA
00000Fr 1               
00000Fr 1  A9 00                lda #0                  ; bitové pole: vše nulové
000011r 1  8D 1D D0             sta GRACTL              ; uložit do řídicího registru GRACTL na čipu GTIA
000014r 1               
000014r 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
000017r 1               
000017r 1  A9 01                lda #1                  ; horizontální velikost hráče
000019r 1  8D 08 D0             sta SIZEP0              ; uložit do řídicího registru SIZEP0 na čipu GTIA
00001Cr 1               
00001Cr 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
00001Fr 1               
00001Fr 1  A9 03                lda #3                  ; horizontální velikost hráče
000021r 1  8D 08 D0             sta SIZEP0              ; uložit do řídicího registru SIZEP0 na čipu GTIA
000024r 1               
000024r 1  4C rr rr     loop:   jmp loop
000027r 1               .endproc
000027r 1               
000027r 1               .proc get_key
000027r 1  AD 25 E4             lda KBHANDLER+1         ; cteni horni casti adresy ulozene v ROM
00002Ar 1  48                   pha                     ; ulozeni na zasobnik
00002Br 1  AD 24 E4             lda KBHANDLER           ; cteni dolni casti adresy ulozene v ROM
00002Er 1  48                   pha                     ; ulozeni na zasobnik
00002Fr 1  60                   rts                     ; vyber adresy ze zasobniku + skok
000030r 1                                               ; zde neni nutne mit RTS
000030r 1               .endproc
000030r 1               
000030r 1               end:
000030r 1               
000030r 1               
000030r 1               .segment "EXEHDR"
