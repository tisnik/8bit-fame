...
Main file   : sound_9.asm
Current file: sound_9.asm
...
000000r 1               
000000r 1               CPU_FREQ_CHANNEL_1_MASK = %01000000
000000r 1               CPU_FREQ_CHANNEL_3_MASK = %00100000
000000r 1               JOIN_CANNELS_1_2_MASK   = %00010000
000000r 1               JOIN_CANNELS_3_4_MASK   = %00001000
000000r 1               
000000r 1               
000000r 1               .proc main
000000r 1  A9 50                lda #CPU_FREQ_CHANNEL_1_MASK + JOIN_CANNELS_1_2_MASK    ; tón odvozený od frekvence CPU
000002r 1  8D 08 D2             sta AUDCTL              ; zápis do řídicího registru čipu POKEY
000005r 1               
000005r 1  A9 AA                lda #PURE_TONE_MASK+10  ; hlasitost (0-15)
000007r 1  8D 03 D2             sta AUDC2               ; zápis do registru řízení hlasitosti pro zvukový kanál číslo 2 čipu POKEY
00000Ar 1               
00000Ar 1                       ; nastavit vektor pro odloženou VBI
00000Ar 1  A9 rr                lda #>horizontal_movement
00000Cr 1  8D 25 02             sta VVBLKD+1
00000Fr 1  A9 rr                lda #<horizontal_movement
000011r 1  8D 24 02             sta VVBLKD
000014r 1               loop:
000014r 1  4C rr rr             jmp loop                ; program vlastně nice nedělá - jen cyklí!
000017r 1               .endproc
000017r 1               
000017r 1               
000017r 1               ; ---------------------------------------------------------------------
000017r 1               ; subrutina pro obsluhu VBI
000017r 1               ; ---------------------------------------------------------------------
000017r 1               .proc   horizontal_movement
000017r 1  AE rr rr             ldx divider1
00001Ar 1  AC rr rr             ldy divider2
00001Dr 1               
00001Dr 1  AD 78 02             lda STICK0              ; čtení joysticku
000020r 1  C9 0B                cmp #11                 ; je nakloněn doleva?
000022r 1  D0 01                bne not_left
000024r 1  CA                   dex                     ; změna děliče
000025r 1               not_left:
000025r 1  C9 07                cmp #7                  ; je nakloněn doprava?
000027r 1  D0 01                bne not_right
000029r 1  E8                   inx                     ; změna děliče
00002Ar 1               not_right:
00002Ar 1  C9 0E                cmp #14                 ; je nakloněn nahoru?
00002Cr 1  D0 01                bne not_up
00002Er 1  88                   dey                     ; změna Y-ové souřadnice hráče
00002Fr 1               not_up:
00002Fr 1  C9 0D                cmp #13                 ; je nakloněn dolů?
000031r 1  D0 01                bne not_down
000033r 1  C8                   iny                     ; změna Y-ové souřadnice hráče
000034r 1               not_down:
000034r 1  8E 00 D2             stx AUDF1               ; zápis do registru děliče frekvence pro zvukový kanál číslo 1 čipu POKEY
000037r 1  8C 02 D2             sty AUDF2               ; zápis do registru děliče frekvence pro zvukový kanál číslo 2 čipu POKEY
00003Ar 1  8E rr rr             stx divider1
00003Dr 1  8C rr rr             sty divider2
000040r 1  4C 62 E4             jmp XITVBV              ; zpracovat zbytek odloženého VBLANKu
000043r 1  60                   rts
000044r 1               .endproc
000044r 1               
000044r 1               ; děliče frekvence
000044r 1  0A           divider1: .byte 10
000045r 1  0A           divider2: .byte 10
000046r 1               
000046r 1               
000046r 1               end:
000046r 1               
000046r 1               .segment "EXEHDR"
