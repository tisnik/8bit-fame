...
Main file   : pmg_collisions_3.asm
Current file: pmg_collisions_3.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Ovládání PMG joystickem. Detekce kolize prvního hráče s dalšími hráči.
000000r 1               ; Detekce kolize první střely s hráči.
000000r 1               ;
...
0000B5r 1               
0000B5r 1               
0000B5r 1               .proc   _wait_vsync
0000B5r 1  8A                   txa                     ; uložení obsahu X do akumulátoru
0000B6r 1  A6 14                ldx     RTCLOK+2        ; čekání na konec snímku
0000B8r 1  E4 14        @wt:    cpx     RTCLOK+2
0000BAr 1  F0 FC                beq     @wt
0000BCr 1  AA                   tax                     ; obnovení obsahu X z akumulátoru
0000BDr 1  60                   rts
0000BEr 1               .endproc
0000BEr 1               
0000BEr 1               
0000BEr 1               .proc  draw_at_y
0000BEr 1                       addr = 152*256          ; adresa první stránky se sprity
0000BEr 1  8A                   txa
0000BFr 1  48                   pha                     ; uložit X na zásobník
0000C0r 1  98                   tya
0000C1r 1  48                   pha                     ; uložit Y na zásobník
0000C2r 1               
0000C2r 1  A2 0A                ldx #10                 ; začneme na hodnotě o 1 vyšší
0000C4r 1               next_line:
0000C4r 1  BD rr rr             lda sprite-1, x         ; načíst
0000C7r 1  99 00 9A             sta addr+PLAYER_0_OFFSET, y  ; uložit byte - první hráč
0000CAr 1  88                   dey
0000CBr 1  CA                   dex                     ; snížit offset + nastavit příznaky
0000CCr 1  D0 F6                bne next_line           ; další byte spritu
0000CEr 1               
0000CEr 1  68                   pla
0000CFr 1  A8                   tay                     ; obnovit Y ze zásobníku
0000D0r 1  68                   pla
0000D1r 1  AA                   tax                     ; obnovit X ze zásobníku
0000D2r 1  60                   rts                     ; návrat z podprogramu
0000D3r 1               .endproc
0000D3r 1               
0000D3r 1               
0000D3r 1               ; data
0000D3r 1  00 18 3C 7E  sprite:   .byte 0, 24, 60, 126, 219, 255, 36, 90, 165, 0
0000D7r 1  DB FF 24 5A  
0000DBr 1  A5 00        
0000DDr 1               
0000DDr 1               end:
0000DDr 1               
0000DDr 1               
0000DDr 1               .segment "EXEHDR"
