...
Main file   : key_02.asm
Current file: key_02.asm
...
000000r 1               
000000r 1               .proc main
000000r 1  A9 80                lda #128                ; horizontální pozice prvního hráče
000002r 1  8D 00 D0             sta HPOSP0              ; uložit do řídicího registru HPOSP0 na čipu GTIA
000005r 1               
000005r 1  A9 EC                lda #HUE_YELLOW<<4 + 12 ; barva prvního hráče (odstín+intenzita)
000007r 1  8D C0 02             sta PCOLR0              ; uložit do řídicího registru PCOLR0 na čipu GTIA
00000Ar 1               
00000Ar 1  A9 FF                lda #$ff                ; bitová maska prvního i druhého hráče
00000Cr 1  8D 0D D0             sta GRAFP0              ; uložit do řídicího registru GRAFP0 na čipu GTIA
00000Fr 1               
00000Fr 1  A9 03                lda #3                  ; bitové pole: povolení hráčů i střel
000011r 1  8D 1D D0             sta GRACTL              ; uložit do řídicího registru GRACTL na čipu GTIA
000014r 1               
000014r 1  A9 98                lda #152                ; paměťová stránka číslo 152
000016r 1  8D 07 D4             sta PMBASE
000019r 1               
000019r 1                       addr = 152*256
000019r 1  A2 08                ldx #8                  ; začneme na hodnotě o 1 vyšší
00001Br 1               next_line:
00001Br 1  BD rr rr             lda sprite-1, x         ; načíst
00001Er 1  9D 40 9A             sta addr+512+64, x      ; uložit byte
000021r 1  CA                   dex                     ; snížit offset + nastavit příznaky
000022r 1  D0 F7                bne next_line           ; další byte spritu
000024r 1               
000024r 1  A9 2E                lda #46                 ; povolení PMG DMA
000026r 1  8D 2F 02             sta SDMCTL
000029r 1               
000029r 1                       ; nastavit vektor pro odloženou VBI
000029r 1  A9 rr                lda #>horizontal_movement
00002Br 1  8D 25 02             sta VVBLKD+1
00002Er 1  A9 rr                lda #<horizontal_movement
000030r 1  8D 24 02             sta VVBLKD
000033r 1               loop:
000033r 1  4C rr rr             jmp loop                ; program vlastně nice nedělá - jen cyklí!
000036r 1               .endproc
000036r 1               
000036r 1               
000036r 1               
000036r 1               ; ---------------------------------------------------------------------
000036r 1               ; subrutina pro obsluhu VBI
000036r 1               ; ---------------------------------------------------------------------
000036r 1               .proc   horizontal_movement
000036r 1  AE rr rr             ldx x_pos               ; původní pozice prvního hráče
000039r 1               
000039r 1  AD 78 02             lda STICK0              ; čtení joysticku
00003Cr 1  C9 0B                cmp #11                 ; je nakloněn doleva?
00003Er 1  D0 01                bne not_left
000040r 1  CA                   dex                     ; posun hráče doleva
000041r 1               not_left:
000041r 1  C9 07                cmp #7                  ; je nakloněn doprava?
000043r 1  D0 01                bne not_right
000045r 1  E8                   inx                     ; posun hráče doprava
000046r 1               not_right:
000046r 1  8E 00 D0             stx HPOSP0              ; změna pozice prvního hráče
000049r 1  8E rr rr             stx x_pos               ; zapamatovat si pozici prvního hráče
00004Cr 1               
00004Cr 1  AD 1F D0             lda CONSOL              ; načtení stavu kláves START, SELECT, OPTION
00004Fr 1  0A                   asl                     ; bitový posun doleva o pět bitů
000050r 1  0A                   asl
000051r 1  0A                   asl
000052r 1  0A                   asl
000053r 1  0A                   asl
000054r 1  18                   clc
000055r 1  69 0C                adc #12                 ; přidat požadovanou intenzitu
000057r 1  8D C0 02             sta PCOLR0              ; uložit do řídicího registru PCOLR0 na čipu GTIA
00005Ar 1               
00005Ar 1  4C 62 E4             jmp XITVBV              ; zpracovat zbytek odloženého VBLANKu
00005Dr 1  60                   rts
00005Er 1               .endproc
00005Er 1               
00005Er 1               
00005Er 1               ; data
00005Er 1  18 3C 7E DB  sprite:   .byte 24, 60, 126, 219, 255, 36, 90, 165
000062r 1  FF 24 5A A5  
000066r 1               
000066r 1               ; pozice hráče
000066r 1  80           x_pos:    .byte 128
000067r 1               
000067r 1               end:
000067r 1               
000067r 1               
000067r 1               .segment "EXEHDR"
