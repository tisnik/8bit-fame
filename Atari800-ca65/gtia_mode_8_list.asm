...
Main file   : gtia_mode_8.asm
Current file: gtia_mode_8.asm
...
000008r 1  31 02        
00000Ar 1  A9 00 85 80          fill_screen screen1     ; vyplnění obrazovky
00000Er 1  A9 70 85 81  
000012r 1  A2 60 A9 00  
000016r 1  A8 18 91 80  
00001Ar 1  C8 69 01 C9  
00001Er 1  28 D0 F7 A5  
000022r 1  80 18 69 28  
000026r 1  85 80 A5 81  
00002Ar 1  69 00 85 81  
00002Er 1  CA D0 E3     
000031r 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
000034r 1               
000034r 1  20 rr rr             jsr gtia_mode_9         ; nastavení GTIA režimu číslo 9
000037r 1               
000037r 1  4C rr rr             game_loop               ; hlavní herní smyčka
00003Ar 1               .endproc
00003Ar 1               
00003Ar 1               
00003Ar 1               
00003Ar 1               ; ---------------------------------------------------------------------
00003Ar 1               ; nastavení GTIA režimu číslo 9
00003Ar 1               ; ---------------------------------------------------------------------
00003Ar 1               .proc gtia_mode_9
00003Ar 1  AD 6F 02             lda GPRIOR              ; modifikace stínového registru GPRIOR
00003Dr 1  09 40                ora  #$40               ; výběr GTIA režimu GR.9
00003Fr 1  8D 6F 02             sta GPRIOR
000042r 1  60                   rts                     ; vyber adresy ze zasobniku + skok
000043r 1               .endproc
000043r 1               
000043r 1               
000043r 1               
000043r 1               ; ---------------------------------------------------------------------
000043r 1               ; čekání na stisk klávesy
000043r 1               ; ---------------------------------------------------------------------
000043r 1               .proc get_key
000043r 1                       KBHANDLER = $e424       ; rutina pro cteni klavesy
000043r 1  AD 25 E4             lda KBHANDLER+1         ; cteni horni casti adresy ulozene v ROM
000046r 1  48                   pha                     ; ulozeni na zasobnik
000047r 1  AD 24 E4             lda KBHANDLER           ; cteni dolni casti adresy ulozene v ROM
00004Ar 1  48                   pha                     ; ulozeni na zasobnik
00004Br 1  60                   rts                     ; vyber adresy ze zasobniku + skok
00004Cr 1                                               ; zde neni nutne mit RTS
00004Cr 1               .endproc
00004Cr 1               
00004Cr 1               
00004Cr 1               dlist:
00004Cr 1  70 70 70     .byte DL_BLK8, DL_BLK8, DL_BLK8 ; 3x8=24 prázdných obrazových řádků
00004Fr 1  4F           .byte DL_LMS+DL_MAP320x1x1      ; určení počáteční adresy obrazové paměti + jeden řádek režimu F (GR.8)
000050r 1  00 70        .byte <screen1, >screen1        ; počáteční adresa obrazové paměti (první blok)
000052r 1  0F 0F 0F 0F  .res 95, DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000056r 1  0F 0F 0F 0F  
00005Ar 1  0F 0F 0F 0F  
00005Er 1  0F 0F 0F 0F  
000062r 1  0F 0F 0F 0F  
000066r 1  0F 0F 0F 0F  
00006Ar 1  0F 0F 0F 0F  
00006Er 1  0F 0F 0F 0F  
000072r 1  0F 0F 0F 0F  
000076r 1  0F 0F 0F 0F  
00007Ar 1  0F 0F 0F 0F  
00007Er 1  0F 0F 0F 0F  
000082r 1  0F 0F 0F 0F  
000086r 1  0F 0F 0F 0F  
00008Ar 1  0F 0F 0F 0F  
00008Er 1  0F 0F 0F 0F  
000092r 1  0F 0F 0F 0F  
000096r 1  0F 0F 0F 0F  
00009Ar 1  0F 0F 0F 0F  
00009Er 1  0F 0F 0F 0F  
0000A2r 1  0F 0F 0F 0F  
0000A6r 1  0F 0F 0F 0F  
0000AAr 1  0F 0F 0F 0F  
0000AEr 1  0F 0F 0F     
0000B1r 1  4F           .byte DL_LMS+DL_MAP320x1x1      ; určení počáteční adresy obrazové paměti + jeden řádek režimu F (GR.8)
0000B2r 1  00 80        .byte <screen2, >screen2        ; počáteční adresa obrazové paměti (druhý blok)
0000B4r 1  0F 0F 0F 0F  .res 95, DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000B8r 1  0F 0F 0F 0F  
0000BCr 1  0F 0F 0F 0F  
0000C0r 1  0F 0F 0F 0F  
0000C4r 1  0F 0F 0F 0F  
0000C8r 1  0F 0F 0F 0F  
0000CCr 1  0F 0F 0F 0F  
0000D0r 1  0F 0F 0F 0F  
0000D4r 1  0F 0F 0F 0F  
0000D8r 1  0F 0F 0F 0F  
0000DCr 1  0F 0F 0F 0F  
...
000110r 1  0F 0F 0F     
000113r 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
000116r 1               
000116r 1               
000116r 1               end:
000116r 1               
000116r 1               .segment "EXEHDR"
