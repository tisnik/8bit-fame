...
Main file   : antic_bitmap_6.asm
Current file: antic_bitmap_6.asm
...
00001Br 1  00 30        .byte <screen, >screen          ; počáteční adresa obrazové paměti
00001Dr 1  0F 0F 0F 0F  .res 191, DL_MAP320x1x1         ; opakovat řádky grafického režimu F (GR.8)
...
000079r 1  0F 0F 0F 0F  
00007Dr 1  0F 0F 0F 0F  
...
004E00  1               
004E00  1               ; ---------------------------------------------------------------------
004E00  1               ; definice segmentů vyžadovaných formátem XEX
004E00  1               ; ---------------------------------------------------------------------
