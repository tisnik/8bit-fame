...
Main file   : gtia_mode_B.asm
Current file: gtia_mode_B.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Grafický režim 320x192 se dvěma barvami.
000000r 1               ; Korektní display list.
000000r 1               ; Vykreslení šestnácti různých kombinací pixelů.
000000r 1               ; Přepnutí do GTIA režimu 9.
000000r 1               ; ---------------------------------------------------------------------
000000r 1               
...
000000r 1               .CODE
000000r 1               
000000r 1               ; dva bloky RAM využité jako obrazová paměť
000000r 1               screen1 = $7000
000000r 1               screen2 = $8000
000000r 1               
000000r 1               ; adresy PMG
000000r 1               PLAYER_0_OFFSET = 512
000000r 1               PLAYER_1_OFFSET = PLAYER_0_OFFSET + 128
000000r 1               PLAYER_2_OFFSET = PLAYER_1_OFFSET + 128
000000r 1               PLAYER_3_OFFSET = PLAYER_2_OFFSET + 128
000000r 1               
000000r 1               
000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; makro pro nastavení display listu
000000r 1               ; ---------------------------------------------------------------------
000000r 1               .macro  set_display_list label
000000r 1                       lda #<label             ; nižší byte adresy display listu
000000r 1                       sta SDLSTL
000000r 1                       lda #>label             ; vyšší byte adresy display listu
000000r 1                       sta SDLSTH
000000r 1               .endmacro
000000r 1               
000000r 1               
000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; makro pro nastavení DLI
000000r 1               ; ---------------------------------------------------------------------
000000r 1               .macro  set_dli_handler handler
000000r 1                       ; vektor DLI
000000r 1                       lda #<handler           ; nastavení DLI
000000r 1                       sta VDSLST
000000r 1                       lda #>handler
000000r 1                       sta VDSLST+1
000000r 1               .endmacro
000000r 1               
000000r 1               
000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; makro pro nastavení VBI
000000r 1               ; ---------------------------------------------------------------------
000000r 1               .macro set_vbi_handler handler
000000r 1                       ; nastavit vektor pro odloženou VBI
000000r 1                       lda #>handler
000000r 1                       sta VVBLKD+1
000000r 1                       lda #<handler
000000r 1                       sta VVBLKD
000000r 1               .endmacro
000000r 1               
000000r 1               
000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; vyplnění obrazovky
000000r 1               ; ---------------------------------------------------------------------
000000r 1               .macro  fill_screen screen
000000r 1                       .local next_line        ; definice lokálního symbolu
000000r 1                       .local draw_on_line     ; definice lokálního symbolu
000000r 1                       screen_addr = 128
000000r 1               
000000r 1                       lda #<screen1           ; uložit adresu začátku obrazovky na nultou stránku
000000r 1                       sta screen_addr
000000r 1                       lda #>screen1
000000r 1                       sta screen_addr+1
000000r 1               
000000r 1                       ldx #96                 ; počitadlo řádků
000000r 1               next_line:
000000r 1                       lda #0                  ; zapisovaná hodnota + počitadlo smyčky
000000r 1                       tay                     ; offset do obrazové paměti
000000r 1                       clc                     ; nechceme přičítat přenos
000000r 1                       ; ---------------------------------------------------------------------
000000r 1                       ; vykreslení pixelů na jednom řádku
000000r 1                       ; ---------------------------------------------------------------------
000000r 1               draw_on_line:
000000r 1                       sta (screen_addr), y    ; zápis na první řádek
000000r 1                       iny                     ; další zápis bude proveden o jeden bajt dále
000000r 1                       adc #1                  ; zvýšení hodnoty v akumulátoru
000000r 1                       cmp #40                 ; konec smyčky?
000000r 1                       bne draw_on_line        ; dokud není nula, pokračovat
000000r 1               
000000r 1                       lda screen_addr         ; 16bitové zvýšení adresy
000000r 1                       clc
000000r 1                       adc #40
000000r 1                       sta screen_addr
000000r 1                       lda screen_addr+1
000000r 1                       adc #0
000000r 1                       sta screen_addr+1
000000r 1               
000000r 1                       dex                     ; snížení počitadla
000000r 1                       bne next_line           ; jsme na posledním řádku? ne->skok
000000r 1               .endmacro
000000r 1               
000000r 1               
000000r 1               
...
000000r 1               ; set PMG
000000r 1               ; ---------------------------------------------------------------------
000000r 1               .macro  set_pmg
000000r 1                       .local next_line        ; definice lokálního symbolu
000000r 1               
000000r 1                       lda #80                 ; horizontální pozice prvního hráče
000000r 1                       sta HPOSP0              ; uložit do řídicího registru HPOSP0 na čipu GTIA
000000r 1               
000000r 1                       lda #100                ; horizontální pozice druhého hráče
000000r 1                       sta HPOSP1              ; uložit do řídicího registru HPOSP1 na čipu GTIA
000000r 1               
000000r 1                       lda #120                ; horizontální pozice třetího hráče
000000r 1                       sta HPOSP2              ; uložit do řídicího registru HPOSP2 na čipu GTIA
000000r 1               
000000r 1                       lda #140                ; horizontální pozice čtvrtého hráče
000000r 1                       sta HPOSP3              ; uložit do řídicího registru HPOSP3 na čipu GTIA
000000r 1               
000000r 1                       lda #HUE_BLUE<<4 + 12 ; barva druhého hráče (odstín+intenzita)
000000r 1                       sta PCOLR0              ; uložit do řídicího registru PCOLR0 na čipu GTIA
000000r 1               
000000r 1                       lda #HUE_GREEN<<4 + 12  ; barva prvního hráče (odstín+intenzita)
000000r 1                       sta PCOLR1              ; uložit do řídicího registru PCOLR1 na čipu GTIA
000000r 1               
000000r 1                       lda #HUE_MAGENTA<<4 + 12 ; barva třetího hráče (odstín+intenzita)
000000r 1                       sta PCOLR2              ; uložit do řídicího registru PCOLR2 na čipu GTIA
000000r 1               
000000r 1                       lda #HUE_CYAN<<4 + 12   ; barva čtvrtého hráče (odstín+intenzita)
000000r 1                       sta PCOLR3              ; uložit do řídicího registru PCOLR3 na čipu GTIA
000000r 1               
000000r 1                       lda #$ff                ; bitová maska všech hráčů
000000r 1                       sta GRAFP0              ; uložit do řídicího registru GRAFP0 na čipu GTIA
000000r 1                       sta GRAFP1              ; uložit do řídicího registru GRAFP1 na čipu GTIA
000000r 1                       sta GRAFP2              ; uložit do řídicího registru GRAFP2 na čipu GTIA
000000r 1                       sta GRAFP3              ; uložit do řídicího registru GRAFP3 na čipu GTIA
000000r 1               
000000r 1                       lda #3                  ; bitové pole: povolení hráčů i střel
000000r 1                       sta GRACTL              ; uložit do řídicího registru GRACTL na čipu GTIA
000000r 1               
000000r 1                       lda #0                  ; priorita hráčů a pozadí
000000r 1                       sta GPRIOR              ; uložit do řídicího registru GPRIOR na čipu GTIA
000000r 1               
000000r 1                       lda #152                ; paměťová stránka číslo 152
000000r 1                       sta PMBASE
000000r 1               
000000r 1                       addr = 152*256
000000r 1                       ldx #8                  ; začneme na hodnotě o 1 vyšší
000000r 1               next_line:
000000r 1                       lda sprite-1, x         ; načíst
000000r 1                       sta addr+PLAYER_0_OFFSET+20, x  ; uložit byte - první hráč
000000r 1                       sta addr+PLAYER_1_OFFSET+30, x  ; uložit byte - druhý hráč
000000r 1                       sta addr+PLAYER_2_OFFSET+40, x  ; uložit byte - třetí hráč
000000r 1                       sta addr+PLAYER_3_OFFSET+50, x  ; uložit byte - čtvrtý hráč
000000r 1                       dex                     ; snížit offset + nastavit příznaky
000000r 1                       bne next_line           ; další byte spritu
000000r 1               
000000r 1                       lda #46                 ; povolení PMG DMA
000000r 1                       sta SDMCTL
000000r 1               .endmacro
000000r 1               
000000r 1               
000000r 1               
000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; hlavní herní smyčka
000000r 1               ; ---------------------------------------------------------------------
000000r 1               .macro  game_loop
000000r 1                       .local loop             ; definice lokálního symbolu
000000r 1               loop:
000000r 1                       jmp loop                ; program vlastně nice nedělá - jen cyklí!
000000r 1               .endmacro
000000r 1               
000000r 1               
000000r 1               ; ---------------------------------------------------------------------
...
000000r 1               ; ---------------------------------------------------------------------
000000r 1               .proc main
000000r 1  A9 rr 8D 30          set_display_list dlist  ; nastavení display listu
000004r 1  02 A9 rr 8D  
000008r 1  31 02        
00000Ar 1  A9 50 8D 00          set_pmg                 ; nastavení PMG
00000Er 1  D0 A9 64 8D  
000012r 1  01 D0 A9 78  
000016r 1  8D 02 D0 A9  
00001Ar 1  8C 8D 03 D0  
00001Er 1  A9 7C 8D C0  
000022r 1  02 A9 CC 8D  
000026r 1  C1 02 A9 5C  
00002Ar 1  8D C2 02 A9  
00002Er 1  9C 8D C3 02  
000032r 1  A9 FF 8D 0D  
000036r 1  D0 8D 0E D0  
00003Ar 1  8D 0F D0 8D  
00003Er 1  10 D0 A9 03  
000042r 1  8D 1D D0 A9  
000046r 1  00 8D 6F 02  
00004Ar 1  A9 98 8D 07  
00004Er 1  D4 A2 08 BD  
000052r 1  rr rr 9D 14  
000056r 1  9A 9D 9E 9A  
00005Ar 1  9D 28 9B 9D  
00005Er 1  B2 9B CA D0  
000062r 1  EE A9 2E 8D  
000066r 1  2F 02        
000068r 1               
000068r 1  A9 rr 8D 00          set_dli_handler dli     ; nastavení obsluhy DLI
00006Cr 1  02 A9 rr 8D  
000070r 1  01 02        
000072r 1  A9 rr 8D 25          set_vbi_handler horizontal_movement
000076r 1  02 A9 rr 8D  
00007Ar 1  24 02        
00007Cr 1  A9 00 85 80          fill_screen screen1     ; vyplnění obrazovky
000080r 1  A9 70 85 81  
000084r 1  A2 60 A9 00  
000088r 1  A8 18 91 80  
00008Cr 1  C8 69 01 C9  
000090r 1  28 D0 F7 A5  
000094r 1  80 18 69 28  
000098r 1  85 80 A5 81  
00009Cr 1  69 00 85 81  
0000A0r 1  CA D0 E3     
0000A3r 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
0000A6r 1               
0000A6r 1  20 rr rr             jsr enable_dli          ; povolení DLI (a VBI)
0000A9r 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
0000ACr 1               
0000ACr 1  20 rr rr             jsr gtia_mode_9         ; nastavení GTIA režimu číslo 9
0000AFr 1               
0000AFr 1  4C rr rr             game_loop               ; hlavní herní smyčka
0000B2r 1               .endproc
0000B2r 1               
0000B2r 1               
0000B2r 1               
0000B2r 1               ; ---------------------------------------------------------------------
0000B2r 1               ; povolení DLI (a VBI)
0000B2r 1               ; ---------------------------------------------------------------------
0000B2r 1               .proc enable_dli
0000B2r 1                       ; povolení DLI
0000B2r 1                       NMIEN_DLI=$80           ; maska povolení DLI
0000B2r 1                       NMIEN_VBI=$40           ; maska povolení VBI
0000B2r 1  A9 C0                lda #NMIEN_DLI | NMIEN_VBI ; povolení DLI
0000B4r 1  8D 0E D4             sta NMIEN
0000B7r 1  60                   rts
0000B8r 1               .endproc
0000B8r 1               
0000B8r 1               
0000B8r 1               
0000B8r 1               ; ---------------------------------------------------------------------
0000B8r 1               ; nastavení GTIA režimu číslo 9
0000B8r 1               ; ---------------------------------------------------------------------
0000B8r 1               .proc gtia_mode_9
0000B8r 1  AD 6F 02             lda GPRIOR              ; modifikace stínového registru GPRIOR
0000BBr 1  09 40                ora  #$40               ; výběr GTIA režimu GR.9
0000BDr 1  8D 6F 02             sta GPRIOR
0000C0r 1  60                   rts                     ; vyber adresy ze zasobniku + skok
0000C1r 1               .endproc
0000C1r 1               
0000C1r 1               
0000C1r 1               
0000C1r 1               ; ---------------------------------------------------------------------
0000C1r 1               ; čekání na stisk klávesy
0000C1r 1               ; ---------------------------------------------------------------------
0000C1r 1               .proc get_key
0000C1r 1                       KBHANDLER = $e424       ; rutina pro cteni klavesy
0000C1r 1  AD 25 E4             lda KBHANDLER+1         ; cteni horni casti adresy ulozene v ROM
0000C4r 1  48                   pha                     ; ulozeni na zasobnik
0000C5r 1  AD 24 E4             lda KBHANDLER           ; cteni dolni casti adresy ulozene v ROM
0000C8r 1  48                   pha                     ; ulozeni na zasobnik
0000C9r 1  60                   rts                     ; vyber adresy ze zasobniku + skok
0000CAr 1                                               ; zde neni nutne mit RTS
0000CAr 1               .endproc
0000CAr 1               
0000CAr 1               
0000CAr 1               ; ---------------------------------------------------------------------
0000CAr 1               ; obsluha DLI
0000CAr 1               ; ---------------------------------------------------------------------
0000CAr 1               dli:
0000CAr 1  48                   pha                     ; uschovat akumulátor
0000CBr 1  AD rr rr             lda color               ; barva pozadí
0000CEr 1  18                   clc
0000CFr 1  69 10                adc #16
0000D1r 1  8D 1A D0             sta COLBK               ; přímo nastavit zápisem do HW registru
0000D4r 1  8D rr rr             sta color
0000D7r 1  68                   pla                     ; obnovit akumulátor
0000D8r 1  40                   rti                     ; návrat z DLI
0000D9r 1               
0000D9r 1               
0000D9r 1               ; ---------------------------------------------------------------------
0000D9r 1               ; subrutina pro obsluhu VBI
0000D9r 1               ; ---------------------------------------------------------------------
0000D9r 1               .proc   horizontal_movement
0000D9r 1  AE rr rr             ldx x_pos_0             ; původní pozice prvního hráče
0000DCr 1  CA                   dex                     ; posun hráče doleva
0000DDr 1  8E 00 D0             stx HPOSP0              ; změna pozice prvního hráče
0000E0r 1  8E rr rr             stx x_pos_0             ; zapamatovat si pozici prvního hráče
0000E3r 1               
0000E3r 1  AE rr rr             ldx x_pos_1             ; původní pozice prvního hráče
0000E6r 1  E8                   inx                     ; posun hráče doprava
0000E7r 1  8E 01 D0             stx HPOSP1              ; změna pozice prvního hráče
0000EAr 1  8E rr rr             stx x_pos_1             ; zapamatovat si pozici prvního hráče
0000EDr 1               
0000EDr 1  AE rr rr             ldx x_pos_2             ; původní pozice prvního hráče
0000F0r 1  CA                   dex                     ; posun hráče doleva
0000F1r 1  CA                   dex                     ; posun hráče doleva
0000F2r 1  8E 02 D0             stx HPOSP2              ; změna pozice prvního hráče
0000F5r 1  8E rr rr             stx x_pos_2             ; zapamatovat si pozici prvního hráče
0000F8r 1               
0000F8r 1  AE rr rr             ldx x_pos_3             ; původní pozice prvního hráče
0000FBr 1  E8                   inx                     ; posun hráče doprava
0000FCr 1  E8                   inx                     ; posun hráče doprava
0000FDr 1  8E 03 D0             stx HPOSP3              ; změna pozice prvního hráče
000100r 1  8E rr rr             stx x_pos_3             ; zapamatovat si pozici prvního hráče
000103r 1               
000103r 1  4C 62 E4             jmp XITVBV              ; zpracovat zbytek odloženého VBLANKu
000106r 1  60                   rts
000107r 1               .endproc
000107r 1               
000107r 1               
000107r 1               dlist:
000107r 1  70 70 70     .byte DL_BLK8, DL_BLK8, DL_BLK8 ; 3x8=24 prázdných obrazových řádků
00010Ar 1  4F           .byte DL_LMS+DL_MAP320x1x1      ; určení počáteční adresy obrazové paměti + jeden řádek režimu F (GR.8)
00010Br 1  00 70        .byte <screen1, >screen1        ; počáteční adresa obrazové paměti (první blok)
00010Dr 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000111r 1  0F           
000112r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
000113r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000117r 1  0F           
000118r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
000119r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
00011Dr 1  0F           
00011Er 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
00011Fr 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000123r 1  0F           
000124r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
000125r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000129r 1  0F           
00012Ar 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
00012Br 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
00012Fr 1  0F           
000130r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
000131r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000135r 1  0F           
000136r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
000137r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
00013Br 1  0F           
00013Cr 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
00013Dr 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000141r 1  0F           
000142r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
000143r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000147r 1  0F           
000148r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
000149r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
00014Dr 1  0F           
00014Er 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
00014Fr 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000153r 1  0F           
000154r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
000155r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000159r 1  0F           
00015Ar 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
00015Br 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
00015Fr 1  0F           
000160r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
000161r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000165r 1  0F           
000166r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
000167r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
00016Br 1  0F           
00016Cr 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
00016Dr 1  4F           .byte DL_LMS+DL_MAP320x1x1      ; určení počáteční adresy obrazové paměti + jeden řádek režimu F (GR.8)
00016Er 1  00 80        .byte <screen2, >screen2        ; počáteční adresa obrazové paměti (druhý blok)
000170r 1  0F 0F 0F 0F  .res 95, DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000174r 1  0F 0F 0F 0F  
000178r 1  0F 0F 0F 0F  
00017Cr 1  0F 0F 0F 0F  
000180r 1  0F 0F 0F 0F  
000184r 1  0F 0F 0F 0F  
000188r 1  0F 0F 0F 0F  
00018Cr 1  0F 0F 0F 0F  
000190r 1  0F 0F 0F 0F  
000194r 1  0F 0F 0F 0F  
000198r 1  0F 0F 0F 0F  
00019Cr 1  0F 0F 0F 0F  
0001A0r 1  0F 0F 0F 0F  
0001A4r 1  0F 0F 0F 0F  
0001A8r 1  0F 0F 0F 0F  
0001ACr 1  0F 0F 0F 0F  
0001B0r 1  0F 0F 0F 0F  
0001B4r 1  0F 0F 0F 0F  
0001B8r 1  0F 0F 0F 0F  
0001BCr 1  0F 0F 0F 0F  
0001C0r 1  0F 0F 0F 0F  
0001C4r 1  0F 0F 0F 0F  
0001C8r 1  0F 0F 0F 0F  
0001CCr 1  0F 0F 0F     
0001CFr 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
0001D2r 1               
0001D2r 1               ; barva v GTIA režimu 9
0001D2r 1  01           color: .byte 1
0001D3r 1               
0001D3r 1               ; data spritů
0001D3r 1  18 3C 7E DB  sprite:  .byte 24, 60, 126, 219, 255, 36, 90, 165
0001D7r 1  FF 24 5A A5  
0001DBr 1  50           x_pos_0: .byte 80
0001DCr 1  64           x_pos_1: .byte 100
0001DDr 1  78           x_pos_2: .byte 120
0001DEr 1  8C           x_pos_3: .byte 140
0001DFr 1               
0001DFr 1               end:
0001DFr 1               
0001DFr 1               .segment "EXEHDR"
