...
Main file   : rainbow_6.asm
Current file: rainbow_6.asm
...
00000Ar 1               
00000Ar 1                       ; vektor DLI
00000Ar 1  A9 rr                lda #<dli               ; nastavení DLI
00000Cr 1  8D 00 02             sta VDSLST
00000Fr 1  A9 rr                lda #>dli
000011r 1  8D 01 02             sta VDSLST+1
000014r 1               
000014r 1                       ; povolení DLI
000014r 1                       NMIEN_DLI=$80           ; maska povolení DLI
000014r 1                       NMIEN_VBI=$40           ; maska povolení VBI
000014r 1  A9 C0                lda #NMIEN_DLI | NMIEN_VBI ; povolení DLI
000016r 1  8D 0E D4             sta NMIEN
000019r 1               
...
00001Cr 1               
00001Cr 1               ; ---------------------------------------------------------------------
00001Cr 1               ; obsluha DLI
00001Cr 1               ; ---------------------------------------------------------------------
00001Cr 1               dli:
00001Cr 1  A9 00                lda #0
00001Er 1  8D 00 D4             sta DMACTL
000021r 1  A2 C0                ldx #192                ; počitadlo řádků
000023r 1  AC rr rr             ldy color               ; počáteční barva
000026r 1  8D 0A D4             sta WSYNC               ; čekání na další řádek
000029r 1               next_line:
000029r 1  8C 1A D0             sty COLBK               ; změna barvy
00002Cr 1  C8                   iny                     ; další barva v paletě
00002Dr 1               
00002Dr 1  EA EA EA EA          .repeat 10
000031r 1  EA EA EA EA  
000035r 1  EA EA        
000037r 1                       nop
000037r 1                       .endrepeat
000037r 1               
000037r 1  A9 00                lda #0
000039r 1  8D 1A D0             sta COLBK               ; změna barvy
00003Cr 1               
00003Cr 1  EA EA EA EA          .repeat 10
000040r 1  EA EA EA EA  
000044r 1  EA EA        
000046r 1                       nop
000046r 1                       .endrepeat
000046r 1               
000046r 1  8C 1A D0             sty COLBK
000049r 1               
000049r 1  EA EA EA EA          .repeat 10
00004Dr 1  EA EA EA EA  
000051r 1  EA EA        
000053r 1                       nop
000053r 1                       .endrepeat
000053r 1  8D 1A D0             sta COLBK               ; změna barvy
000056r 1               
000056r 1  8D 0A D4             sta WSYNC               ; čekání na další řádek
000059r 1               
000059r 1  A9 00                lda #0
00005Br 1  8D 1A D0             sta COLBK               ; změna barvy
00005Er 1               
00005Er 1  CA                   dex
00005Fr 1  D0 C8                bne next_line           ; opakovat 192x
000061r 1  EE rr rr             inc color               ; počáteční barva pro další snímek
000064r 1  40                   rti                     ; návrat z DLI
000065r 1               
000065r 1               
000065r 1               ; ---------------------------------------------------------------------
000065r 1               ; display list
000065r 1               ; ---------------------------------------------------------------------
000065r 1               dlist:
000065r 1  70 70 F0     .byte DL_BLK8, DL_BLK8, DL_DLI+DL_BLK8 ; 3x8=24 prázdných obrazových řádků
000068r 1  70 70 70 70  .res 24, DL_BLK8                ; opakovat řádky textového režimu 2 (GR.0)
00006Cr 1  70 70 70 70  
000070r 1  70 70 70 70  
000074r 1  70 70 70 70  
000078r 1  70 70 70 70  
00007Cr 1  70 70 70 70  
000080r 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
000083r 1               
000083r 1               end:
000083r 1               
000083r 1  00           color: .byte 0
000084r 1               
000084r 1               .BSS
