...
Main file   : rainbow_1.asm
Current file: rainbow_1.asm
...
00001Er 1               next_line:
00001Er 1  8E 18 D0             stx COLPF2              ; změna barvy
000021r 1  8D 0A D4             sta WSYNC               ; čekání na další řádek
000024r 1  CA                   dex
000025r 1  D0 F7                bne next_line           ; opakovat 192x
...
00002Cr 1  rr rr        .byte <screen, >screen          ; počáteční adresa obrazové paměti
00002Er 1  02 02 02 02  .res 23, DL_CHR40x8x1           ; opakovat řádky textového režimu 2 (GR.0)
000032r 1  02 02 02 02  
000036r 1  02 02 02 02  
00003Ar 1  02 02 02 02  
00003Er 1  02 02 02 02  
000042r 1  02 02 02     
000045r 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
000048r 1               
000048r 1               end:
000048r 1               
000048r 1               .BSS
