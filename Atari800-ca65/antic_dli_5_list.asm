...
Main file   : antic_dli_5.asm
Current file: antic_dli_5.asm
...
000017r 1  D0 F3                bne clear               ; skok
000019r 1               
000019r 1                       ; vektor DLI
000019r 1  A9 rr                lda #<dli               ; nastavení DLI
00001Br 1  8D 00 02             sta VDSLST
00001Er 1  A9 rr                lda #>dli
000020r 1  8D 01 02             sta VDSLST+1
000023r 1               
000023r 1                       ; povolení DLI
000023r 1                       NMIEN_DLI=$80           ; maska povolení DLI
000023r 1                       NMIEN_VBI=$40           ; maska povolení VBI
000023r 1  A9 C0                lda #NMIEN_DLI | NMIEN_VBI ; povolení DLI
000025r 1  8D 0E D4             sta NMIEN
000028r 1               
...
000039r 1               
000039r 1               ; ---------------------------------------------------------------------
000039r 1               ; display list
000039r 1               ; ---------------------------------------------------------------------
000039r 1               dlist:
000039r 1  70 70 70     .byte DL_BLK8, DL_BLK8, DL_BLK8 ; 3x8=24 prázdných obrazových řádků
00003Cr 1  42           .byte DL_LMS+DL_CHR40x8x1       ; určení počáteční adresy obrazové paměti + jeden řádek režimu 2 (GR.0)
00003Dr 1  rr rr        .byte <screen, >screen          ; počáteční adresa obrazové paměti
00003Fr 1  02 02 02 02  .res 6, DL_CHR40x8x1            ; opakovat řádky textového režimu 2 (GR.0)
000043r 1  02 02        
000045r 1  82           .byte DL_DLI+DL_CHR40x8x1       ; GR.0 ovšem navíc s povolením DLI
000046r 1  02 02 02 02  .res 7, DL_CHR40x8x1            ; opakovat řádky textového režimu 2 (GR.0)
00004Ar 1  02 02 02     
00004Dr 1  82           .byte DL_DLI+DL_CHR40x8x1       ; GR.0 ovšem navíc s povolením DLI
00004Er 1  02 02 02 02  .res 8, DL_CHR40x8x1            ; opakovat řádky textového režimu 2 (GR.0)
000052r 1  02 02 02 02  
000056r 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
000059r 1               
000059r 1               color:
000059r 1  C4           .byte $c4                       ; původní barva
00005Ar 1               
00005Ar 1               end:
00005Ar 1               
00005Ar 1               .BSS
