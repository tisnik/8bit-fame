...
Main file   : pmg_stick_4.asm
Current file: pmg_stick_4.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Ovládání PMG joystickem v horizontální směru, zobrazení pátého hráče.
000000r 1               ;
...
00007Ar 1               
00007Ar 1  A2 50                ldx #80                 ; výchozí pozice prvního hráče
00007Cr 1               loop:
00007Cr 1  8A                   txa                     ; uložení obsahu X do akumulátoru
00007Dr 1  20 rr rr             jsr _wait_vsync
000080r 1  20 rr rr             jsr _wait_vsync
000083r 1  AA                   tax                     ; obnovení obsahu X z akumulátoru
000084r 1               
000084r 1  AD 78 02             lda STICK0              ; čtení joysticku
000087r 1  C9 0B                cmp #11                 ; je nakloněn doleva?
000089r 1  D0 01                bne not_left
00008Br 1  CA                   dex                     ; posun hráče doleva
00008Cr 1               not_left:
00008Cr 1  C9 07                cmp #7                  ; je nakloněn doprava?
00008Er 1  D0 01                bne not_right
000090r 1  E8                   inx                     ; posun hráče doprava
000091r 1               not_right:
000091r 1  8E 00 D0             stx HPOSP0              ; změna pozice prvního hráče
000094r 1  4C rr rr             jmp loop
000097r 1               
000097r 1               .endproc
000097r 1               
000097r 1               
000097r 1               .proc   _wait_vsync
000097r 1  A6 14                ldx     RTCLOK+2        ; čekání na konec snímku
000099r 1  E4 14        @wt:    cpx     RTCLOK+2
00009Br 1  F0 FC                beq     @wt
00009Dr 1  60                   rts
00009Er 1               .endproc
00009Er 1               
00009Er 1               
00009Er 1               ; data
00009Er 1  18 3C 7E DB  sprite:   .byte 24, 60, 126, 219, 255, 36, 90, 165
0000A2r 1  FF 24 5A A5  
0000A6r 1               
0000A6r 1               end:
0000A6r 1               
0000A6r 1               
0000A6r 1               .segment "EXEHDR"
