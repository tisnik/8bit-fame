...
Main file   : antic_5.asm
Current file: antic_5.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Výpis všech 128 znaků v přímé i inverzní podobě v režimu GR.0.
000000r 1               ; Mezinárodní znaková sada.
000000r 1               ;
...
000000r 1               ; ---------------------------------------------------------------------
000000r 1               .proc main
000000r 1  A9 CC                lda #204                ; adresa se stránkou znakové sady
...
000021r 1  02           .byte DL_CHR40x8x1              ; jeden řádek textového režimu 2 (GR.0)
000022r 1  02           .byte DL_CHR40x8x1              ; jeden řádek textového režimu 2 (GR.0)
000023r 1  02           .byte DL_CHR40x8x1              ; jeden řádek textového režimu 2 (GR.0)
000024r 1  02           .byte DL_CHR40x8x1              ; jeden řádek textového režimu 2 (GR.0)
000025r 1  02           .byte DL_CHR40x8x1              ; jeden řádek textového režimu 2 (GR.0)
000026r 1  02           .byte DL_CHR40x8x1              ; jeden řádek textového režimu 2 (GR.0)
000027r 1  02           .byte DL_CHR40x8x1              ; jeden řádek textového režimu 2 (GR.0)
000028r 1  02           .byte DL_CHR40x8x1              ; jeden řádek textového režimu 2 (GR.0)
000029r 1  02           .byte DL_CHR40x8x1              ; jeden řádek textového režimu 2 (GR.0)
00002Ar 1  02           .byte DL_CHR40x8x1              ; jeden řádek textového režimu 2 (GR.0)
00002Br 1  02           .byte DL_CHR40x8x1              ; jeden řádek textového režimu 2 (GR.0)
00002Cr 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
00002Fr 1               
00002Fr 1               end:
00002Fr 1               
00002Fr 1               
