...
Main file   : gtia_mode_A.asm
Current file: gtia_mode_A.asm
...
000000r 1               ; Přepnutí do GTIA režimu 11.
000000r 1               ; ---------------------------------------------------------------------
000000r 1               
...
000008r 1  31 02        
00000Ar 1  A9 rr 8D 00          set_dli_handler dli     ; nastavení obsluhy DLI
00000Er 1  02 A9 rr 8D  
000012r 1  01 02        
000014r 1  A9 00 85 80          fill_screen screen1     ; vyplnění obrazovky
000018r 1  A9 70 85 81  
00001Cr 1  A2 60 A9 00  
000020r 1  A8 18 91 80  
000024r 1  C8 69 01 C9  
000028r 1  28 D0 F7 A5  
00002Cr 1  80 18 69 28  
000030r 1  85 80 A5 81  
000034r 1  69 00 85 81  
000038r 1  CA D0 E3     
00003Br 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
00003Er 1               
00003Er 1  20 rr rr             jsr enable_dli          ; povolení DLI (a VBI)
000041r 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
000044r 1               
000044r 1  20 rr rr             jsr gtia_mode_11        ; nastavení GTIA režimu číslo 11
000047r 1               
000047r 1  4C rr rr             game_loop               ; hlavní herní smyčka
00004Ar 1               .endproc
00004Ar 1               
00004Ar 1               
00004Ar 1               
00004Ar 1               ; ---------------------------------------------------------------------
00004Ar 1               ; povolení DLI (a VBI)
00004Ar 1               ; ---------------------------------------------------------------------
00004Ar 1               .proc enable_dli
00004Ar 1                       ; povolení DLI
00004Ar 1                       NMIEN_DLI=$80           ; maska povolení DLI
00004Ar 1                       NMIEN_VBI=$40           ; maska povolení VBI
00004Ar 1  A9 C0                lda #NMIEN_DLI | NMIEN_VBI ; povolení DLI
00004Cr 1  8D 0E D4             sta NMIEN
00004Fr 1  60                   rts
000050r 1               .endproc
000050r 1               
000050r 1               
000050r 1               
000050r 1               ; ---------------------------------------------------------------------
000050r 1               ; nastavení GTIA režimu číslo 11
000050r 1               ; ---------------------------------------------------------------------
000050r 1               .proc gtia_mode_11
000050r 1  AD 6F 02             lda GPRIOR              ; modifikace stínového registru GPRIOR
000053r 1  09 C0                ora  #$c0               ; výběr GTIA režimu GR.11
000055r 1  8D 6F 02             sta GPRIOR
000058r 1  60                   rts                     ; vyber adresy ze zasobniku + skok
000059r 1               .endproc
000059r 1               
000059r 1               
000059r 1               
000059r 1               ; ---------------------------------------------------------------------
000059r 1               ; čekání na stisk klávesy
000059r 1               ; ---------------------------------------------------------------------
000059r 1               .proc get_key
000059r 1                       KBHANDLER = $e424       ; rutina pro cteni klavesy
000059r 1  AD 25 E4             lda KBHANDLER+1         ; cteni horni casti adresy ulozene v ROM
00005Cr 1  48                   pha                     ; ulozeni na zasobnik
00005Dr 1  AD 24 E4             lda KBHANDLER           ; cteni dolni casti adresy ulozene v ROM
000060r 1  48                   pha                     ; ulozeni na zasobnik
000061r 1  60                   rts                     ; vyber adresy ze zasobniku + skok
000062r 1                                               ; zde neni nutne mit RTS
000062r 1               .endproc
000062r 1               
000062r 1               
000062r 1               ; ---------------------------------------------------------------------
000062r 1               ; obsluha DLI
000062r 1               ; ---------------------------------------------------------------------
000062r 1               dli:
000062r 1  48                   pha                     ; uschovat akumulátor
000063r 1  AD rr rr             lda color               ; barva pozadí
000066r 1  18                   clc
000067r 1  69 01                adc #1
000069r 1  8D rr rr             sta color
00006Cr 1  29 0E                and #%00001110
00006Er 1  8D 1A D0             sta COLBK               ; přímo nastavit zápisem do HW registru
000071r 1  68                   pla                     ; obnovit akumulátor
000072r 1  40                   rti                     ; návrat z DLI
000073r 1               
000073r 1               
000073r 1               dlist:
000073r 1  70 70 70     .byte DL_BLK8, DL_BLK8, DL_BLK8 ; 3x8=24 prázdných obrazových řádků
000076r 1  4F           .byte DL_LMS+DL_MAP320x1x1      ; určení počáteční adresy obrazové paměti + jeden řádek režimu F (GR.8)
000077r 1  00 70        .byte <screen1, >screen1        ; počáteční adresa obrazové paměti (první blok)
000079r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
00007Dr 1  0F           
00007Er 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
00007Fr 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000083r 1  0F           
000084r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
000085r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000089r 1  0F           
00008Ar 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
00008Br 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
00008Fr 1  0F           
000090r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
000091r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
000095r 1  0F           
000096r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
000097r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
00009Br 1  0F           
00009Cr 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
00009Dr 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000A1r 1  0F           
0000A2r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
0000A3r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000A7r 1  0F           
0000A8r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
0000A9r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000ADr 1  0F           
0000AEr 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
0000AFr 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000B3r 1  0F           
0000B4r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
0000B5r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000B9r 1  0F           
0000BAr 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
0000BBr 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000BFr 1  0F           
0000C0r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
0000C1r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000C5r 1  0F           
0000C6r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
0000C7r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000CBr 1  0F           
0000CCr 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
0000CDr 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000D1r 1  0F           
0000D2r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
0000D3r 1  0F 0F 0F 0F  .res 5,  DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000D7r 1  0F           
0000D8r 1  8F           .byte DL_MAP320x1x1+DL_DLI      ; povolení DLI
0000D9r 1  4F           .byte DL_LMS+DL_MAP320x1x1      ; určení počáteční adresy obrazové paměti + jeden řádek režimu F (GR.8)
0000DAr 1  00 80        .byte <screen2, >screen2        ; počáteční adresa obrazové paměti (druhý blok)
0000DCr 1  0F 0F 0F 0F  .res 95, DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000E0r 1  0F 0F 0F 0F  
0000E4r 1  0F 0F 0F 0F  
0000E8r 1  0F 0F 0F 0F  
0000ECr 1  0F 0F 0F 0F  
0000F0r 1  0F 0F 0F 0F  
0000F4r 1  0F 0F 0F 0F  
0000F8r 1  0F 0F 0F 0F  
0000FCr 1  0F 0F 0F 0F  
000100r 1  0F 0F 0F 0F  
000104r 1  0F 0F 0F 0F  
000108r 1  0F 0F 0F 0F  
00010Cr 1  0F 0F 0F 0F  
000110r 1  0F 0F 0F 0F  
000114r 1  0F 0F 0F 0F  
000118r 1  0F 0F 0F 0F  
00011Cr 1  0F 0F 0F 0F  
000120r 1  0F 0F 0F 0F  
000124r 1  0F 0F 0F 0F  
000128r 1  0F 0F 0F 0F  
00012Cr 1  0F 0F 0F 0F  
000130r 1  0F 0F 0F 0F  
000134r 1  0F 0F 0F 0F  
000138r 1  0F 0F 0F     
00013Br 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
00013Er 1               
00013Er 1               ; barva v GTIA režimu 9
00013Er 1  00           color: .byte 0
00013Fr 1               
00013Fr 1               end:
00013Fr 1               
00013Fr 1               .segment "EXEHDR"
