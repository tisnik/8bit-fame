...
Main file   : sound_4.asm
Current file: sound_4.asm
...
000008r 1               
000008r 1  A9 FF                lda #255                ; dělič základní frekvence
...
000015r 1               
000015r 1  A9 01                lda #INPUT_FREQ_15KHZ   ; základní tón odvozený od 15kHz
