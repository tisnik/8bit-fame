...
Main file   : cio_get_block.asm
Current file: cio_get_block.asm
...
00001Er 1               
00001Er 1  A9 12                lda #18                 ; kod barvy
000020r 1  8D C6 02             sta COLOR2              ; ulozit do registru COLOR2
000023r 1               loop:
000023r 1  4C rr rr             jmp loop                ; program vlastně nice nedělá - jen cyklí!
000026r 1               .endproc
000026r 1               
000026r 1  xx xx xx xx  buffer: .res 10
00002Ar 1  xx xx xx xx  
00002Er 1  xx xx        
000030r 1               end_of_buffer:
000030r 1               
000030r 1               end:
000030r 1               
000030r 1               
