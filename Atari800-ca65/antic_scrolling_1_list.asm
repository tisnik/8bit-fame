...
Main file   : antic_scrolling_1.asm
Current file: antic_scrolling_1.asm
...
000027r 1  AE rr rr             ldx x_scroll            ; původní pozice prvního hráče
00002Ar 1               
00002Ar 1  AD 78 02             lda STICK0              ; čtení joysticku
00002Dr 1  C9 0B                cmp #11                 ; je nakloněn doleva?
00002Fr 1  D0 01                bne not_left
000031r 1  CA                   dex                     ; posun hráče doleva
000032r 1               not_left:
000032r 1  C9 07                cmp #7                  ; je nakloněn doprava?
000034r 1  D0 01                bne not_right
000036r 1  E8                   inx                     ; posun hráče doprava
000037r 1               not_right:
000037r 1  8E rr rr             stx x_scroll            ; zapamatovat si pozici prvního hráče
00003Ar 1                       ; scrolling
00003Ar 1  4C 62 E4             jmp XITVBV              ; zpracovat zbytek odloženého VBLANKu
00003Dr 1               .endproc
00003Dr 1               
00003Dr 1               
00003Dr 1               dlist:
...
000041r 1  rr rr        .byte <screen, >screen          ; počáteční adresa obrazové paměti
000043r 1  02 02 02 02  .res 23, DL_CHR40x8x1           ; opakovat řádky textového režimu 2 (GR.0)
000047r 1  02 02 02 02  
00004Br 1  02 02 02 02  
00004Fr 1  02 02 02 02  
000053r 1  02 02 02 02  
000057r 1  02 02 02     
00005Ar 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
00005Dr 1               
00005Dr 1               
00005Dr 1               color:
00005Dr 1  C4           .byte $c4                       ; původní barva
00005Er 1               
00005Er 1               
00005Er 1               ; horizontální scrolling
00005Er 1  00           x_scroll:    .byte 0
00005Fr 1               
00005Fr 1               end:
00005Fr 1               
00005Fr 1               
