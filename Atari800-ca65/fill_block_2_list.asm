...
Main file   : fill_block_2.asm
Current file: fill_block_2.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Vyplnění bloku kontantou, nekorektní varianta s jedním index registrem
000000r 1               ;
...
000009r 1               
000009r 1  4C rr rr     loop:   jmp loop
00000Cr 1               end:
00000Cr 1               .endproc
00000Cr 1               
00000Cr 1               
00000Cr 1               .segment "EXEHDR"
