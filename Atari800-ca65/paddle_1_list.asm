...
Main file   : paddle_1.asm
Current file: paddle_1.asm
...
000005r 1               
000005r 1  A9 CC                lda #HUE_GREEN<<4 + 12  ; barva prvního hráče (odstín+intenzita)
000007r 1  8D C0 02             sta PCOLR0              ; uložit do řídicího registru PCOLR0 na čipu GTIA
00000Ar 1               
00000Ar 1  A9 03                lda #3                  ; bitové pole: povolení hráčů i střel
00000Cr 1  8D 1D D0             sta GRACTL              ; uložit do řídicího registru GRACTL na čipu GTIA
00000Fr 1               
00000Fr 1  A9 00                lda #0                  ; priorita hráčů a pozadí
000011r 1  8D 6F 02             sta GPRIOR              ; uložit do řídicího registru GPRIOR na čipu GTIA
000014r 1               
...
00001Er 1  9D 32 9A             sta addr+PLAYER_0_OFFSET+50, x  ; uložit byte - první hráč
...
00004Cr 1  4C 62 E4             jmp XITVBV              ; zpracovat zbytek odloženého VBLANKu
00004Fr 1  60                   rts
000050r 1               .endproc
000050r 1               
000050r 1               
000050r 1               ; data
000050r 1  18 3C 7E DB  sprite:   .byte 24, 60, 126, 219, 255, 36, 90, 165
000054r 1  FF 24 5A A5  
000058r 1               
000058r 1               ; horizontální pozice hráče
000058r 1  50           x_pos:    .byte 80
000059r 1               
000059r 1               end:
000059r 1               
000059r 1               
000059r 1               .segment "EXEHDR"
