...
Main file   : pmg_07.asm
Current file: pmg_07.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Initializace PMG, nastavení barvy, pozice a bitmapy prvního hráče.
000000r 1               ;
...
000019r 1  A9 18                lda #24                 ; bitová maska jednoho řádku spritu
00001Br 1  8D 40 9A             sta addr+512+64         ; zapsat do paměti
00001Er 1  A9 3C                lda #60
000020r 1  8D 41 9A             sta addr+512+64+1
000023r 1  A9 7E                lda #126
000025r 1  8D 42 9A             sta addr+512+64+2
000028r 1  A9 7E                lda #126
00002Ar 1  8D 43 9A             sta addr+512+64+3
00002Dr 1  A9 DB                lda #219
00002Fr 1  8D 44 9A             sta addr+512+64+4
000032r 1  A9 FF                lda #255
000034r 1  8D 45 9A             sta addr+512+64+5
000037r 1  A9 24                lda #36
000039r 1  8D 46 9A             sta addr+512+64+6
00003Cr 1  A9 5A                lda #90
00003Er 1  8D 47 9A             sta addr+512+64+7
000041r 1  A9 A5                lda #165
000043r 1  8D 48 9A             sta addr+512+64+8
000046r 1               
000046r 1  A9 2E                lda #46                 ; povolení PMG DMA
000048r 1  8D 2F 02             sta SDMCTL
00004Br 1               
00004Br 1  4C rr rr     loop:   jmp loop
00004Er 1               .endproc
00004Er 1               
00004Er 1               end:
00004Er 1               
00004Er 1               
00004Er 1               .segment "EXEHDR"
