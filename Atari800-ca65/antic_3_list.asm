...
Main file   : antic_3.asm
Current file: antic_3.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Nastavení display listu s několika různými textovými i grafickými režimy.
000000r 1               ;
...
000020r 1  rr rr        .byte <screen, >screen          ; počáteční adresa obrazové paměti
000022r 1  07           .byte DL_CHR20x16x2             ; jeden řádek textového režimu 7 (GR.2)
000023r 1  02           .byte DL_CHR40x8x1              ; jeden řádek textového režimu 2 (GR.0)
000024r 1  06           .byte DL_CHR20x8x2              ; jeden řádek textového režimu 6 (GR.1)
000025r 1  02           .byte DL_CHR40x8x1              ; jeden řádek textového režimu 2 (GR.0)
000026r 1  07           .byte DL_CHR20x16x2             ; jeden řádek textového režimu 7 (GR.2)
000027r 1  07           .byte DL_CHR20x16x2             ; jeden řádek textového režimu 7 (GR.2)
000028r 1  08           .byte DL_MAP40x8x4              ; jeden řádek grafického režimu 8 (GR.3)
000029r 1  08           .byte DL_MAP40x8x4              ; jeden řádek grafického režimu 8 (GR.3)
00002Ar 1  07           .byte DL_CHR20x16x2             ; jeden řádek textového režimu 7 (GR.2)
00002Br 1  07           .byte DL_CHR20x16x2             ; jeden řádek textového režimu 7 (GR.2)
00002Cr 1  07           .byte DL_CHR20x16x2             ; jeden řádek textového režimu 7 (GR.2)
00002Dr 1  02           .byte DL_CHR40x8x1              ; jeden řádek textového režimu 2 (GR.0)
