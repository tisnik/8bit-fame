...
Main file   : paddle_2.asm
Current file: paddle_2.asm
...
000036r 1  AD 70 02             lda PADDL0              ; čtení hodnoty paddle
000039r 1  8D 00 D0             sta HPOSP0              ; změna pozice prvního hráče
00003Cr 1  4C 62 E4             jmp XITVBV              ; zpracovat zbytek odloženého VBLANKu
00003Fr 1  60                   rts
000040r 1               .endproc
000040r 1               
000040r 1               
000040r 1               ; data
000040r 1  18 3C 7E DB  sprite:   .byte 24, 60, 126, 219, 255, 36, 90, 165
000044r 1  FF 24 5A A5  
000048r 1               
000048r 1               end:
000048r 1               
000048r 1               
000048r 1               .segment "EXEHDR"
