...
Main file   : sound_1.asm
Current file: sound_1.asm
...
000015r 1               
000015r 1  A9 00                lda #0                  ; vypnutí zvuku (nulová hlasitost)
000017r 1  8D 01 D2             sta AUDC1               ; zápis do registru řízení hlasitosti pro zvukový kanál číslo 1 čipu POKEY
00001Ar 1               
00001Ar 1  4C rr rr     loop:   jmp loop
00001Dr 1               .endproc
00001Dr 1               
00001Dr 1               
00001Dr 1               ; ---------------------------------------------------------------------
00001Dr 1               ; čekání na stisk klávesy
00001Dr 1               ; ---------------------------------------------------------------------
00001Dr 1               .proc get_key
00001Dr 1                       KBHANDLER = $e424       ; rutina pro cteni klavesy
00001Dr 1  AD 25 E4             lda KBHANDLER+1         ; cteni horni casti adresy ulozene v ROM
000020r 1  48                   pha                     ; ulozeni na zasobnik
000021r 1  AD 24 E4             lda KBHANDLER           ; cteni dolni casti adresy ulozene v ROM
000024r 1  48                   pha                     ; ulozeni na zasobnik
000025r 1  60                   rts                     ; vyber adresy ze zasobniku + skok
000026r 1                                               ; zde neni nutne mit RTS
000026r 1               .endproc
000026r 1               
000026r 1               
000026r 1               end:
000026r 1               
000026r 1               .segment "EXEHDR"
