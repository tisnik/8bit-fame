...
Main file   : key_03.asm
Current file: key_03.asm
...
000000r 1  A9 rr                lda #>vbi_handler
000002r 1  8D 25 02             sta VVBLKD+1
000005r 1  A9 rr                lda #<vbi_handler
000007r 1  8D 24 02             sta VVBLKD
00000Ar 1               loop:
00000Ar 1  4C rr rr             jmp loop                ; program vlastně nice nedělá - jen cyklí!
00000Dr 1               .endproc
00000Dr 1               
00000Dr 1               
00000Dr 1               
00000Dr 1               ; ---------------------------------------------------------------------
00000Dr 1               ; Tisk hodnoty 0..255 formou dvou hexadecimálních číslic
00000Dr 1               ; ---------------------------------------------------------------------
00000Dr 1               .proc print_2_hex_digits
00000Dr 1  48                   pha                     ; ulozit akumulator na zasobnik
00000Er 1  4A 4A 4A 4A          lsr_ 4                  ; posun 4 nejvyssich bitu do bitu nejnizsich
000012r 1  20 rr rr             jsr nibble_to_hex_char  ; prevod na interni kod cislice
000015r 1  A0 00                ldy #0                  ; pozice na obrazovce
000017r 1  20 rr rr             jsr print_char_at_y     ; tisk cislice/znaku
00001Ar 1               
00001Ar 1  68                   pla
00001Br 1  29 0F                and #$0f                ; ziskat jen nizsi nibble
00001Dr 1  20 rr rr             jsr nibble_to_hex_char  ; prevod na interni kod cislice
000020r 1  A0 01                ldy #1                  ; pozice na obrazovce
000022r 1  20 rr rr             jsr print_char_at_y     ; tisk cislice/znaku
000025r 1               .endproc
000025r 1               
000025r 1               
000025r 1               
000025r 1               ; ---------------------------------------------------------------------
000025r 1               ; Převod hodnoty 0..15 na jeden hexadecimální znak
000025r 1               ; ---------------------------------------------------------------------
000025r 1               .proc nibble_to_hex_char
000025r 1  C9 0A                cmp #$0a                ; test na hodnotu 0-9 nebo 10-15
000027r 1  90 02                bcc skip_add            ; je to hodnota 0-9
000029r 1  69 06                adc #6                  ; pricist sedmicku (6+carry)
00002Br 1               skip_add:
00002Br 1  69 10                adc #16                 ; prevod hodnoty na interni kod (ne ATASCII!)
00002Dr 1  60                   rts                     ; navrat z podprogramu
00002Er 1               .endproc
00002Er 1               
00002Er 1               
00002Er 1               
00002Er 1               ; ---------------------------------------------------------------------
00002Er 1               ; Tisk znaku (v akumulátoru) na offset definovaný v index registru Y
00002Er 1               ; ---------------------------------------------------------------------
00002Er 1               .proc print_char_at_y
00002Er 1  91 58                sta (88), y             ; tisk znaku na první místo na obrazovce
000030r 1                                               ; (adresa Video RAM je na adresách 88 a 89)
000030r 1  60                   rts
000031r 1               .endproc
000031r 1               
000031r 1               
000031r 1               
000031r 1               ; ---------------------------------------------------------------------
000031r 1               ; Subrutina pro obsluhu VBI
000031r 1               ; ---------------------------------------------------------------------
000031r 1               .proc   vbi_handler
000031r 1  AD 09 D2             lda KBCODE              ; načtení kódu stlačených kláves
000034r 1  20 rr rr             jsr print_2_hex_digits
000037r 1               
000037r 1  4C 62 E4             jmp XITVBV              ; zpracovat zbytek odloženého VBLANKu
00003Ar 1  60                   rts
00003Br 1               .endproc
00003Br 1               
00003Br 1               end:                            ; potrebujeme znat adresu konce kodoveho segmentu
00003Br 1               
00003Br 1               
00003Br 1               .segment "EXEHDR"
