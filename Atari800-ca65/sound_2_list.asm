...
Main file   : sound_2.asm
Current file: sound_2.asm
...
000000r 1               ;
000000r 1               ; Čip POKEY v osmibitových mikropočítačích Atari
000000r 1               ; https://www.root.cz/clanky/cip-pokey-v-osmibitovych-mikropocitacich-atari/
000000r 1               ; ---------------------------------------------------------------------
000000r 1               
...
00000Dr 1               
00000Dr 1  A9 00                lda #00                 ; základní tón odvozený od 64kHz
00000Fr 1  8D 08 D2             sta AUDCTL              ; zápis do řídicího registru čipu POKEY
000012r 1               
000012r 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
000015r 1               
000015r 1  A9 6A                lda #POLY_5_BIT_MASK+10 ; hlasitost (0-15) + noise
...
00001Dr 1               
00001Dr 1  A9 00                lda #0                  ; vypnutí zvuku (nulová hlasitost)
00001Fr 1  8D 01 D2             sta AUDC1               ; zápis do registru řízení hlasitosti pro zvukový kanál číslo 1 čipu POKEY
000022r 1               
000022r 1  4C rr rr     loop:   jmp loop
000025r 1               .endproc
000025r 1               
000025r 1               
000025r 1               ; ---------------------------------------------------------------------
000025r 1               ; čekání na stisk klávesy
000025r 1               ; ---------------------------------------------------------------------
000025r 1               .proc get_key
000025r 1                       KBHANDLER = $e424       ; rutina pro cteni klavesy
000025r 1  AD 25 E4             lda KBHANDLER+1         ; cteni horni casti adresy ulozene v ROM
000028r 1  48                   pha                     ; ulozeni na zasobnik
000029r 1  AD 24 E4             lda KBHANDLER           ; cteni dolni casti adresy ulozene v ROM
00002Cr 1  48                   pha                     ; ulozeni na zasobnik
00002Dr 1  60                   rts                     ; vyber adresy ze zasobniku + skok
00002Er 1                                               ; zde neni nutne mit RTS
00002Er 1               .endproc
00002Er 1               
00002Er 1               
00002Er 1               end:
00002Er 1               
00002Er 1               .segment "EXEHDR"
