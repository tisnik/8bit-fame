...
000000r 1               .proc main
000000r 1               loop:
000000r 1  A0 00                ldy #0                  ; počitadlo zápisů
000002r 1               fills:
000002r 1  AD 0A D2             lda RANDOM
000005r 1  91 58                sta (88), y             ; tisk znaku na zvolené místo na obrazovce
000007r 1                                               ; (adresa Video RAM je na adresách 88 a 89)
000007r 1  C8                   iny                     ; zvětšit hodnotu počitadla a offsetu
000008r 1  C0 F0                cpy #40*6               ; test na koncovou hodnotu počitadla
00000Ar 1  D0 F6                bne fills               ; skok, pokud Y>40*6
00000Cr 1               
00000Cr 1  20 rr rr             jsr get_key
00000Fr 1  4C rr rr             jmp loop
000012r 1               .endproc
000012r 1               
000012r 1               
000012r 1               ; ---------------------------------------------------------------------
000012r 1               ; čekání na stisk klávesy
000012r 1               ; ---------------------------------------------------------------------
000012r 1               .proc get_key
000012r 1                       KBHANDLER = $e424       ; rutina pro cteni klavesy
000012r 1  AD 25 E4             lda KBHANDLER+1         ; cteni horni casti adresy ulozene v ROM
000015r 1  48                   pha                     ; ulozeni na zasobnik
000016r 1  AD 24 E4             lda KBHANDLER           ; cteni dolni casti adresy ulozene v ROM
000019r 1  48                   pha                     ; ulozeni na zasobnik
00001Ar 1  60                   rts                     ; vyber adresy ze zasobniku + skok
00001Br 1                                               ; zde neni nutne mit RTS
00001Br 1               .endproc
00001Br 1               
00001Br 1               
00001Br 1               end:
00001Br 1               
00001Br 1               .segment "EXEHDR"
