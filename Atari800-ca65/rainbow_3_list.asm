...
Main file   : rainbow_3.asm
Current file: rainbow_3.asm
...
00001Cr 1               ; ---------------------------------------------------------------------
00001Cr 1               dli:
00001Cr 1  A2 C0                ldx #192                ; počitadlo řádků
00001Er 1  AC rr rr             ldy color               ; počáteční barva
000021r 1  A9 FF                lda #$ff
000023r 1  18                   clc
000024r 1  ED rr rr             sbc color
000027r 1               next_line:
000027r 1  8C 18 D0             sty COLPF2              ; změna barvy
00002Ar 1  8D 0A D4             sta WSYNC               ; čekání na další řádek
00002Dr 1  C8                   iny                     ; další barva v paletě
00002Er 1               
00002Er 1  8D 1A D0             sta COLBK               ; změna barvy okraje
000031r 1  18                   clc
000032r 1  E9 01                sbc #1
000034r 1               
000034r 1  CA                   dex
000035r 1  D0 F0                bne next_line           ; opakovat 192x
000037r 1  EE rr rr             inc color               ; počáteční barva pro další snímek
00003Ar 1               
00003Ar 1  A9 00                lda #0                  ; černá barva
00003Cr 1  8D 1A D0             sta COLBK               ; změna barvy spodního okraje
00003Fr 1               
00003Fr 1  40                   rti                     ; návrat z DLI
000040r 1               
000040r 1               
000040r 1               ; ---------------------------------------------------------------------
000040r 1               ; display list
000040r 1               ; ---------------------------------------------------------------------
000040r 1               dlist:
000040r 1  70 70 F0     .byte DL_BLK8, DL_BLK8, DL_DLI+DL_BLK8 ; 3x8=24 prázdných obrazových řádků
000043r 1  42           .byte DL_LMS+DL_CHR40x8x1       ; určení počáteční adresy obrazové paměti + jeden řádek režimu 2 (GR.0)
000044r 1  rr rr        .byte <screen, >screen          ; počáteční adresa obrazové paměti
000046r 1  02 02 02 02  .res 23, DL_CHR40x8x1           ; opakovat řádky textového režimu 2 (GR.0)
00004Ar 1  02 02 02 02  
00004Er 1  02 02 02 02  
000052r 1  02 02 02 02  
000056r 1  02 02 02 02  
00005Ar 1  02 02 02     
00005Dr 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
000060r 1               
000060r 1               end:
000060r 1               
000060r 1  00           color: .byte 0
000061r 1               
000061r 1               .BSS
