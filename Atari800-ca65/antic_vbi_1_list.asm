...
Main file   : antic_vbi_1.asm
Current file: antic_vbi_1.asm
...
00005Er 1               
00005Er 1               loop:
00005Er 1  20 rr rr             jsr horizontal_movement
000061r 1  4C rr rr             jmp loop
000064r 1               .endproc
000064r 1               
000064r 1               
...
000072r 1  C9 0B                cmp #11                 ; je nakloněn doleva?
000074r 1  D0 01                bne not_left
000076r 1  CA                   dex                     ; posun hráče doleva
000077r 1               not_left:
000077r 1  C9 07                cmp #7                  ; je nakloněn doprava?
000079r 1  D0 01                bne not_right
...
000087r 1  F0 FC                beq     @wt
000089r 1  60                   rts
00008Ar 1               .endproc
00008Ar 1               
00008Ar 1               
00008Ar 1               ; data
00008Ar 1  18 3C 7E DB  sprite:   .byte 24, 60, 126, 219, 255, 36, 90, 165
00008Er 1  FF 24 5A A5  
000092r 1               
000092r 1               ; horizontální pozice hráče
000092r 1  50           x_pos:    .byte 80
000093r 1               
000093r 1               end:
000093r 1               
000093r 1               
000093r 1               .segment "EXEHDR"
