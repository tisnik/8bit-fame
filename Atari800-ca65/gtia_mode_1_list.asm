...
Main file   : gtia_mode_1.asm
Current file: gtia_mode_1.asm
...
00002Er 1               
00002Er 1  4C rr rr     loop:   jmp loop
000031r 1               .endproc
000031r 1               
000031r 1               dlist:
000031r 1  70 70 70     .byte DL_BLK8, DL_BLK8, DL_BLK8 ; 3x8=24 prázdných obrazových řádků
000034r 1  4F           .byte DL_LMS+DL_MAP320x1x1      ; určení počáteční adresy obrazové paměti + jeden řádek režimu F (GR.8)
000035r 1  00 70        .byte <screen1, >screen1        ; počáteční adresa obrazové paměti (první blok)
000037r 1  0F 0F 0F 0F  .res 95, DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
00003Br 1  0F 0F 0F 0F  
00003Fr 1  0F 0F 0F 0F  
000043r 1  0F 0F 0F 0F  
000047r 1  0F 0F 0F 0F  
00004Br 1  0F 0F 0F 0F  
...
000093r 1  0F 0F 0F     
000096r 1  4F           .byte DL_LMS+DL_MAP320x1x1      ; určení počáteční adresy obrazové paměti + jeden řádek režimu F (GR.8)
000097r 1  00 80        .byte <screen2, >screen2        ; počáteční adresa obrazové paměti (druhý blok)
000099r 1  0F 0F 0F 0F  .res 95, DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
00009Dr 1  0F 0F 0F 0F  
0000A1r 1  0F 0F 0F 0F  
0000A5r 1  0F 0F 0F 0F  
0000A9r 1  0F 0F 0F 0F  
0000ADr 1  0F 0F 0F 0F  
...
0000F5r 1  0F 0F 0F     
0000F8r 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
0000FBr 1               
0000FBr 1               
0000FBr 1               end:
0000FBr 1               
0000FBr 1               .segment "EXEHDR"
