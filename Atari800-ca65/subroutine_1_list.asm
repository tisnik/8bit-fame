...
Main file   : subroutine_1.asm
Current file: subroutine_1.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Definice subrutin, volání subrutin, návrat ze subrutiny.
000000r 1               ;
...
000000r 1               
000000r 1               .proc main
000000r 1  20 rr rr             jsr print_char
000003r 1  4C rr rr     loop:   jmp loop
000006r 1               .endproc
000006r 1               
000006r 1               
000006r 1               .proc print_char
000006r 1  A9 21                lda #33                 ; kod znaku, ktery se bude tisknout
