...
Main file   : sound_5.asm
Current file: sound_5.asm
...
00000Br 1               
00000Br 1  A9 FF                lda #255                ; dělič základní frekvence
00000Dr 1  8D 00 D2             sta AUDF1               ; zápis do registru děliče frekvence pro zvukový kanál číslo 1 čipu POKEY
000010r 1  A9 FE                lda #254                ; dělič základní frekvence
000012r 1  8D 02 D2             sta AUDF2               ; zápis do registru děliče frekvence pro zvukový kanál číslo 2 čipu POKEY
000015r 1               
...
00001Dr 1               
00001Dr 1  A9 01                lda #INPUT_FREQ_15KHZ   ; základní tón odvozený od 15kHz
00001Fr 1  8D 08 D2             sta AUDCTL              ; zápis do řídicího registru čipu POKEY
000022r 1               
000022r 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
000025r 1               
000025r 1  A9 00                lda #0                  ; vypnutí zvuku (nulová hlasitost)
000027r 1  8D 01 D2             sta AUDC1               ; zápis do registru řízení hlasitosti pro zvukový kanál číslo 1 čipu POKEY
00002Ar 1               
00002Ar 1  4C rr rr     loop:   jmp loop
00002Dr 1               .endproc
00002Dr 1               
00002Dr 1               
00002Dr 1               ; ---------------------------------------------------------------------
00002Dr 1               ; čekání na stisk klávesy
00002Dr 1               ; ---------------------------------------------------------------------
00002Dr 1               .proc get_key
00002Dr 1                       KBHANDLER = $e424       ; rutina pro cteni klavesy
