...
Main file   : gtia_mode_2.asm
Current file: gtia_mode_2.asm
...
000000r 1               ; Obrazovka by měla obsahovat šestnáct odstínů šedi.
000000r 1               ; ---------------------------------------------------------------------
000000r 1               
...
000031r 1               
000031r 1  AD 6F 02             lda GPRIOR              ; modifikace stínového registru GPRIOR
000034r 1  09 40                ora  #$40               ; výběr GTIA režimu GR.9
000036r 1  8D 6F 02             sta GPRIOR
000039r 1               
000039r 1  4C rr rr     loop:   jmp loop
00003Cr 1               .endproc
00003Cr 1               
00003Cr 1               
00003Cr 1               ; ---------------------------------------------------------------------
00003Cr 1               ; čekání na stisk klávesy
00003Cr 1               ; ---------------------------------------------------------------------
00003Cr 1               .proc get_key
00003Cr 1                       KBHANDLER = $e424       ; rutina pro cteni klavesy
00003Cr 1  AD 25 E4             lda KBHANDLER+1         ; cteni horni casti adresy ulozene v ROM
00003Fr 1  48                   pha                     ; ulozeni na zasobnik
000040r 1  AD 24 E4             lda KBHANDLER           ; cteni dolni casti adresy ulozene v ROM
000043r 1  48                   pha                     ; ulozeni na zasobnik
000044r 1  60                   rts                     ; vyber adresy ze zasobniku + skok
000045r 1                                               ; zde neni nutne mit RTS
000045r 1               .endproc
000045r 1               
000045r 1               
000045r 1               dlist:
000045r 1  70 70 70     .byte DL_BLK8, DL_BLK8, DL_BLK8 ; 3x8=24 prázdných obrazových řádků
000048r 1  4F           .byte DL_LMS+DL_MAP320x1x1      ; určení počáteční adresy obrazové paměti + jeden řádek režimu F (GR.8)
000049r 1  00 70        .byte <screen1, >screen1        ; počáteční adresa obrazové paměti (první blok)
00004Br 1  0F 0F 0F 0F  .res 95, DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
00004Fr 1  0F 0F 0F 0F  
000053r 1  0F 0F 0F 0F  
000057r 1  0F 0F 0F 0F  
00005Br 1  0F 0F 0F 0F  
00005Fr 1  0F 0F 0F 0F  
...
0000A7r 1  0F 0F 0F     
0000AAr 1  4F           .byte DL_LMS+DL_MAP320x1x1      ; určení počáteční adresy obrazové paměti + jeden řádek režimu F (GR.8)
0000ABr 1  00 80        .byte <screen2, >screen2        ; počáteční adresa obrazové paměti (druhý blok)
0000ADr 1  0F 0F 0F 0F  .res 95, DL_MAP320x1x1          ; opakovat řádky grafického režimu F (GR.8)
0000B1r 1  0F 0F 0F 0F  
0000B5r 1  0F 0F 0F 0F  
0000B9r 1  0F 0F 0F 0F  
0000BDr 1  0F 0F 0F 0F  
0000C1r 1  0F 0F 0F 0F  
...
000109r 1  0F 0F 0F     
00010Cr 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
00010Fr 1               
00010Fr 1               
00010Fr 1               end:
00010Fr 1               
00010Fr 1               .segment "EXEHDR"
