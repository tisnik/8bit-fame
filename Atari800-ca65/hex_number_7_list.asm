...
Main file   : hex_number_7.asm
Current file: hex_number_7.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Realizace tisku dvouciferné hexadecimální hodnoty
000000r 1               ;
...
000009r 1  4A           	lsr                     ; posun 4 nejvyssich bitu do bitu nejnizsich
00000Ar 1  4A           	lsr
00000Br 1  4A           	lsr
00000Cr 1  4A           	lsr
...
000020r 1               
000020r 1               
000020r 1               .proc nibble_to_hex_char
000020r 1  C9 0A                cmp #$0a                ; test na hodnotu 0-9 nebo 10-15
000022r 1  90 02                bcc skip_add            ; je to hodnota 0-9
000024r 1  69 06                adc #6                  ; pricist sedmicku (6+carry)
000026r 1               skip_add:
000026r 1  69 10                adc #16                 ; prevod hodnoty na interni kod (ne ATASCII!)
000028r 1  60                   rts                     ; navrat z podprogramu
000029r 1               .endproc
000029r 1               
000029r 1               
000029r 1               .proc print_char_at_y
000029r 1  91 58                sta (88), y             ; tisk znaku na první místo na obrazovce
00002Br 1                                               ; (adresa Video RAM je na adresách 88 a 89)
00002Br 1  60                   rts
00002Cr 1               .endproc
00002Cr 1               
00002Cr 1               end:                            ; potrebujeme znat adresu konce kodoveho segmentu
00002Cr 1               
00002Cr 1               
00002Cr 1               .segment "EXEHDR"
