...
Main file   : antic_8.asm
Current file: antic_8.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Výpis všech 64 znaků ve čtyřech barvách v režimu GR.1.
000000r 1               ; Použití prvních 64 znaků z ATASCII.
000000r 1               ;
...
000000r 1               ; ---------------------------------------------------------------------
000000r 1               .proc main
000000r 1  A9 E2                lda #226                ; adresa se stránkou znakové sady
...
000016r 1  D0 F9                bne clear               ; skok
000018r 1               
...
00001Br 1               
00001Br 1               ; ---------------------------------------------------------------------
00001Br 1               ; display list
00001Br 1               ; ---------------------------------------------------------------------
00001Br 1               dlist:
00001Br 1  70 70 70     .byte DL_BLK8, DL_BLK8, DL_BLK8 ; 3x8=24 prázdných obrazových řádků
00001Er 1  46           .byte DL_LMS+DL_CHR20x8x2       ; určení počáteční adresy obrazové paměti + jeden řádek režimu 2 (GR.0)
00001Fr 1  rr rr        .byte <screen, >screen          ; počáteční adresa obrazové paměti
000021r 1  06           .byte DL_CHR20x8x2              ; jeden řádek textového režimu 6 (GR.1)
000022r 1  06           .byte DL_CHR20x8x2              ; jeden řádek textového režimu 6 (GR.1)
000023r 1  06           .byte DL_CHR20x8x2              ; jeden řádek textového režimu 6 (GR.1)
000024r 1  06           .byte DL_CHR20x8x2              ; jeden řádek textového režimu 6 (GR.1)
000025r 1  06           .byte DL_CHR20x8x2              ; jeden řádek textového režimu 6 (GR.1)
000026r 1  06           .byte DL_CHR20x8x2              ; jeden řádek textového režimu 6 (GR.1)
000027r 1  06           .byte DL_CHR20x8x2              ; jeden řádek textového režimu 6 (GR.1)
000028r 1  06           .byte DL_CHR20x8x2              ; jeden řádek textového režimu 6 (GR.1)
000029r 1  06           .byte DL_CHR20x8x2              ; jeden řádek textového režimu 6 (GR.1)
00002Ar 1  06           .byte DL_CHR20x8x2              ; jeden řádek textového režimu 6 (GR.1)
00002Br 1  06           .byte DL_CHR20x8x2              ; jeden řádek textového režimu 6 (GR.1)
00002Cr 1  06           .byte DL_CHR20x8x2              ; jeden řádek textového režimu 6 (GR.1)
00002Dr 1  06           .byte DL_CHR20x8x2              ; jeden řádek textového režimu 6 (GR.1)
00002Er 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
000031r 1               
000031r 1               end:
000031r 1               
000031r 1               
000031r 1               .BSS
000000r 1  xx xx xx xx  screen: .res 20*24              ; rezervace prostoru pro video paměť
