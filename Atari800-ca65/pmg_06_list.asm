...
Main file   : pmg_06.asm
Current file: pmg_06.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Initializace PMG, povolení PMG, nastavení pozice, tvaru a barvy dvou
000000r 1               ; hráčů.
000000r 1               ;
...
000005r 1               
000005r 1  A9 84                lda #132                ; horizontální pozice druého hráče
000007r 1  8D 01 D0             sta HPOSP1              ; uložit do řídicího registru HPOSP1 na čipu GTIA
00000Ar 1               
00000Ar 1  A9 C6                lda #HUE_GREEN<<4 + 6   ; barva prvního hráče (odstín+intenzita)
00000Cr 1  8D C0 02             sta PCOLR0              ; uložit do řídicího registru PCOLR0 na čipu GTIA
00000Fr 1               
00000Fr 1  A9 EC                lda #HUE_YELLOW<<4 + 12 ; barva druhého hráče (odstín+intenzita)
000011r 1  8D C1 02             sta PCOLR1              ; uložit do řídicího registru PCOLR1 na čipu GTIA
000014r 1               
000014r 1  A9 FF                lda #$ff                ; bitová maska prvního i druhého hráče
000016r 1  8D 0D D0             sta GRAFP0              ; uložit do řídicího registru GRAFP0 na čipu GTIA
000019r 1  8D 0E D0             sta GRAFP1              ; uložit do řídicího registru GRAFP1 na čipu GTIA
00001Cr 1               
00001Cr 1  A9 00                lda #0                  ; bitové pole: vše nulové
00001Er 1  8D 1D D0             sta GRACTL              ; uložit do řídicího registru GRACTL na čipu GTIA
000021r 1               
000021r 1  A9 00                lda #0                  ; priorita hráčů a pozadí
000023r 1  8D 6F 02             sta GPRIOR              ; uložit do řídicího registru GPRIOR na čipu GTIA
000026r 1               
000026r 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
000029r 1               
000029r 1  A9 20                lda #32                 ; priorita hráčů a pozadí - OR barev
00002Br 1  8D 6F 02             sta GPRIOR              ; uložit do řídicího registru GPRIOR na čipu GTIA
00002Er 1               
00002Er 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
000031r 1               
000031r 1  A9 1F                lda #31                 ; priorita hráčů a pozadí
000033r 1  8D 6F 02             sta GPRIOR              ; uložit do řídicího registru GPRIOR na čipu GTIA
000036r 1               
000036r 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
000039r 1               
000039r 1  A9 25                lda #37                 ; priorita hráčů a pozadí
00003Br 1  8D 6F 02             sta GPRIOR              ; uložit do řídicího registru GPRIOR na čipu GTIA
00003Er 1               
