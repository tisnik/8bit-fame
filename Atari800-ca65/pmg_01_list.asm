...
Main file   : pmg_01.asm
Current file: pmg_01.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Initializace PMG, povolení PMG, nastavení pozice a tvaru prvního hráče.
000000r 1               ;
...
000005r 1               
000005r 1  A9 FF                lda #$ff                ; bitová maska hráče
000007r 1  8D 0D D0             sta GRAFP0              ; uložit do řídicího registru GRAFP0 na čipu GTIA
00000Ar 1               
00000Ar 1  4C rr rr     loop:   jmp loop
00000Dr 1               end:
00000Dr 1               .endproc
00000Dr 1               
00000Dr 1               
00000Dr 1               .segment "EXEHDR"
