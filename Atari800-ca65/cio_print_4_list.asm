...
Main file   : cio_print_4.asm
Current file: cio_print_4.asm
...
000000r 1               
000000r 1               .proc main
000000r 1  A2 3C                ldx #60                 ; offset odvozený od čísla IOCB kanálu (nutno násobit šestnácti)
000002r 1  A9 09                lda #PUTREC             ; prováděná operace
000004r 1  9D 42 03             sta ICCOM, x
000007r 1               
000007r 1                       ; adresa zapisovaného bloku
000007r 1  A9 rr                lda #<message
000009r 1  9D 44 03             sta ICBAL, x
00000Cr 1  A9 rr                lda #>message
00000Er 1  9D 45 03             sta ICBAH, x
000011r 1               
000011r 1                       ; nastavení počtu zapisovaných bajtů na 256!!!
000011r 1  A9 00                lda #0
000013r 1  9D 48 03             sta ICBLL, x
000016r 1  A9 01                lda #1
000018r 1  9D 49 03             sta ICBLH, x
00001Br 1               
00001Br 1                       ; zavolání rutiny pro CIO
00001Br 1  20 56 E4             jsr CIOV
00001Er 1               
00001Er 1  BD 43 03     	lda ICSTA, x            ; status poslední operace
000021r 1  10 08        	bpl ok                  ; test bitu 7
000023r 1               
000023r 1  A9 12                lda #18                 ; kod barvy
000025r 1  8D C6 02             sta COLOR2              ; ulozit do registru COLOR2
000028r 1  4C rr rr     	jmp loop
00002Br 1               
00002Br 1               ok:
00002Br 1  A9 C3                lda #$c3                ; kod barvy
00002Dr 1  8D C6 02             sta COLOR2              ; ulozit do registru COLOR2
000030r 1               
000030r 1               loop:
000030r 1  4C rr rr             jmp loop                ; program vlastně nice nedělá - jen cyklí!
000033r 1               .endproc
000033r 1               
000033r 1  48 65 6C 6C  message: .byte "Hello, world!", $9b
000037r 1  6F 2C 20 77  
00003Br 1  6F 72 6C 64  
00003Fr 1  21 9B        
000041r 1               end_of_message:
000041r 1               
000041r 1               end:
000041r 1               
000041r 1               
000041r 1               .segment "EXEHDR"
