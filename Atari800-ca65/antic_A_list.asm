...
Main file   : antic_A.asm
Current file: antic_A.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Výpis 256 kódů znaků v režimu GR.12.
000000r 1               ; Použití vlastní znakové sady (resp. její části).
000000r 1               ;
...
00000Ar 1  A9 rr                lda #>dlist             ; vyšší byte adresy display listu
00000Cr 1  8D 31 02             sta SDLSTH
00000Fr 1               
00000Fr 1  A0 00                ldy #0                  ; počitadlo zápisů
000011r 1               fill_screen:
000011r 1  98                   tya                     ; kód vypisovaného znaku
000012r 1  99 rr rr             sta screen, y           ; tisk znaku na zvolené místo na obrazovce
000015r 1  C8                   iny                     ; zvětšit hodnotu počitadla a offsetu
000016r 1  D0 F9                bne fill_screen         ; skok
000018r 1               
000018r 1               define_font:
000018r 1  A2 40                ldx #8*8                ; počitadlo smyčky
00001Ar 1               next_line:
00001Ar 1  BD rr rr             lda font_source, x      ; načíst byte
00001Dr 1  9D 00 98             sta font_target, x      ; uložit byte
000020r 1  CA                   dex                     ; snížit offset + nastavit příznaky
000021r 1  D0 F7                bne next_line           ; další byte spritu
...
00002Ar 1  rr rr        .byte <screen, >screen          ; počáteční adresa obrazové paměti
00002Cr 1  04           .byte DL_CHR40x8x4              ; jeden řádek textového režimu 4 (GR.12)
00002Dr 1  04           .byte DL_CHR40x8x4              ; jeden řádek textového režimu 4 (GR.12)
00002Er 1  04           .byte DL_CHR40x8x4              ; jeden řádek textového režimu 4 (GR.12)
00002Fr 1  04           .byte DL_CHR40x8x4              ; jeden řádek textového režimu 4 (GR.12)
000030r 1  04           .byte DL_CHR40x8x4              ; jeden řádek textového režimu 4 (GR.12)
000031r 1  04           .byte DL_CHR40x8x4              ; jeden řádek textového režimu 4 (GR.12)
000032r 1  04           .byte DL_CHR40x8x4              ; jeden řádek textového režimu 4 (GR.12)
000033r 1  04           .byte DL_CHR40x8x4              ; jeden řádek textového režimu 4 (GR.12)
000034r 1  04           .byte DL_CHR40x8x4              ; jeden řádek textového režimu 4 (GR.12)
000035r 1  04           .byte DL_CHR40x8x4              ; jeden řádek textového režimu 4 (GR.12)
000036r 1  04           .byte DL_CHR40x8x4              ; jeden řádek textového režimu 4 (GR.12)
000037r 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
00003Ar 1               
00003Ar 1               font_source:
...
000042r 1               
000042r 1  40           .byte %01000000
000043r 1  40           .byte %01000000
000044r 1  40           .byte %01000000
000045r 1  40           .byte %01000000
000046r 1  40           .byte %01000000
000047r 1  40           .byte %01000000
000048r 1  40           .byte %01000000
000049r 1  40           .byte %01000000
00004Ar 1               
00004Ar 1  80           .byte %10000000
00004Br 1  80           .byte %10000000
00004Cr 1  80           .byte %10000000
00004Dr 1  80           .byte %10000000
00004Er 1  80           .byte %10000000
00004Fr 1  80           .byte %10000000
000050r 1  80           .byte %10000000
000051r 1  80           .byte %10000000
000052r 1               
000052r 1  C0           .byte %11000000
000053r 1  C0           .byte %11000000
000054r 1  C0           .byte %11000000
000055r 1  C0           .byte %11000000
000056r 1  C0           .byte %11000000
000057r 1  C0           .byte %11000000
000058r 1  C0           .byte %11000000
000059r 1  C0           .byte %11000000
00005Ar 1               
00005Ar 1  00           .byte %00000000
00005Br 1  00           .byte %00000000
00005Cr 1  00           .byte %00000000
00005Dr 1  00           .byte %00000000
00005Er 1  00           .byte %00000000
00005Fr 1  00           .byte %00000000
000060r 1  00           .byte %00000000
000061r 1  00           .byte %00000000
000062r 1               
000062r 1  55           .byte %01010101
000063r 1  55           .byte %01010101
000064r 1  55           .byte %01010101
000065r 1  55           .byte %01010101
000066r 1  55           .byte %01010101
000067r 1  55           .byte %01010101
000068r 1  55           .byte %01010101
000069r 1  55           .byte %01010101
00006Ar 1               
00006Ar 1  AA           .byte %10101010
00006Br 1  AA           .byte %10101010
00006Cr 1  AA           .byte %10101010
00006Dr 1  AA           .byte %10101010
00006Er 1  AA           .byte %10101010
00006Fr 1  AA           .byte %10101010
000070r 1  AA           .byte %10101010
000071r 1  AA           .byte %10101010
000072r 1               
000072r 1  FF           .byte %11111111
000073r 1  FF           .byte %11111111
