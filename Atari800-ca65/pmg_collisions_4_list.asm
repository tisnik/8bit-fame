...
Main file   : pmg_collisions_4.asm
Current file: pmg_collisions_4.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Ovládání PMG joystickem. Detekce kolize prvního hráče s hracím polem.
000000r 1               ;
...
000000r 1               MISSILES_OFFSET = 384
000000r 1               
000000r 1               
000000r 1               .proc main
000000r 1  A9 3C                lda #60                 ; horizontální pozice prvního hráče
000002r 1  8D 00 D0             sta HPOSP0              ; uložit do řídicího registru HPOSP0 na čipu GTIA
000005r 1               
000005r 1  A9 5A                lda #90                 ; horizontální pozice druhého hráče
000007r 1  8D 01 D0             sta HPOSP1              ; uložit do řídicího registru HPOSP1 na čipu GTIA
00000Ar 1               
00000Ar 1  A9 64                lda #100                ; horizontální pozice třetího hráče
00000Cr 1  8D 02 D0             sta HPOSP2              ; uložit do řídicího registru HPOSP2 na čipu GTIA
00000Fr 1               
00000Fr 1  A9 6E                lda #110                ; horizontální pozice čtvrtého hráče
000011r 1  8D 03 D0             sta HPOSP3              ; uložit do řídicího registru HPOSP3 na čipu GTIA
000014r 1               
000014r 1  A9 8C                lda #140                ; horizontální pozice první střely
000016r 1  8D 04 D0             sta HPOSM0              ; uložit do řídicího registru HPOSP0 na čipu GTIA
000019r 1               
000019r 1  A9 90                lda #144                ; horizontální pozice druhé střely
00001Br 1  8D 05 D0             sta HPOSM1              ; uložit do řídicího registru HPOSP1 na čipu GTIA
00001Er 1               
00001Er 1  A9 94                lda #148                ; horizontální pozice třetí střely
000020r 1  8D 06 D0             sta HPOSM2              ; uložit do řídicího registru HPOSP2 na čipu GTIA
000023r 1               
000023r 1  A9 98                lda #152                ; horizontální pozice čtvrté střely
000025r 1  8D 07 D0             sta HPOSM3              ; uložit do řídicího registru HPOSP3 na čipu GTIA
000028r 1               
000028r 1  A9 CC                lda #HUE_GREEN<<4 + 12  ; barva prvního hráče (odstín+intenzita)
00002Ar 1  8D C0 02             sta PCOLR0              ; uložit do řídicího registru PCOLR0 na čipu GTIA
00002Dr 1               
00002Dr 1  A9 EC                lda #HUE_YELLOW<<4 + 12 ; barva druhého hráče (odstín+intenzita)
00002Fr 1  8D C1 02             sta PCOLR1              ; uložit do řídicího registru PCOLR1 na čipu GTIA
000032r 1               
000032r 1  A9 5C                lda #HUE_MAGENTA<<4 + 12 ; barva třetího hráče (odstín+intenzita)
000034r 1  8D C2 02             sta PCOLR2              ; uložit do řídicího registru PCOLR2 na čipu GTIA
000037r 1               
000037r 1  A9 9C                lda #HUE_CYAN<<4 + 12   ; barva čtvrtého hráče (odstín+intenzita)
000039r 1  8D C3 02             sta PCOLR3              ; uložit do řídicího registru PCOLR3 na čipu GTIA
00003Cr 1               
00003Cr 1  A9 F8                lda #HUE_YELLOWRED<<4 + 8   ; barva pátého hráče (odstín+intenzita)
00003Er 1  8D C7 02             sta COLOR3              ; uložit do řídicího registru COLPF3 na čipu GTIA
000041r 1               
000041r 1  A9 03                lda #3                  ; bitové pole: povolení hráčů i střel
000043r 1  8D 1D D0             sta GRACTL              ; uložit do řídicího registru GRACTL na čipu GTIA
000046r 1               
000046r 1  A9 00                lda #0                  ; priorita hráčů a pozadí
000048r 1  8D 6F 02             sta GPRIOR              ; uložit do řídicího registru GPRIOR na čipu GTIA
00004Br 1               
00004Br 1  A9 98                lda #152                ; paměťová stránka číslo 152
00004Dr 1  8D 07 D4             sta PMBASE
000050r 1               
000050r 1                       addr = 152*256
000050r 1  A2 0A                ldx #10                 ; začneme na hodnotě o 1 vyšší
000052r 1               next_line:
000052r 1  BD rr rr             lda sprite-1, x         ; načíst
000055r 1  9D 0A 9A             sta addr+PLAYER_0_OFFSET+10, x  ; uložit byte - první hráč
000058r 1  9D B2 9A             sta addr+PLAYER_1_OFFSET+50, x  ; uložit byte - druhý hráč
00005Br 1  9D 32 9B             sta addr+PLAYER_2_OFFSET+50, x  ; uložit byte - třetí hráč
00005Er 1  9D B2 9B             sta addr+PLAYER_3_OFFSET+50, x  ; uložit byte - čtvrtý hráč
...
00006Br 1  8D 2F 02             sta SDMCTL
00006Er 1               
00006Er 1               ; zde začíná "herní kernel"
00006Er 1  A2 3C                ldx #60                 ; výchozí pozice prvního hráče
000070r 1  A0 14                ldy #20                 ; X i Y
000072r 1               loop:
000072r 1  20 rr rr             jsr _wait_vsync         ; čekání na vykreslení snímku
000075r 1  20 rr rr             jsr _wait_vsync
000078r 1  20 rr rr             jsr _wait_vsync
00007Br 1  20 rr rr             jsr _wait_vsync
00007Er 1               
00007Er 1  AD 78 02             lda STICK0              ; čtení joysticku
000081r 1  C9 0B                cmp #11                 ; je nakloněn doleva?
000083r 1  D0 01                bne not_left
000085r 1  CA                   dex                     ; posun hráče doleva
000086r 1               not_left:
000086r 1  C9 07                cmp #7                  ; je nakloněn doprava?
000088r 1  D0 01                bne not_right
00008Ar 1  E8                   inx                     ; posun hráče doprava
00008Br 1               not_right:
00008Br 1  C9 0E                cmp #14                 ; je nakloněn nahoru?
00008Dr 1  D0 04                bne not_up
00008Fr 1  88                   dey                     ; změna Y-ové souřadnice hráče
000090r 1  20 rr rr             jsr draw_at_y           ; překreslení spritu
000093r 1               not_up:
000093r 1  C9 0D                cmp #13                 ; je nakloněn dolů?
000095r 1  D0 04                bne not_down
000097r 1  C8                   iny                     ; změna Y-ové souřadnice hráče
...
0000A5r 1  18           	clc
0000A6r 1  6D 04 D0     	adc P0PF
0000A9r 1  0A           	asl                     ; posun na pozice informace o odstínu
0000AAr 1  0A           	asl
0000ABr 1  0A           	asl
0000ACr 1  0A           	asl
0000ADr 1  18           	clc
0000AEr 1  69 0C        	adc #12                 ; přidat světlost barvy
0000B0r 1               
0000B0r 1  8D C0 02     	sta PCOLR0              ; změnit barvu prvního hráče
0000B3r 1  8D 1E D0     	sta HITCLR              ; vymazat informace o kolizích
0000B6r 1               
0000B6r 1  4C rr rr             jmp loop
0000B9r 1               
0000B9r 1               .endproc
0000B9r 1               
0000B9r 1               
0000B9r 1               .proc   _wait_vsync
0000B9r 1  8A                   txa                     ; uložení obsahu X do akumulátoru
0000BAr 1  A6 14                ldx     RTCLOK+2        ; čekání na konec snímku
0000BCr 1  E4 14        @wt:    cpx     RTCLOK+2
0000BEr 1  F0 FC                beq     @wt
0000C0r 1  AA                   tax                     ; obnovení obsahu X z akumulátoru
0000C1r 1  60                   rts
0000C2r 1               .endproc
0000C2r 1               
0000C2r 1               
0000C2r 1               .proc  draw_at_y
0000C2r 1                       addr = 152*256          ; adresa první stránky se sprity
0000C2r 1  8A                   txa
0000C3r 1  48                   pha                     ; uložit X na zásobník
0000C4r 1  98                   tya
0000C5r 1  48                   pha                     ; uložit Y na zásobník
0000C6r 1               
0000C6r 1  A2 0A                ldx #10                 ; začneme na hodnotě o 1 vyšší
0000C8r 1               next_line:
0000C8r 1  BD rr rr             lda sprite-1, x         ; načíst
0000CBr 1  99 00 9A             sta addr+PLAYER_0_OFFSET, y  ; uložit byte - první hráč
0000CEr 1  88                   dey
0000CFr 1  CA                   dex                     ; snížit offset + nastavit příznaky
0000D0r 1  D0 F6                bne next_line           ; další byte spritu
0000D2r 1               
0000D2r 1  68                   pla
0000D3r 1  A8                   tay                     ; obnovit Y ze zásobníku
0000D4r 1  68                   pla
0000D5r 1  AA                   tax                     ; obnovit X ze zásobníku
0000D6r 1  60                   rts                     ; návrat z podprogramu
0000D7r 1               .endproc
0000D7r 1               
0000D7r 1               
0000D7r 1               ; data
0000D7r 1  00 18 3C 7E  sprite:   .byte 0, 24, 60, 126, 219, 255, 36, 90, 165, 0
0000DBr 1  DB FF 24 5A  
0000DFr 1  A5 00        
0000E1r 1               
0000E1r 1               end:
0000E1r 1               
0000E1r 1               
0000E1r 1               .segment "EXEHDR"
