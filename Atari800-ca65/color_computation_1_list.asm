...
Main file   : color_computation_1.asm
Current file: color_computation_1.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Výpočet barvy pozadí na základě odstínu barvy a intenzity
000000r 1               ;
...
000000r 2               
000000r 1               
000000r 1               HUE_COLOR_GRAY        = 16 * $0
000000r 1               HUE_COLOR_GOLD        = 16 * $1
000000r 1               HUE_COLOR_ORANGE_1    = 16 * $2
000000r 1               HUE_COLOR_PINK        = 16 * $3
000000r 1               HUE_COLOR_MAGENTA     = 16 * $4
000000r 1               HUE_COLOR_BLUE        = 16 * $5
000000r 1               HUE_COLOR_INDIGO      = 16 * $6
000000r 1               HUE_COLOR_SKY_BLUE    = 16 * $7
000000r 1               HUE_COLOR_ROYAL_BLUE  = 16 * $8
000000r 1               HUE_COLOR_LIGHT_BLUE  = 16 * $9
000000r 1               HUE_COLOR_TURQOISE    = 16 * $A
000000r 1               HUE_COLOR_AQUAMARIN   = 16 * $B
000000r 1               HUE_COLOR_SEA_GREEN   = 16 * $C
000000r 1               HUE_COLOR_LIGHT_GREEN = 16 * $D
000000r 1               HUE_COLOR_OLIVE       = 16 * $E
000000r 1               HUE_COLOR_ORANGE_2    = 16 * $F
000000r 1               
000000r 1               .CODE
000000r 1               
000000r 1               
...
000003r 1  69 06                adc #6                  ; svetlost v rozsahu 0..14 s krokem 2
000005r 1  8D C6 02             sta COLOR2              ; ulozit do registru COLOR2
000008r 1  4C rr rr     loop:   jmp loop
00000Br 1               end:
00000Br 1               .endproc
00000Br 1               
00000Br 1               
00000Br 1               .segment "EXEHDR"
