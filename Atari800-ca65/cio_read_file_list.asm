...
Main file   : cio_read_file.asm
Current file: cio_read_file.asm
...
00004Dr 1  A9 0D                lda #(end_of_buffer-buffer)
...
00006Cr 1  A9 0D                lda #(end_of_buffer-buffer)
...
000086r 1               
000086r 1               ; buffer
000086r 1  xx xx xx xx  buffer: .res 13
00008Ar 1  xx xx xx xx  
00008Er 1  xx xx xx xx  
000092r 1  xx           
000093r 1               end_of_buffer:
000093r 1               
000093r 1               end:
000093r 1               
000093r 1               
