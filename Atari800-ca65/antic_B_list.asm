...
00000Cr 1               clear:
00000Cr 1  98                   tya                     ; kód tištěných pixelů
00000Dr 1  99 rr rr             sta screen, y           ; tisk pixelu na zvolené místo na obrazovce
000010r 1  C8                   iny                     ; zvětšit hodnotu počitadla a offsetu
000011r 1  D0 F9                bne clear               ; skok
000013r 1               
...
000019r 1  49           .byte DL_LMS+DL_MAP80x4x2       ; určení počáteční adresy obrazové paměti + jeden řádek režimu 9 (GR.4)
00001Ar 1  rr rr        .byte <screen, >screen          ; počáteční adresa obrazové paměti
00001Cr 1  09           .byte DL_MAP80x4x2              ; jeden řádek grafického režimu 9 (GR.4)
...
000034r 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
000037r 1               
000037r 1               end:
000037r 1               
000037r 1               
000037r 1               .BSS
000000r 1  xx xx xx xx  screen: .res 10*48              ; rezervace prostoru pro video paměť
