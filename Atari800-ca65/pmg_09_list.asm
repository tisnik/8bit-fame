...
Main file   : pmg_09.asm
Current file: pmg_09.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Initializace PMG, povolení PMG, nastavení pozice, tvaru a barvy všech
000000r 1               ; objektů.
000000r 1               ;
...
000014r 1               
000014r 1  A9 C6                lda #HUE_GREEN<<4 + 6   ; barva prvního hráče (odstín+intenzita)
...
000036r 1               
000036r 1  A9 00                lda #0                  ; bitové pole: vše nulové
...
000040r 1               
000040r 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
000043r 1               
000043r 1  A9 01                lda #1                  ; priorita hráčů a pozadí
000045r 1  8D 6F 02             sta GPRIOR              ; uložit do řídicího registru GPRIOR na čipu GTIA
000048r 1               
000048r 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
00004Br 1               
00004Br 1  A9 02                lda #2                  ; priorita hráčů a pozadí
00004Dr 1  8D 6F 02             sta GPRIOR              ; uložit do řídicího registru GPRIOR na čipu GTIA
000050r 1               
000050r 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
000053r 1               
000053r 1  A9 04                lda #4                  ; priorita hráčů a pozadí
000055r 1  8D 6F 02             sta GPRIOR              ; uložit do řídicího registru GPRIOR na čipu GTIA
000058r 1               
000058r 1  4C rr rr     loop:   jmp loop
00005Br 1               .endproc
00005Br 1               
00005Br 1               .proc get_key
00005Br 1  AD 25 E4             lda KBHANDLER+1         ; cteni horni casti adresy ulozene v ROM
00005Er 1  48                   pha                     ; ulozeni na zasobnik
00005Fr 1  AD 24 E4             lda KBHANDLER           ; cteni dolni casti adresy ulozene v ROM
000062r 1  48                   pha                     ; ulozeni na zasobnik
000063r 1  60                   rts                     ; vyber adresy ze zasobniku + skok
000064r 1                                               ; zde neni nutne mit RTS
000064r 1               .endproc
000064r 1               
000064r 1               end:
000064r 1               
