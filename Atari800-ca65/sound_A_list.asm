...
Main file   : sound_A.asm
Current file: sound_A.asm
...
000025r 1               
000025r 1                       ; otočení frekvencí
000025r 1  A9 1F                lda #31                 ; dělič základní frekvence (cca 1kHz)
...
000032r 1               
000032r 1               ; ---------------------------------------------------------------------
000032r 1               ; čekání na stisk klávesy
000032r 1               ; ---------------------------------------------------------------------
000032r 1               .proc get_key
000032r 1                       KBHANDLER = $e424       ; rutina pro cteni klavesy
000032r 1  AD 25 E4             lda KBHANDLER+1         ; cteni horni casti adresy ulozene v ROM
000035r 1  48                   pha                     ; ulozeni na zasobnik
000036r 1  AD 24 E4             lda KBHANDLER           ; cteni dolni casti adresy ulozene v ROM
000039r 1  48                   pha                     ; ulozeni na zasobnik
00003Ar 1  60                   rts                     ; vyber adresy ze zasobniku + skok
00003Br 1                                               ; zde neni nutne mit RTS
00003Br 1               .endproc
00003Br 1               
00003Br 1               
00003Br 1               end:
