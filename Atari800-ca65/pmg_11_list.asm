...
00005Er 1               
00005Er 1  A9 50                lda #80                 ; výchozí pozice prvního hráče
000060r 1               loop:
000060r 1  20 rr rr             jsr wait                ; počkáme určitou dobu
000063r 1  38                   sec
000064r 1  69 00                adc #0
000066r 1  8D 00 D0             sta HPOSP0              ; změna pozice prvního hráče
000069r 1  4C rr rr             jmp loop
00006Cr 1               
00006Cr 1               .endproc
00006Cr 1               
00006Cr 1               
00006Cr 1               .proc wait
00006Cr 1  A0 32                ldy #50
00006Er 1               wait1:                          ; vnější čekací smyčka
00006Er 1  A2 00                ldx #0
000070r 1               wait2:                          ; vnitřní čekací smyčka
000070r 1  CA                   dex                     ; počitadlo vnitřní smyčky
000071r 1  D0 FD                bne wait2
000073r 1  88                   dey                     ; počitadlo vnější smyčky
000074r 1  D0 F8                bne wait1
000076r 1  60                   rts                     ; návrat ze subrutiny
000077r 1               .endproc
000077r 1               
000077r 1               
000077r 1               ; data
000077r 1  18 3C 7E DB  sprite:   .byte 24, 60, 126, 219, 255, 36, 90, 165
00007Br 1  FF 24 5A A5  
00007Fr 1               
00007Fr 1               end:
00007Fr 1               
00007Fr 1               
00007Fr 1               .segment "EXEHDR"
