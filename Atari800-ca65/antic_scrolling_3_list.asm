...
Main file   : antic_scrolling_3.asm
Current file: antic_scrolling_3.asm
...
000000r 1               
000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; makro pro tisk jedné hexa číslice na určené místo na obrazovce
000000r 1               ; ---------------------------------------------------------------------
000000r 1               .macro  print_hex address, screen, offset
000000r 1                       .local skip_add         ; definice lokálního symbolu
000000r 1                       lda address             ; načíst hodnotu, která se má vypsat
000000r 1                       lsr A                   ; 4x "zpomalení"
000000r 1                       lsr A
000000r 1                       and #15                 ; scrolling je jen v rozsahu 0-15
000000r 1                       cmp #$0a                ; test na hodnotu 0-9 nebo 10-15
000000r 1                       bcc skip_add            ; je to hodnota 0-9?
000000r 1                       adc #6                  ; pricist sedmicku (6+carry)
000000r 1               skip_add:
000000r 1                       adc #16                 ; prevod hodnoty na interni kod (ne ATASCII!)
000000r 1                       sta screen+offset
000000r 1               .endmacro
000000r 1               
000000r 1               
000000r 1               ; ---------------------------------------------------------------------
...
00001Ar 1  F1           
00001Br 1  A9 07 A2 rr          set_vbi_handler scroll  ; nastavení obsluhy VBI
00001Fr 1  A0 rr 20 5C  
000023r 1  E4           
000024r 1  4C rr rr             game_loop               ; hlavní herní smyčka
000027r 1               .endproc
000027r 1               
000027r 1               
000027r 1               ; ---------------------------------------------------------------------
000027r 1               ; subrutina pro obsluhu VBI
000027r 1               ; ---------------------------------------------------------------------
000027r 1               .proc   scroll
000027r 1  AD 78 02             lda STICK0              ; čtení joysticku
00002Ar 1  C9 0B                cmp #11                 ; je nakloněn doleva?
00002Cr 1  D0 03                bne not_left
00002Er 1  CE rr rr             dec x_scroll            ; změnit počitadlo horizontálního scrollingu
000031r 1               not_left:
000031r 1  C9 07                cmp #7                  ; je nakloněn doprava?
000033r 1  D0 03                bne not_right
000035r 1  EE rr rr             inc x_scroll            ; změnit počitadlo horizontálního scrollingu
000038r 1               not_right:
000038r 1  C9 0E                cmp #14                 ; je nakloněn nahoru?
00003Ar 1  D0 03                bne not_up
00003Cr 1  CE rr rr             dec y_scroll            ; změnit počitadlo vertikálního scrollingu
00003Fr 1               not_up:
00003Fr 1  C9 0D                cmp #13                 ; je nakloněn dolů?
000041r 1  D0 03                bne not_down
000043r 1  EE rr rr             inc y_scroll            ; změnit počitadlo vertikálního scrollingu
000046r 1               not_down:
000046r 1  AD rr rr             lda y_scroll            ; změna vertikálního posunu
000049r 1  4A                   lsr A                   ; 4x "zpomalení"
00004Ar 1  4A                   lsr A
00004Br 1  8D 05 D4             sta VSCROL              ; zápis do řídicího registru ANTICu
00004Er 1               
00004Er 1  AD rr rr 4A          print_hex x_scroll, screen, 40*23
000052r 1  4A 29 0F C9  
000056r 1  0A 90 02 69  
00005Ar 1  06 69 10 8D  
00005Er 1  rr rr        
000060r 1  AD rr rr 4A          print_hex y_scroll, screen, 40*23+2
000064r 1  4A 29 0F C9  
000068r 1  0A 90 02 69  
00006Cr 1  06 69 10 8D  
000070r 1  rr rr        
000072r 1  4C 62 E4             jmp XITVBV              ; zpracovat zbytek odloženého VBLANKu
000075r 1               .endproc
000075r 1               
000075r 1               
000075r 1               dlist:
000075r 1  70 70 70     .byte DL_BLK8, DL_BLK8, DL_BLK8 ; 3x8=24 prázdných obrazových řádků
000078r 1  42           .byte DL_LMS+DL_CHR40x8x1       ; určení počáteční adresy obrazové paměti + jeden řádek režimu 2 (GR.0)
000079r 1  rr rr        .byte <screen, >screen          ; počáteční adresa obrazové paměti
00007Br 1  02 02 02 02  .res 11, DL_CHR40x8x1           ; opakovat řádky textového režimu 2 (GR.0)
00007Fr 1  02 02 02 02  
000083r 1  02 02 02     
000086r 1  22 22 22 22  .res 7,  DL_VSCROL+DL_CHR40x8x1 ; zde bude povolen scrolling
00008Ar 1  22 22 22     
00008Dr 1  02 02 02 02  .res 5,  DL_CHR40x8x1           ; opakovat řádky textového režimu 2 (GR.0)
000091r 1  02           
000092r 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
000095r 1               
000095r 1               
000095r 1               color:
000095r 1  C4           .byte $c4                       ; původní barva
000096r 1               
000096r 1               
000096r 1               ; horizontální scrolling
000096r 1  00           x_scroll:    .byte 0
000097r 1               
000097r 1               ; vertikální scrolling
000097r 1  00           y_scroll:    .byte 0
000098r 1               
000098r 1               end:
000098r 1               
000098r 1               
