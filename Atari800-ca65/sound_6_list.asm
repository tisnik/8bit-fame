...
Main file   : sound_6.asm
Current file: sound_6.asm
...
000000r 1               INPUT_FREQ_15KHZ = %00000001
000000r 1               
000000r 1               .proc main
...
000008r 1  8D 03 D2             sta AUDC2               ; zápis do registru řízení hlasitosti pro zvukový kanál číslo 2 čipu POKEY
00000Br 1  8D 05 D2             sta AUDC3               ; zápis do registru řízení hlasitosti pro zvukový kanál číslo 3 čipu POKEY
00000Er 1  8D 07 D2             sta AUDC4               ; zápis do registru řízení hlasitosti pro zvukový kanál číslo 4 čipu POKEY
000011r 1               
000011r 1  A9 FF                lda #255                ; dělič základní frekvence
000013r 1  8D 00 D2             sta AUDF1               ; zápis do registru děliče frekvence pro zvukový kanál číslo 1 čipu POKEY
000016r 1  A9 FE                lda #254                ; dělič základní frekvence
000018r 1  8D 02 D2             sta AUDF2               ; zápis do registru děliče frekvence pro zvukový kanál číslo 2 čipu POKEY
00001Br 1  A9 FD                lda #253                ; dělič základní frekvence
00001Dr 1  8D 04 D2             sta AUDF3               ; zápis do registru děliče frekvence pro zvukový kanál číslo 3 čipu POKEY
000020r 1  A9 FC                lda #252                ; dělič základní frekvence
000022r 1  8D 06 D2             sta AUDF4               ; zápis do registru děliče frekvence pro zvukový kanál číslo 4 čipu POKEY
000025r 1               
000025r 1  A9 00                lda #00                 ; základní tón odvozený od 64kHz
000027r 1  8D 08 D2             sta AUDCTL              ; zápis do řídicího registru čipu POKEY
00002Ar 1               
00002Ar 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
00002Dr 1               
00002Dr 1  A9 01                lda #INPUT_FREQ_15KHZ   ; základní tón odvozený od 15kHz
00002Fr 1  8D 08 D2             sta AUDCTL              ; zápis do řídicího registru čipu POKEY
000032r 1               
000032r 1  20 rr rr             jsr get_key             ; čekání na stisk klávesy
000035r 1               
000035r 1  A9 00                lda #0                  ; vypnutí zvuku (nulová hlasitost)
...
00003Dr 1               
00003Dr 1               ; ---------------------------------------------------------------------
00003Dr 1               ; čekání na stisk klávesy
00003Dr 1               ; ---------------------------------------------------------------------
00003Dr 1               .proc get_key
00003Dr 1                       KBHANDLER = $e424       ; rutina pro cteni klavesy
00003Dr 1  AD 25 E4             lda KBHANDLER+1         ; cteni horni casti adresy ulozene v ROM
000040r 1  48                   pha                     ; ulozeni na zasobnik
000041r 1  AD 24 E4             lda KBHANDLER           ; cteni dolni casti adresy ulozene v ROM
000044r 1  48                   pha                     ; ulozeni na zasobnik
000045r 1  60                   rts                     ; vyber adresy ze zasobniku + skok
000046r 1                                               ; zde neni nutne mit RTS
000046r 1               .endproc
000046r 1               
000046r 1               
000046r 1               end:
