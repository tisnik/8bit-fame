...
Main file   : sound_C.asm
Current file: sound_C.asm
...
000000r 1               HIGH_PASS_1_3_MASK = %00000100
000000r 1               
000000r 1               ; Bit	Stručný popis
000000r 1               ; 7	záměna 17bitového poly čítače za 9bitový čítač
000000r 1               ; 6	vstupní hodinový signál pro kanál 1 bude mít frekvenci CPU (1,77 nebo 1,79 MHz)
000000r 1               ; 5	vstupní hodinový signál pro kanál 3 bude mít frekvenci CPU (1,77 nebo 1,79 MHz)
000000r 1               ; 4	vstupem kanálu číslo 2 bude kanál číslo 1 (spojení kanálů do 16bitového děliče)
000000r 1               ; 3	vstupem kanálu číslo 4 bude kanál číslo 3 (spojení kanálů do 16bitového děliče)
000000r 1               ; 2	konfigurace primitivní horní propusti pro kanál 1 tvořené kanálem 3
000000r 1               ; 1	konfigurace primitivní horní propusti pro kanál 2 tvořené kanálem 4
000000r 1               ; 0	vstupní hodinový signál bude mít frekvenci cca 15kHz a ne 64kHz
000000r 1               
000000r 1               
000000r 1               
000000r 1               .proc main
...
00000Dr 1               
00000Dr 1                       ; nastavit vektor pro odloženou VBI
00000Dr 1  A9 rr                lda #>horizontal_movement
00000Fr 1  8D 25 02             sta VVBLKD+1
000012r 1  A9 rr                lda #<horizontal_movement
000014r 1  8D 24 02             sta VVBLKD
000017r 1               loop:
000017r 1  AD rr rr             lda noise1
00001Ar 1  29 07                and #%111               ; jen spodní tři bity
00001Cr 1  0A                   asl                     ; posunout do nejvyšších tří pozic
00001Dr 1  0A                   asl
00001Er 1  0A                   asl
00001Fr 1  0A                   asl
000020r 1  0A                   asl
000021r 1  18                   clc
000022r 1  69 0A                adc #10                 ; přidat hlasitost
000024r 1  8D 01 D2             sta AUDC1
000027r 1               
...
000030r 1               
000030r 1               ; ---------------------------------------------------------------------
000030r 1               ; čekání na stisk klávesy
000030r 1               ; ---------------------------------------------------------------------
000030r 1               .proc get_key
000030r 1                       KBHANDLER = $e424       ; rutina pro cteni klavesy
000030r 1  AD 25 E4             lda KBHANDLER+1         ; cteni horni casti adresy ulozene v ROM
000033r 1  48                   pha                     ; ulozeni na zasobnik
000034r 1  AD 24 E4             lda KBHANDLER           ; cteni dolni casti adresy ulozene v ROM
000037r 1  48                   pha                     ; ulozeni na zasobnik
000038r 1  60                   rts                     ; vyber adresy ze zasobniku + skok
000039r 1                                               ; zde neni nutne mit RTS
000039r 1               .endproc
000039r 1               
000039r 1               
000039r 1               ; ---------------------------------------------------------------------
000039r 1               ; subrutina pro obsluhu VBI
000039r 1               ; ---------------------------------------------------------------------
000039r 1               .proc   horizontal_movement
000039r 1  AE rr rr             ldx divider1
00003Cr 1  AC rr rr             ldy divider2
00003Fr 1               
00003Fr 1  AD 78 02             lda STICK0              ; čtení joysticku
000042r 1  C9 0B                cmp #11                 ; je nakloněn doleva?
000044r 1  D0 01                bne not_left
000046r 1  CA                   dex                     ; změna děliče
000047r 1               not_left:
000047r 1  C9 07                cmp #7                  ; je nakloněn doprava?
000049r 1  D0 01                bne not_right
00004Br 1  E8                   inx                     ; změna děliče
00004Cr 1               not_right:
00004Cr 1  C9 0E                cmp #14                 ; je nakloněn nahoru?
00004Er 1  D0 01                bne not_up
000050r 1  88                   dey                     ; změna Y-ové souřadnice hráče
000051r 1               not_up:
000051r 1  C9 0D                cmp #13                 ; je nakloněn dolů?
000053r 1  D0 01                bne not_down
000055r 1  C8                   iny                     ; změna Y-ové souřadnice hráče
000056r 1               not_down:
000056r 1  8E 00 D2             stx AUDF1               ; zápis do registru děliče frekvence pro zvukový kanál číslo 1 čipu POKEY
000059r 1  8C 04 D2             sty AUDF3               ; zápis do registru děliče frekvence pro zvukový kanál číslo 3 čipu POKEY
00005Cr 1  8E rr rr             stx divider1
00005Fr 1  8C rr rr             sty divider2
000062r 1  4C 62 E4             jmp XITVBV              ; zpracovat zbytek odloženého VBLANKu
000065r 1  60                   rts
000066r 1               .endproc
000066r 1               
000066r 1               ; děliče frekvence
000066r 1  0A           divider1: .byte 10
000067r 1  0A           divider2: .byte 10
000068r 1  00           noise1:   .byte 0
000069r 1               
000069r 1               
000069r 1               end:
000069r 1               
000069r 1               .segment "EXEHDR"
