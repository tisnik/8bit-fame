...
Main file   : rainbow_4.asm
Current file: rainbow_4.asm
...
00000Ar 1               
00000Ar 1  AD 2F 02 29          set_playfield_width #%01 ; šířka herního pole
00000Er 1  FC 09 01 8D  
000012r 1  2F 02        
000014r 1                       ; vektor DLI
000014r 1  A9 rr                lda #<dli               ; nastavení DLI
000016r 1  8D 00 02             sta VDSLST
000019r 1  A9 rr                lda #>dli
00001Br 1  8D 01 02             sta VDSLST+1
00001Er 1               
00001Er 1                       ; povolení DLI
00001Er 1                       NMIEN_DLI=$80           ; maska povolení DLI
00001Er 1                       NMIEN_VBI=$40           ; maska povolení VBI
00001Er 1  A9 C0                lda #NMIEN_DLI | NMIEN_VBI ; povolení DLI
000020r 1  8D 0E D4             sta NMIEN
000023r 1               
...
000026r 1               
000026r 1               ; ---------------------------------------------------------------------
000026r 1               ; obsluha DLI
000026r 1               ; ---------------------------------------------------------------------
000026r 1               dli:
000026r 1  A2 C0                ldx #192                ; počitadlo řádků
000028r 1  AC rr rr             ldy color               ; počáteční barva
00002Br 1  A9 FF                lda #$ff
00002Dr 1  18                   clc
00002Er 1  ED rr rr             sbc color
000031r 1               next_line:
000031r 1  8C 18 D0             sty COLPF2              ; změna barvy
000034r 1  8D 0A D4             sta WSYNC               ; čekání na další řádek
000037r 1  C8                   iny                     ; další barva v paletě
000038r 1               
000038r 1  8D 1A D0             sta COLBK               ; změna barvy okraje
00003Br 1  18                   clc
00003Cr 1  E9 01                sbc #1
00003Er 1               
00003Er 1  CA                   dex
00003Fr 1  D0 F0                bne next_line           ; opakovat 192x
000041r 1  EE rr rr             inc color               ; počáteční barva pro další snímek
000044r 1               
000044r 1  A9 00                lda #0                  ; černá barva
000046r 1  8D 1A D0             sta COLBK               ; změna barvy spodního okraje
000049r 1               
000049r 1  40                   rti                     ; návrat z DLI
00004Ar 1               
00004Ar 1               
00004Ar 1               ; ---------------------------------------------------------------------
00004Ar 1               ; display list
00004Ar 1               ; ---------------------------------------------------------------------
00004Ar 1               dlist:
00004Ar 1  70 70 F0     .byte DL_BLK8, DL_BLK8, DL_DLI+DL_BLK8 ; 3x8=24 prázdných obrazových řádků
00004Dr 1  42           .byte DL_LMS+DL_CHR40x8x1       ; určení počáteční adresy obrazové paměti + jeden řádek režimu 2 (GR.0)
00004Er 1  rr rr        .byte <screen, >screen          ; počáteční adresa obrazové paměti
000050r 1  02 02 02 02  .res 23, DL_CHR40x8x1           ; opakovat řádky textového režimu 2 (GR.0)
000054r 1  02 02 02 02  
000058r 1  02 02 02 02  
00005Cr 1  02 02 02 02  
000060r 1  02 02 02 02  
000064r 1  02 02 02     
000067r 1  41 rr rr     .byte DL_JVB, <dlist, >dlist    ; skok na začátek display listu
00006Ar 1               
00006Ar 1               end:
00006Ar 1               
00006Ar 1  00           color: .byte 0
00006Br 1               
00006Br 1               .BSS
