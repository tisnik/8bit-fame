...
Main file   : key_01.asm
Current file: key_01.asm
...
00000Dr 1               
00000Dr 1               ; ---------------------------------------------------------------------
00000Dr 1               ; tisk číslice uložené v akumulátoru na specifikovaný offset
00000Dr 1               ; ---------------------------------------------------------------------
00000Dr 1               .macro print_digit offset
00000Dr 1                       clc
00000Dr 1                       adc #16                 ; převod na interní kód znaku
00000Dr 1                       ldy #offset             ; nastavit registr Y
00000Dr 1                       sta (88),y              ; tisk znaku "0" nebo "1" na specifikované místo na obrazovce
00000Dr 1                                               ; (adresa Video RAM je na adresách 88 a 89)
00000Dr 1               .endmacro
00000Dr 1               
00000Dr 1               
00000Dr 1               
00000Dr 1               ; ---------------------------------------------------------------------
00000Dr 1               ; subrutina pro obsluhu VBI
00000Dr 1               ; ---------------------------------------------------------------------
00000Dr 1               .proc   vbi_handler
00000Dr 1               
00000Dr 1  AD 1F D0             lda CONSOL              ; načtení stavu kláves START, SELECT, OPTION
000010r 1  29 01                and #%00000001          ; jen klávesa START
000012r 1  18 69 10 A0          print_digit 2
000016r 1  02 91 58     
000019r 1               
000019r 1  AD 1F D0             lda CONSOL              ; načtení stavu kláves START, SELECT, OPTION
00001Cr 1  4A                   lsr
00001Dr 1  29 01                and #%00000001          ; jen klávesa SELECT
00001Fr 1  18 69 10 A0          print_digit 4
000023r 1  04 91 58     
000026r 1               
000026r 1  AD 1F D0             lda CONSOL              ; načtení stavu kláves START, SELECT, OPTION
000029r 1  4A                   lsr
00002Ar 1  4A                   lsr
00002Br 1  29 01                and #%00000001          ; jen klávesa OPTION
00002Dr 1  18 69 10 A0          print_digit 6
000031r 1  06 91 58     
000034r 1               
000034r 1  4C 62 E4             jmp XITVBV              ; zpracovat zbytek odloženého VBLANKu
000037r 1  60                   rts
000038r 1               .endproc
000038r 1               
000038r 1               
