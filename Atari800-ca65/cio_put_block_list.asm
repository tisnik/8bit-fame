...
Main file   : cio_put_block.asm
Current file: cio_put_block.asm
...
000002r 1  A9 0B                lda #PUTCHR             ; prováděná operace
...
000011r 1               
000011r 1                       ; nastavení počtu zapisovaných bajtů
000011r 1  A9 0D                lda #(end_of_message-message)
...
00001Er 1               
00001Er 1               loop:
00001Er 1  4C rr rr             jmp loop                ; program vlastně nice nedělá - jen cyklí!
000021r 1               .endproc
000021r 1               
000021r 1  48 65 6C 6C  message: .byte "Hello, world!"
000025r 1  6F 2C 20 77  
000029r 1  6F 72 6C 64  
00002Dr 1  21           
00002Er 1               end_of_message:
00002Er 1               
00002Er 1               end:
00002Er 1               
00002Er 1               
