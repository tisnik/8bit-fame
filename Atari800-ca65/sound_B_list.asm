...
Main file   : sound_B.asm
Current file: sound_B.asm
...
000017r 1               loop:
000017r 1  4C rr rr             jmp loop                ; program vlastně nice nedělá - jen cyklí!
00001Ar 1               .endproc
00001Ar 1               
00001Ar 1               
00001Ar 1               ; ---------------------------------------------------------------------
00001Ar 1               ; subrutina pro obsluhu VBI
00001Ar 1               ; ---------------------------------------------------------------------
00001Ar 1               .proc   horizontal_movement
00001Ar 1  AE rr rr             ldx divider1
00001Dr 1  AC rr rr             ldy divider2
000020r 1               
000020r 1  AD 78 02             lda STICK0              ; čtení joysticku
000023r 1  C9 0B                cmp #11                 ; je nakloněn doleva?
000025r 1  D0 01                bne not_left
000027r 1  CA                   dex                     ; změna děliče
000028r 1               not_left:
000028r 1  C9 07                cmp #7                  ; je nakloněn doprava?
00002Ar 1  D0 01                bne not_right
00002Cr 1  E8                   inx                     ; změna děliče
00002Dr 1               not_right:
00002Dr 1  C9 0E                cmp #14                 ; je nakloněn nahoru?
00002Fr 1  D0 01                bne not_up
000031r 1  88                   dey                     ; změna Y-ové souřadnice hráče
000032r 1               not_up:
000032r 1  C9 0D                cmp #13                 ; je nakloněn dolů?
000034r 1  D0 01                bne not_down
000036r 1  C8                   iny                     ; změna Y-ové souřadnice hráče
000037r 1               not_down:
000037r 1  8E 00 D2             stx AUDF1               ; zápis do registru děliče frekvence pro zvukový kanál číslo 1 čipu POKEY
00003Ar 1  8C 04 D2             sty AUDF3               ; zápis do registru děliče frekvence pro zvukový kanál číslo 3 čipu POKEY
00003Dr 1  8E rr rr             stx divider1
000040r 1  8C rr rr             sty divider2
000043r 1  4C 62 E4             jmp XITVBV              ; zpracovat zbytek odloženého VBLANKu
000046r 1  60                   rts
000047r 1               .endproc
000047r 1               
000047r 1               ; děliče frekvence
000047r 1  0A           divider1: .byte 10
000048r 1  0A           divider2: .byte 10
000049r 1               
000049r 1               
000049r 1               end:
000049r 1               
000049r 1               .segment "EXEHDR"
