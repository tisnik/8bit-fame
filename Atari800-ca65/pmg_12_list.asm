...
Main file   : pmg_12.asm
Current file: pmg_12.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Automatický horizontální pohyb prvního hráče, čekání na další snímek.
000000r 1               ;
...
000060r 1               loop:
000060r 1  20 rr rr             jsr _wait_vsync
...
000072r 1               
000072r 1               
000072r 1               .proc   _wait_vsync
000072r 1  A6 14                ldx     RTCLOK+2        ; čekání na konec snímku
000074r 1  E4 14        @wt:    cpx     RTCLOK+2
000076r 1  F0 FC                beq     @wt
000078r 1  60                   rts
000079r 1               .endproc
000079r 1               
000079r 1               
000079r 1               ; data
000079r 1  18 3C 7E DB  sprite:   .byte 24, 60, 126, 219, 255, 36, 90, 165
00007Dr 1  FF 24 5A A5  
000081r 1               
000081r 1               end:
000081r 1               
000081r 1               
000081r 1               .segment "EXEHDR"
