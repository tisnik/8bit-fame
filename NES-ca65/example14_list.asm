...
Main file   : example14.asm
Current file: example14.asm
...
000083r 1  A2 00                ldx #0            ; vynulování počitadla
000085r 1               :
...
00008Cr 1  E0 20                cpx #32           ; každý sprite má 4 bajty: y-coord, tile, attributy, y-coord * 8 spritů = 32
00008Er 1  D0 F5                bne :-
000090r 1               
...
0000BCr 1               
0000BCr 1               ; data pro jeden sprite
0000BCr 1               spritedata:
0000BCr 1  10 00 00 08      .byte $10, $00, $00, $08   ; y-coord, tile number, attributes, x-coord
0000C0r 1  10 01 00 12      .byte $10, $01, $00, $12
0000C4r 1  1A 02 00 08      .byte $1a, $02, $00, $08
0000C8r 1  1A 03 00 12      .byte $1a, $03, $00, $12
0000CCr 1  24 04 00 08      .byte $24, $04, $00, $08
0000D0r 1  24 05 00 12      .byte $24, $05, $00, $12
0000D4r 1  2E 06 00 08      .byte $2e, $06, $00, $08
0000D8r 1  2E 07 00 12      .byte $2e, $07, $00, $12
0000DCr 1               
0000DCr 1               
0000DCr 1               
0000DCr 1               ; ---------------------------------------------------------------------
0000DCr 1               ; Tabulka vektorů CPU
0000DCr 1               ; ---------------------------------------------------------------------
0000DCr 1               
0000DCr 1               .segment "VECTORS"
