...
Main file   : example03.asm
Current file: example03.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Upravená kostra programu pro herní konzoli NES
000000r 1               ; Pojmenování všech řídicích registrů
000000r 1               ;
...
000012r 1  2C 02 20     wait1:  bit PPUSTATUS           ; test obsahu registru PPUSTATUS
000015r 1  10 FB                bpl wait1               ; skok, pokud je příznak N nulový
000017r 1  2C 02 20     wait2:  bit PPUSTATUS           ; test obsahu registru PPUSTATUS
...
000038r 1  2C 02 20     wait3:  bit PPUSTATUS           ; test obsahu registru PPUSTATUS
