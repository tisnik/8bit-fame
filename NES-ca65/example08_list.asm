...
Main file   : example08.asm
Current file: example08.asm

000000r 1               ; ---------------------------------------------------------------------
000000r 1               ; Kostra programu pro herní konzoli NES
000000r 1               ; Vynulování barvové palety, zvýšení intenzity zvolené barvové složky
000000r 1               ;
...
00003Dr 1  A9 3F                lda #>PALETTE ; nastavení adresy pro barvovou paletu $3f00
00003Fr 1  8D 06 20             sta PPUADDR
000042r 1  A9 00                lda #<PALETTE ; nižší bajt adresy
