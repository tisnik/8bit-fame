...
Main file   : example20.asm
Current file: example20.asm
...
000027r 1  01           
000028r 1  F0 03                beq up_not_pressed ; není stisknuto? => skok
00002Ar 1               
00002Ar 1  CE 00 02             dec YPOS
00002Dr 1               
00002Dr 1               up_not_pressed:
00002Dr 1               
00002Dr 1  AD 16 40 29          read_button        ; stav tlačítka Down
000031r 1  01           
000032r 1  F0 03                beq down_not_pressed ; není stisknuto? => skok
000034r 1               
000034r 1  EE 00 02             inc YPOS
000037r 1               
000037r 1               down_not_pressed:
000037r 1               
000037r 1  AD 16 40 29          read_button      ; stav tlačítka Left
00003Br 1  01           
00003Cr 1  F0 03                beq left_not_pressed ; není stisknuto? => skok
00003Er 1               
00003Er 1  CE 03 02             dec XPOS
000041r 1               
000041r 1               left_not_pressed:
000041r 1               
000041r 1  AD 16 40 29          read_button      ; stav tlačítka Right
000045r 1  01           
000046r 1  F0 03                beq right_not_pressed ; není stisknuto? => skok
000048r 1               
000048r 1  EE 03 02             inc XPOS
00004Br 1               
00004Br 1               right_not_pressed:
00004Br 1               
00004Br 1  40                   rti                ; návrat z přerušení
00004Cr 1               
00004Cr 1               .endproc
00004Cr 1               
00004Cr 1               
00004Cr 1               
00004Cr 1               ; Obslužná rutina pro IRQ (maskovatelné přerušení)
00004Cr 1               
00004Cr 1               .proc irq
00004Cr 1  40                   rti                     ; návrat z přerušení
00004Dr 1               .endproc
00004Dr 1               
00004Dr 1               
00004Dr 1               
00004Dr 1               ; Obslužná rutina pro RESET
00004Dr 1               
00004Dr 1               .proc reset
00004Dr 1                       ; nastavení stavu CPU
00004Dr 1  78 D8 A2 FF          setup_cpu
000051r 1  9A           
000052r 1               
000052r 1                       ; nastavení řídicích registrů
000052r 1  A2 00                ldx #$00
000054r 1  8E 00 20             stx PPUCTRL             ; nastavení PPUCTRL = 0 (NMI)
000057r 1  8E 01 20             stx PPUMASK             ; nastavení PPUMASK = 0
00005Ar 1  8E 10 40             stx DMC_FREQ            ; zákaz DMC IRQ
00005Dr 1               
00005Dr 1  A2 40                ldx #$40
00005Fr 1  8E 17 40             stx $4017               ; interrupt inhibit bit
000062r 1               
000062r 1                       ; čekání na vnitřní inicializaci PPU (dva snímky)
000062r 1  2C 02 20 10          wait_for_frame
000066r 1  FB           
000067r 1  2C 02 20 10          wait_for_frame
00006Br 1  FB           
00006Cr 1               
00006Cr 1                       ; vymazání obsahu RAM
00006Cr 1  A9 00 95 00          clear_ram
000070r 1  9D 00 01 9D  
000074r 1  00 02 9D 00  
000078r 1  03 9D 00 04  
00007Cr 1  9D 00 05 9D  
000080r 1  00 06 9D 00  
000084r 1  07 E8 D0 E6  
000088r 1               
000088r 1                       ; čekání na další snímek
000088r 1  2C 02 20 10          wait_for_frame
00008Cr 1  FB           
00008Dr 1               
00008Dr 1                       ; nastavení barvové palety
00008Dr 1  20 rr rr             jsr load_palette  ; zavolání subrutiny
000090r 1               
000090r 1                       ; nastavení spritů
000090r 1  20 rr rr             jsr load_sprites  ; zavolání subrutiny
000093r 1               
000093r 1                       ; vlastní herní smyčka je prozatím prázdná
000093r 1               game_loop:
000093r 1  4C rr rr             jmp game_loop           ; nekonečná smyčka (později rozšíříme)
000096r 1               .endproc
000096r 1               
000096r 1               
000096r 1               
000096r 1               ; vynulování barvové palety
000096r 1               .proc clear_palette
000096r 1  AD 02 20 A9          ppu_data_palette_address
00009Ar 1  3F 8D 06 20  
00009Er 1  A9 00 8D 06  
0000A2r 1  20           
0000A3r 1               
0000A3r 1  A2 20                ldx #$20        ; počitadlo barev v paletě: 16+16
0000A5r 1  A9 00                lda #$00        ; vynulování každé barvy
0000A7r 1               
0000A7r 1               :
0000A7r 1  8D 07 20             sta PPUDATA     ; zápis barvy
0000AAr 1  CA                   dex             ; snížení hodnoty počitadla
0000ABr 1  D0 FA                bne :-
0000ADr 1               
0000ADr 1  60                   rts             ; návrat ze subrutiny
0000AEr 1               .endproc
0000AEr 1               
0000AEr 1               
0000AEr 1               
0000AEr 1               ; nastavení barvové palety
0000AEr 1               .proc load_palette
0000AEr 1  AD 02 20 A9          ppu_data_palette_address
0000B2r 1  3F 8D 06 20  
0000B6r 1  A9 00 8D 06  
0000BAr 1  20           
0000BBr 1               
0000BBr 1                       ; $3f00-$3f0f - paleta pozadí
0000BBr 1                       ; $3f10-$3f1f - paleta spritů
0000BBr 1               
0000BBr 1  A2 00                ldx #$00        ; vynulovat počitadlo a offset
0000BDr 1               
0000BDr 1               :
0000BDr 1  BD rr rr             lda palette, x  ; načíst bajt s offsetem
0000C0r 1  8D 07 20             sta PPUDATA     ; zápis barvy do PPU
0000C3r 1  E8                   inx             ; zvýšit počitadlo/offset
0000C4r 1  E0 20                cpx #32         ; limit počtu barev
0000C6r 1  D0 F5                bne :-          ; opakovat smyčku 32x
0000C8r 1               
0000C8r 1  60                   rts             ; návrat ze subrutiny
0000C9r 1               .endproc
0000C9r 1               
0000C9r 1               
0000C9r 1               
0000C9r 1               ; načtení spritů
0000C9r 1               .proc load_sprites
0000C9r 1  A2 00                ldx #0
0000CBr 1               :
0000CBr 1  BD rr rr             lda spritedata,X  ; budeme přesouvat data z této oblasti
0000CEr 1  9D 00 02             sta $0200,X       ; uložení do paměti spritů
0000D1r 1  E8                   inx               ; zvýšení hodnoty počitadla
0000D2r 1  E0 20                cpx #32           ; každý sprite má 4 bajty: y-coord, tile, attributy, y-coord * 8 spritů = 32
0000D4r 1  D0 F5                bne :-
0000D6r 1               
0000D6r 1  58                   cli               ; vynulování bitu I - povolení přerušení
0000D7r 1  A9 80                lda #%10000000
0000D9r 1  8D 00 20             sta PPUCTRL       ; při každém VBLANK se vyvolá NMI (důležité!)
0000DCr 1               
0000DCr 1  A9 10                lda #%00010000    ; povolení zobrazení spritů
0000DEr 1  8D 01 20             sta PPUMASK
0000E1r 1               
...
0000E2r 1               
0000E2r 1               
0000E2r 1               ; samotná barvová paleta
0000E2r 1               palette:
0000E2r 1  22 29 1A 0F      .byte $22, $29, $1a, $0F, $22, $36, $17, $0F, $22, $30, $21, $0F, $22, $27, $17, $0F  ; barvy pozadí
0000E6r 1  22 36 17 0F  
0000EAr 1  22 30 21 0F  
0000EEr 1  22 27 17 0F  
0000F2r 1  22 16 27 18      .byte $22, $16, $27, $18, $22, $1A, $30, $27, $22, $16, $30, $27, $22, $0F, $36, $17  ; barvy spritů
0000F6r 1  22 1A 30 27  
0000FAr 1  22 16 30 27  
0000FEr 1  22 0F 36 17  
000102r 1               
000102r 1               ; data pro větší množství spritů
000102r 1               spritedata:
000102r 1  10 00 00 08      .byte $10, $00, $00, $08   ; y-coord, tile number, attributes, x-coord
000106r 1  10 01 00 10      .byte $10, $01, $00, $10
00010Ar 1  18 02 00 08      .byte $18, $02, $00, $08
00010Er 1  18 03 00 10      .byte $18, $03, $00, $10
000112r 1  20 04 00 08      .byte $20, $04, $00, $08
000116r 1  20 05 00 10      .byte $20, $05, $00, $10
00011Ar 1  28 06 00 08      .byte $28, $06, $00, $08
00011Er 1  28 07 00 10      .byte $28, $07, $00, $10
000122r 1               
000122r 1               
000122r 1               
000122r 1               ; ---------------------------------------------------------------------
000122r 1               ; Tabulka vektorů CPU
000122r 1               ; ---------------------------------------------------------------------
000122r 1               
000122r 1               .segment "VECTORS"
