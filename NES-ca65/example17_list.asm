...
Main file   : example17.asm
Current file: example17.asm
...
000022r 1               
000022r 1  AD 00 02             lda $0200          ; změna y-ové pozice spritu
000025r 1  38                   sec                ; nastavit přenos
000026r 1  E9 02                sbc #$02           ; y--
000028r 1  8D 00 02             sta $0200          ; uložení nové y-ové pozice spritu
00002Br 1               
...
000032r 1               
000032r 1  AD 00 02             lda $0200          ; změna y-ové pozice spritu
000035r 1  18                   clc                ; vynulovat přenos
000036r 1  69 02                adc #$02           ; y++
000038r 1  8D 00 02             sta $0200          ; uložení nové y-ové pozice spritu
00003Br 1               
...
000052r 1               
000052r 1  AD 03 02             lda $0203          ; změna x-ové pozice spritu
000055r 1  18                   clc                ; vynulovat přenos
000056r 1  69 02                adc #$02           ; x--
000058r 1  8D 03 02             sta $0203          ; uložení nové x-ové pozice spritu
00005Br 1               
