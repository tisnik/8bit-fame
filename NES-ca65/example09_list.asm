...
000000r 1               .endmacro
000000r 1               
000000r 1               ; vynulování barvové palety
000000r 1               .macro clear_palette
...
000000r 1                       sta PPUADDR
000000r 1               
000000r 1                       ldx #$20        ; počitadlo barev v paletě: 16+16
000000r 1                       lda #$00        ; vynulování každé barvy
000000r 1               
000000r 1               :
000000r 1                       sta PPUDATA     ; zápis barvy
000000r 1                       dex             ; snížení hodnoty počitadla
000000r 1                       bne :-
000000r 1               .endmacro
000000r 1               
000000r 1               
