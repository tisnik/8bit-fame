...
00003Dr 1               
00003Dr 1  A9 80                lda #%10000000 ; vysoká intenzita modré barvy
00003Fr 1  8D 01 20             sta PPUMASK
000042r 1               
000042r 1                       ; vlastní herní smyčka je prozatím prázdná
000042r 1               game_loop:
000042r 1  4C rr rr             jmp game_loop           ; nekonečná smyčka (později rozšíříme)
000045r 1               .endproc
000045r 1               
000045r 1               
000045r 1               
000045r 1               ; vynulování barvové palety
000045r 1               .proc clear_palette
000045r 1  AD 02 20             lda PPUSTATUS   ; reset záchytného registru
000048r 1  A9 3F                lda #>PALETTE   ; nastavení adresy pro barvovou paletu $3f00
00004Ar 1  8D 06 20             sta PPUADDR
00004Dr 1  A9 00                lda #<PALETTE   ; nižší bajt adresy
00004Fr 1  8D 06 20             sta PPUADDR
000052r 1               
000052r 1  A2 20                ldx #$20        ; počitadlo barev v paletě: 16+16
000054r 1  A9 00                lda #$00        ; vynulování každé barvy
000056r 1               
000056r 1               :
000056r 1  8D 07 20             sta PPUDATA     ; zápis barvy
000059r 1  CA                   dex             ; snížení hodnoty počitadla
00005Ar 1  D0 FA                bne :-
00005Cr 1               
00005Cr 1  60                   rts             ; návrat ze subrutiny
00005Dr 1               .endproc
00005Dr 1               
00005Dr 1               
00005Dr 1               
00005Dr 1               ; ---------------------------------------------------------------------
00005Dr 1               ; Tabulka vektorů CPU
00005Dr 1               ; ---------------------------------------------------------------------
00005Dr 1               
