...
.LFB0:
	.cfi_startproc
	unpcklpd	xmm0, xmm0	# vect_cst__21
	lea	rax, [rdi+64]	# _5,
.L2:
# add_delta_8_doubles.c:5:         a[i] += delta;
	movupd	xmm1, XMMWORD PTR [rdi]	# vect__4.6_20, MEM <vector(2) double> [(double *)_2]
	add	rdi, 16	# ivtmp.13,
# add_delta_8_doubles.c:5:         a[i] += delta;
	addpd	xmm1, xmm0	# vect__5.7_22, vect_cst__21
	movups	XMMWORD PTR [rdi-16], xmm1	# MEM <vector(2) double> [(double *)_2], vect__5.7_22
	cmp	rax, rdi	# _5, ivtmp.13
	jne	.L2	#,
# add_delta_8_doubles.c:7: }
	ret	
	.cfi_endproc
.LFE0:
