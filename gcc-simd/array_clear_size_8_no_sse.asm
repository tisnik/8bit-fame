...
# options passed: -masm=intel -mno-sse -mtune=generic -march=x86-64 -O2
	.text
	.p2align 4
	.globl	clear
	.type	clear, @function
...
# array_clear_size_8.c:5:         a[i] = 0.0;
	mov	QWORD PTR [rdi], 0	# MEM <char[1:32]> [(void *)a_7(D)],
	mov	QWORD PTR [rdi+8], 0	# MEM <char[1:32]> [(void *)a_7(D)],
	mov	QWORD PTR [rdi+16], 0	# MEM <char[1:32]> [(void *)a_7(D)],
	mov	QWORD PTR [rdi+24], 0	# MEM <char[1:32]> [(void *)a_7(D)],
