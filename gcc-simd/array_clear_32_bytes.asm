...
.LFB0:
	.cfi_startproc
# array_clear_32_bytes.c:5:         a[i] = 0;
	pxor	xmm0, xmm0	# tmp99
	movups	XMMWORD PTR [rdi], xmm0	# MEM <char[1:32]> [(void *)a_6(D)], tmp99
	movups	XMMWORD PTR [rdi+16], xmm0	# MEM <char[1:32]> [(void *)a_6(D)], tmp99
# array_clear_32_bytes.c:7: }
	ret	
	.cfi_endproc
.LFE0:
	.size	clear, .-clear
