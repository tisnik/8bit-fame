...
.LFB0:
	...
	cmp	rax, 14	# _14,
	jbe	.L4	#,
# add_arrays_16_bytes.c:5:         a[i] += b[i];
	movdqu	xmm0, XMMWORD PTR [rsi]	# vect__5.9_38, MEM <vector(16) unsigned char> [(unsigned char *)b_11(D)]
# add_arrays_16_bytes.c:5:         a[i] += b[i];
	movdqu	xmm1, XMMWORD PTR [rdi]	# tmp120, MEM <vector(16) unsigned char> [(unsigned char *)a_10(D)]
	paddb	xmm0, xmm1	# vect__6.10_39, tmp120
	movups	XMMWORD PTR [rdi], xmm0	# MEM <vector(16) unsigned char> [(unsigned char *)a_10(D)], vect__6.10_39
	ret	
	.p2align 4,,10
	.p2align 3
.L4:
# add_arrays_16_bytes.c:1: void add_arrays(unsigned char *a, unsigned char *b) {
...
# add_arrays_16_bytes.c:4:     for (i=0; i<SIZE; i++) {
	add	rax, 1	# ivtmp.16,
	cmp	rax, 16	# ivtmp.16,
	jne	.L2	#,
# add_arrays_16_bytes.c:7: }
	ret	
	.cfi_endproc
.LFE0:
