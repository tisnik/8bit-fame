    ...
    16                                  ;-----------------------------------------------------------------------------
    17                                  section .text
    18                                          global _start                ; tento symbol ma byt dostupny i linkeru
    19                                  
    20                                  _start:
    21 00000000 B842000000                      mov     eax, 0x42            ; == 0b01000010
    22 00000005 0FBCD0                          bsf     edx, eax             ; zjisteni indexu nejvyssiho nenuloveho bitu
    23                                  
    24 00000008 BB[00000000]                    mov     ebx, hex_message     ; buffer, ktery se zaplni hexa cislicemi
    25 0000000D E822000000                      call    hex2string           ; zavolani prislusne subrutiny
    26                                          print_string   hex_message, hex_message_length    ; tisk hexadecimalni hodnoty
    11 00000012 B804000000          <1>  mov eax, sys_write
    12 00000017 BB01000000          <1>  mov ebx, 1
    13 0000001C B9[00000000]        <1>  mov ecx, %1
    14 00000021 BA09000000          <1>  mov edx, %2
    15 00000026 CD80                <1>  int 80h
    27                                  
    28                                          exit                         ; ukonceni procesu
    81 00000028 B801000000          <1>  mov eax,sys_exit
    82 0000002D BB00000000          <1>  mov ebx,0
    83 00000032 CD80                <1>  int 80h
    29                                  
    30                                  
    31                                  %include "hex2string.asm"
     ...
     7                              <1> hex2string:
     8 00000034 B908000000          <1>                   mov ecx,  8               ; pocet opakovani smycky
     9                              <1> 
    10 00000039 C1C204              <1> .print_one_digit: rol edx, 4                ; rotace doleva znamena, ze se do spodnich 4 bitu nasune dalsi cifra
    11 0000003C 88D0                <1>                   mov al, dl                ; nechceme porusit obsah vstupni hodnoty v EDX, proto pouzijeme AL
    12 0000003E 240F                <1>                   and al, 0x0f              ; maskovani, potrebujeme pracovat jen s jednou cifrou
    13 00000040 3C0A                <1>                   cmp al, 10                ; je cifra vetsi nebo rovna 10?
    14 00000042 7C02                <1>                   jl  .store_digit          ; neni, pouze prevest 0..9 na ASCII hodnotu '0'..'9'
    15                              <1> 
    16 00000044 0407                <1> .alpha_digit:     add al, 'A'-10-'0'        ; prevod hodnoty 10..15 na znaky 'A'..'F'
    17                              <1> 
    18 00000046 0430                <1> .store_digit:     add al, '0'
    19 00000048 8803                <1>                   mov [ebx], al             ; ulozeni cifry do retezce
    20 0000004A 43                  <1>                   inc ebx                   ; dalsi cifra
    21 0000004B E2EC                <1>                   loop .print_one_digit     ; a opakovani smycky, dokud se nedosahlo nuly
    22                              <1> 
    23 0000004D C3                  <1>                   ret                       ; navrat ze subrutiny
    24                              <1> 
    25                              <1> %endif
