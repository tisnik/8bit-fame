...
3060   R2=10
3065   D=60
3070   FOR T=0 TO 3*360 STEP 0.3
3080     X=ORIGIN_X+(R1-R2)*COS(T)+D*COS(T*(R1-R2)/R2)
3090     Y=ORIGIN_Y-(R1-R2)*SIN(T)+D*SIN(T*(R1-R2)/R2)
3100     IF X>0 AND X<320 AND Y>0 AND Y<191 THEN PLOT X,Y
3110   NEXT T
3120 ENDPROC 
4000 ------------------------------
4010 REM SAVE_IMAGE
...
4050   FILENAME$="H:HYPOTROCHOID2.BMP"
4060   EXEC WRITE_BMP
4070 ENDPROC 
10000 ------------------------------
