...
1. [Bubble sort in Microsoft BASIC](bubble_sort.bas)
1. [Factorial computation in Microsoft BASIC](factorial.bas)
1. [Pi computation in Microsoft BASIC](PI.bas)
1. [1D array handling](1d_array.bas)
1. [2D array handling](2d_array.bas)
1. [GCD computation in Microsoft BASIC](GCD.bas)
1. [Finding FP limits](harmonic.bas)
1. [Moire pattern in Microsoft BASIC (4 colors)](moire1.bas)
1. [Moire pattern in Microsoft BASIC (16 grayscales)](moire2.bas)
1. [Moire pattern in Microsoft BASIC (16 colors)](moire3.bas)
