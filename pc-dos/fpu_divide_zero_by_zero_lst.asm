     1                                  ;-----------------------------------------------------------------------------
     2                                  ; Deleni nuly nulou matematickym koprocesorem.
     3                                  ;
   ...
   127                              <1> %endif
    17                                  
    18                                  main:
    19 0000005E D9EE                            fldz                 ; nacteni FP konstanty 0.0
    ...
    23                                  
    24                                          wait_key             ; cekani na klavesu
    22 00000081 31C0                <1>  xor ax, ax
    23 00000083 CD16                <1>  int 0x16
    25                                          exit                 ; navrat do DOSu
    16 00000085 B44C                <1>  mov ah, 0x4c
    17 00000087 CD21                <1>  int 0x21
