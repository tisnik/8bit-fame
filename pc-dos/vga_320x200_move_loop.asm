...
;
; preklad pomoci:
;     nasm -f bin -o vga.com vga_320x200_move_loop.asm
;
; nebo pouze:
;     nasm -o vga.com vga_320x200_move_loop.asm
...
opak:
        mov al, ds:[si]     ; načtení ze zdrojového bloku
        mov es:[di], al     ; uložení do cílového bloku
        inc si              ; zvýšení ukazatelů
        inc di
        loop opak           ; opakování CX-krát
