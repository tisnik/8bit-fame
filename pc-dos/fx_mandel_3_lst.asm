    ...
    35                                  
    36 0000000F C706[0000]00E0          mforx:  mov     word [cx_], MIN    ; od -2 (imaginarni osa)
    ...
    55 0000003C C1FB05                          sar     BX,5               ; zy1 div 256 * 2 (pro mul v X-pointu)
    ...
    68 00000060 3D0040                          cmp     AX, BAILOUT*P      ; kontrola na bailout (abs[Z]<4)
    ...
    74 0000006A 8306[0000]40                    add     word [cx_], K      ; cy_:=cy_+K
    75 0000006F 4E                              dec     si
    76 00000070 75A6                            jnz     short mfory        ; Y!=0 ->dalsi radek
    77                                  
    78 00000072 8306[0000]55                    add     word [cy_], L      ; cx_:=cx_+L
    ...
    87                                  section .data
    88                                  
    89 00000000 00E0                    cy_     dw MIN                     ; poloha v komplexni rovine rovine
    90                                  
    91                                  section .bss
    92                                  
