...
;-----------------------------------------------------------------------------
     ...
     3                                  
     4                                  ; konstanty
     5                                  P       equ     4096/4              ; poloha desetinne tecky v X-pointu
    ...
    34 0000000D B105                            mov     CL, 5              ; posun pro FX format
    35                                  
    36 0000000F C706[0000]00F8          mforx:  mov     word [cx_], MIN    ; od -2 (imaginarni osa)
    ...
    55 0000003C C1FB04                          sar     BX,4               ; zy1 div 256 * 2 (pro mul v X-pointu)
    ...
    68 00000060 3D0010                          cmp     AX, BAILOUT*P      ; kontrola na bailout (abs[Z]<4)
    ...
    74 0000006A 8306[0000]10                    add     word [cx_], K      ; cy_:=cy_+K
    75 0000006F 4E                              dec     si
    76 00000070 75A6                            jnz     short mfory        ; Y!=0 ->dalsi radek
    77                                  
    78 00000072 8306[0000]15                    add     word [cy_], L      ; cx_:=cx_+L
    79 00000077 81FF00FA                        cmp     di, 64000          ; konec obrazku ?
    80 0000007B 7592                            jne     short mforx
    81                                  
    82                                  finish:
    83                                          wait_key                   ; cekani na klavesu
    22 0000007D 31C0                <1>  xor ax, ax
    23 0000007F CD16                <1>  int 0x16
    84                                          exit                       ; navrat do DOSu
    16 00000081 B44C                <1>  mov ah, 0x4c
    17 00000083 CD21                <1>  int 0x21
    85                                  
    86                                  
    87                                  section .data
    88                                  
    89 00000000 00F8                    cy_     dw MIN                     ; poloha v komplexni rovine rovine
    90                                  
    91                                  section .bss
    92                                  
