     1                                  ;-----------------------------------------------------------------------------
     2                                  ; Deleni zapornou nulou matematickym koprocesorem.
     3                                  ;
   ...
   127                              <1> %endif
    ...
    20 00000060 D9E0                            fchs                 ; zmena znamenka
    21 00000062 D9EE                            fldz                 ; nacteni FP konstanty 0.0
    22 00000064 DEF9                            fdivp                ; vypocet podilu
    23                                          print_float32_as_hex ; zobrazeni FP hodnoty v hexadecimalnim tvaru
